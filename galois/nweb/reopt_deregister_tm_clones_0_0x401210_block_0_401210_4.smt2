; reopt_deregister_tm_clones_0_0x401210.block_0_401210.0 @ 0x40121b: precondition ((= rbp (fnstart rbp)), for jump)
(set-logic ALL)
...
; LLVM:     jump label %block_0_401230
(assert true)
(assert (= fnstart_df false))
(assert (= fnstart_rbx fnstart_rbx))
(assert (= fnstart_rsp fnstart_rsp))
