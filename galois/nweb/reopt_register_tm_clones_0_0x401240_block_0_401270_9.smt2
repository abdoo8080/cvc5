; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: register value preserved (r15, after return)
(set-logic ALL)
...
(assert (= a0x401270_r13 fnstart_r13))
(assert (= a0x401270_r14 fnstart_r14))
(check-sat-assuming ((not (= a0x401270_r15 fnstart_r15))))
(exit)
