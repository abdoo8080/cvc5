; web.block_0_4016b0.1 @ 0x4016c1: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4016b0_rax () (_ BitVec 64))
(declare-fun a0x4016b0_rcx () (_ BitVec 64))
(declare-fun a0x4016b0_rdx () (_ BitVec 64))
(declare-fun a0x4016b0_rbx () (_ BitVec 64))
(declare-fun a0x4016b0_rsp () (_ BitVec 64))
(declare-fun a0x4016b0_rbp () (_ BitVec 64))
(declare-fun a0x4016b0_rsi () (_ BitVec 64))
(declare-fun a0x4016b0_rdi () (_ BitVec 64))
(declare-fun a0x4016b0_r8 () (_ BitVec 64))
(declare-fun a0x4016b0_r9 () (_ BitVec 64))
(declare-fun a0x4016b0_r10 () (_ BitVec 64))
(declare-fun a0x4016b0_r11 () (_ BitVec 64))
(declare-fun a0x4016b0_r12 () (_ BitVec 64))
(declare-fun a0x4016b0_r13 () (_ BitVec 64))
(declare-fun a0x4016b0_r14 () (_ BitVec 64))
(declare-fun a0x4016b0_r15 () (_ BitVec 64))
(declare-fun a0x4016b0_cf () Bool)
(declare-fun a0x4016b0_RESERVED_1 () Bool)
(declare-fun a0x4016b0_pf () Bool)
(declare-fun a0x4016b0_RESERVED_3 () Bool)
(declare-fun a0x4016b0_af () Bool)
(declare-fun a0x4016b0_RESERVED_5 () Bool)
(declare-fun a0x4016b0_zf () Bool)
(declare-fun a0x4016b0_sf () Bool)
(declare-fun a0x4016b0_tf () Bool)
(declare-fun a0x4016b0_if () Bool)
(define-fun a0x4016b0_df () Bool false)
(declare-fun a0x4016b0_of () Bool)
(declare-fun a0x4016b0_iopl1 () Bool)
(declare-fun a0x4016b0_iopl2 () Bool)
(declare-fun a0x4016b0_nt () Bool)
(declare-fun a0x4016b0_RESERVED_15 () Bool)
(declare-fun a0x4016b0_rf () Bool)
(declare-fun a0x4016b0_vm () Bool)
(declare-fun a0x4016b0_ac () Bool)
(declare-fun a0x4016b0_vif () Bool)
(declare-fun a0x4016b0_vip () Bool)
(declare-fun a0x4016b0_id () Bool)
(declare-fun a0x4016b0_el () Bool)
(declare-fun a0x4016b0_el0 () Bool)
(declare-fun a0x4016b0_el1 () Bool)
(declare-fun a0x4016b0_el2 () Bool)
(declare-fun a0x4016b0_el3 () Bool)
(declare-fun a0x4016b0_el4 () Bool)
(declare-fun a0x4016b0_el5 () Bool)
(declare-fun a0x4016b0_el6 () Bool)
(declare-fun a0x4016b0_el7 () Bool)
(declare-fun a0x4016b0_el8 () Bool)
(declare-fun a0x4016b0_xmm0 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm1 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm2 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm3 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm4 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm5 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm6 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm7 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm8 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm9 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm10 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm11 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm12 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm13 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm14 () (_ BitVec 512))
(declare-fun a0x4016b0_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t125 () (_ BitVec 64))
(declare-fun %t126 () (_ BitVec 32))
(declare-fun %t127 () (_ BitVec 32))
(assert (= %t125 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t126 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t127 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4016b0_rbx fnstart_rbx))
(assert (= a0x4016b0_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4016b0_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4016b0_r12 fnstart_r12))
(assert (= a0x4016b0_r13 fnstart_r13))
(assert (= a0x4016b0_r14 fnstart_r14))
(assert (= a0x4016b0_r15 fnstart_r15))
(assert (= a0x4016b0_af a0x4016b0_df))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t128 = add i64 %t125, 1
(define-fun %t128 () (_ BitVec 64) (bvadd %t125 #x0000000000000001))
; LLVM:     jump label %block_0_40167c
(define-fun addr () (_ BitVec 64) (bvadd a0x4016b0_rbp #xffffffffffffffe0))
...
(define-fun addr0 () (_ BitVec 64) (bvadd a0x4016b0_rbp #xffffffffffffffe0))
...
(assert true)
(assert (= a0x4016b0_df false))
(assert (= %t128 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t126 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t127 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4016b0_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x4016b0_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
