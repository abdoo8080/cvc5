; web.block_0_40197a.1 @ 0x401985: precondition ((= (llvm t311) (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t306 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000018))))))
(exit)
