; web.block_0_40157a.2 @ 0x40157a: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x40157a_rbx fnstart_rbx))
(assert (= a0x40157a_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x40157a_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
