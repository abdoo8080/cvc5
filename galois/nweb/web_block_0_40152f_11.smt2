; web.block_0_40152f.2 @ 0x40154b: precondition ((= (llvm t17) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t13 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
