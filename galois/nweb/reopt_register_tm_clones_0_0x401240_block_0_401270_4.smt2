; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: register value preserved (rbp, after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x401270_rbp fnstart_rbp))))
(exit)
