; web.block_0_4019e9.2 @ 0x4019ec: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x4019e9_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
