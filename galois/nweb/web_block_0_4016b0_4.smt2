; web.block_0_4016b0.1 @ 0x4016c1: precondition ((= (llvm t104) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t128 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
