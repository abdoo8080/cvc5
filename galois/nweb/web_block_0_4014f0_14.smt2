; web.block_0_4014f0.4 @ 0x401510: precondition ((= (llvm t6) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t0 (mem_readbv32 mem3 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
