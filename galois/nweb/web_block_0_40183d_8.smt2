; web.block_0_40183d.4 @ 0x40185a: precondition ((= (llvm t257) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t244 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
