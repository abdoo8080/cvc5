; web.block_0_40164a.2 @ 0x40164d: precondition ((= cf df), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t98 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) a0x40164a_df)))))
(exit)
