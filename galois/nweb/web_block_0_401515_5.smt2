; web.block_0_401515.1 @ 0x40151e: precondition ((= (llvm t13) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t7 #b1) (= %t5 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010)))))))
(exit)
