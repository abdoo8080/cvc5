; web.block_0_401710.2 @ 0x40172c: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x401710_rax () (_ BitVec 64))
(declare-fun a0x401710_rcx () (_ BitVec 64))
(declare-fun a0x401710_rdx () (_ BitVec 64))
(declare-fun a0x401710_rbx () (_ BitVec 64))
(declare-fun a0x401710_rsp () (_ BitVec 64))
(declare-fun a0x401710_rbp () (_ BitVec 64))
(declare-fun a0x401710_rsi () (_ BitVec 64))
(declare-fun a0x401710_rdi () (_ BitVec 64))
(declare-fun a0x401710_r8 () (_ BitVec 64))
(declare-fun a0x401710_r9 () (_ BitVec 64))
(declare-fun a0x401710_r10 () (_ BitVec 64))
(declare-fun a0x401710_r11 () (_ BitVec 64))
(declare-fun a0x401710_r12 () (_ BitVec 64))
(declare-fun a0x401710_r13 () (_ BitVec 64))
(declare-fun a0x401710_r14 () (_ BitVec 64))
(declare-fun a0x401710_r15 () (_ BitVec 64))
(declare-fun a0x401710_cf () Bool)
(declare-fun a0x401710_RESERVED_1 () Bool)
(declare-fun a0x401710_pf () Bool)
(declare-fun a0x401710_RESERVED_3 () Bool)
(declare-fun a0x401710_af () Bool)
(declare-fun a0x401710_RESERVED_5 () Bool)
(declare-fun a0x401710_zf () Bool)
(declare-fun a0x401710_sf () Bool)
(declare-fun a0x401710_tf () Bool)
(declare-fun a0x401710_if () Bool)
(define-fun a0x401710_df () Bool false)
(declare-fun a0x401710_of () Bool)
(declare-fun a0x401710_iopl1 () Bool)
(declare-fun a0x401710_iopl2 () Bool)
(declare-fun a0x401710_nt () Bool)
(declare-fun a0x401710_RESERVED_15 () Bool)
(declare-fun a0x401710_rf () Bool)
(declare-fun a0x401710_vm () Bool)
(declare-fun a0x401710_ac () Bool)
(declare-fun a0x401710_vif () Bool)
(declare-fun a0x401710_vip () Bool)
(declare-fun a0x401710_id () Bool)
(declare-fun a0x401710_el () Bool)
(declare-fun a0x401710_el0 () Bool)
(declare-fun a0x401710_el1 () Bool)
(declare-fun a0x401710_el2 () Bool)
(declare-fun a0x401710_el3 () Bool)
(declare-fun a0x401710_el4 () Bool)
(declare-fun a0x401710_el5 () Bool)
(declare-fun a0x401710_el6 () Bool)
(declare-fun a0x401710_el7 () Bool)
(declare-fun a0x401710_el8 () Bool)
(declare-fun a0x401710_xmm0 () (_ BitVec 512))
(declare-fun a0x401710_xmm1 () (_ BitVec 512))
(declare-fun a0x401710_xmm2 () (_ BitVec 512))
(declare-fun a0x401710_xmm3 () (_ BitVec 512))
(declare-fun a0x401710_xmm4 () (_ BitVec 512))
(declare-fun a0x401710_xmm5 () (_ BitVec 512))
(declare-fun a0x401710_xmm6 () (_ BitVec 512))
(declare-fun a0x401710_xmm7 () (_ BitVec 512))
(declare-fun a0x401710_xmm8 () (_ BitVec 512))
(declare-fun a0x401710_xmm9 () (_ BitVec 512))
(declare-fun a0x401710_xmm10 () (_ BitVec 512))
(declare-fun a0x401710_xmm11 () (_ BitVec 512))
(declare-fun a0x401710_xmm12 () (_ BitVec 512))
(declare-fun a0x401710_xmm13 () (_ BitVec 512))
(declare-fun a0x401710_xmm14 () (_ BitVec 512))
(declare-fun a0x401710_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t164 () (_ BitVec 64))
(declare-fun %t165 () (_ BitVec 32))
(declare-fun %t166 () (_ BitVec 32))
(declare-fun %t167 () (_ BitVec 32))
(assert (= %t164 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t165 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014))))
(assert (= %t166 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t167 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401710_rbx fnstart_rbx))
(assert (= a0x401710_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401710_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401710_r12 fnstart_r12))
(assert (= a0x401710_r13 fnstart_r13))
(assert (= a0x401710_r14 fnstart_r14))
(assert (= a0x401710_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t168 = zext i32 %t167 to i64
(define-fun %t168 () (_ BitVec 64) ((_ zero_extend 32) %t167))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x401710_rbp #xfffffffffffffffc))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x401710_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x401710_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x0000000000401731))
(assert true)
(assert true)
(assert true)
(assert (= %t168 rcx))
(assert (not a0x401710_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401731))
(declare-fun a0x401731_xmm15 () (_ BitVec 512))
(declare-fun a0x401731_xmm14 () (_ BitVec 512))
(declare-fun a0x401731_xmm13 () (_ BitVec 512))
(declare-fun a0x401731_xmm12 () (_ BitVec 512))
(declare-fun a0x401731_xmm11 () (_ BitVec 512))
(declare-fun a0x401731_xmm10 () (_ BitVec 512))
(declare-fun a0x401731_xmm9 () (_ BitVec 512))
(declare-fun a0x401731_xmm8 () (_ BitVec 512))
(declare-fun a0x401731_xmm7 () (_ BitVec 512))
(declare-fun a0x401731_xmm6 () (_ BitVec 512))
(declare-fun a0x401731_xmm5 () (_ BitVec 512))
(declare-fun a0x401731_xmm4 () (_ BitVec 512))
(declare-fun a0x401731_xmm3 () (_ BitVec 512))
(declare-fun a0x401731_xmm2 () (_ BitVec 512))
(declare-fun a0x401731_xmm1 () (_ BitVec 512))
(declare-fun a0x401731_xmm0 () (_ BitVec 512))
(declare-fun a0x401731_el8 () Bool)
(declare-fun a0x401731_el7 () Bool)
(declare-fun a0x401731_el6 () Bool)
(declare-fun a0x401731_el5 () Bool)
(declare-fun a0x401731_el4 () Bool)
(declare-fun a0x401731_el3 () Bool)
(declare-fun a0x401731_el2 () Bool)
(declare-fun a0x401731_el1 () Bool)
(declare-fun a0x401731_el0 () Bool)
(declare-fun a0x401731_el () Bool)
(declare-fun a0x401731_id () Bool)
(declare-fun a0x401731_vip () Bool)
(declare-fun a0x401731_vif () Bool)
(declare-fun a0x401731_ac () Bool)
(declare-fun a0x401731_vm () Bool)
(declare-fun a0x401731_rf () Bool)
(declare-fun a0x401731_RESERVED_15 () Bool)
(declare-fun a0x401731_nt () Bool)
(declare-fun a0x401731_iopl2 () Bool)
(declare-fun a0x401731_iopl1 () Bool)
(declare-fun a0x401731_of () Bool)
(define-fun a0x401731_df () Bool false)
(declare-fun a0x401731_if () Bool)
(declare-fun a0x401731_tf () Bool)
(declare-fun a0x401731_sf () Bool)
(declare-fun a0x401731_zf () Bool)
(declare-fun a0x401731_RESERVED_5 () Bool)
(declare-fun a0x401731_af () Bool)
(declare-fun a0x401731_RESERVED_3 () Bool)
(declare-fun a0x401731_pf () Bool)
(declare-fun a0x401731_RESERVED_1 () Bool)
(declare-fun a0x401731_cf () Bool)
(declare-fun a0x401731_r15 () (_ BitVec 64))
(declare-fun a0x401731_r14 () (_ BitVec 64))
(declare-fun a0x401731_r13 () (_ BitVec 64))
(declare-fun a0x401731_r12 () (_ BitVec 64))
(declare-fun a0x401731_r11 () (_ BitVec 64))
(declare-fun a0x401731_r10 () (_ BitVec 64))
(declare-fun a0x401731_r9 () (_ BitVec 64))
(declare-fun a0x401731_r8 () (_ BitVec 64))
(declare-fun a0x401731_rdi () (_ BitVec 64))
(declare-fun a0x401731_rsi () (_ BitVec 64))
(declare-fun a0x401731_rbp () (_ BitVec 64))
(declare-fun a0x401731_rsp () (_ BitVec 64))
(declare-fun a0x401731_rbx () (_ BitVec 64))
(declare-fun a0x401731_rdx () (_ BitVec 64))
(declare-fun a0x401731_rcx () (_ BitVec 64))
(declare-fun a0x401731_rax () (_ BitVec 64))
...
; LLVM:     jump label %block_0_401731
(assert true)
(assert (= a0x401731_df false))
(assert (= %t164 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t165 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000014))))
(assert (= %t166 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t167 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401710_rbx fnstart_rbx))
