; web.block_0_40167c.5 @ 0x401684: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t111 #b1)) (= a0x40167c_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
