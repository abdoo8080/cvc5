; web.block_0_401792.1 @ 0x40179c: precondition ((= (llvm t193) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t190 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
