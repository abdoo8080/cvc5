; web.block_0_40164a.2 @ 0x40164d: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t98 #b1)) (= a0x40164a_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
