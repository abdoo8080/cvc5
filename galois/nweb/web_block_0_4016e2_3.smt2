; web.block_0_4016e2.6 @ 0x4016f1: instruction pointer is expected value (true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t152 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111010010 (concat #b0 ((_ extract 31 0) rax0)))) #x00000000) false true) #x0000000000401731 #x00000000004016f7) #x00000000004016f7)))))
(exit)
