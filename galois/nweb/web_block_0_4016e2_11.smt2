; web.block_0_4016e2.6 @ 0x4016f1: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t152 #b1) (= a0x4016e2_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
