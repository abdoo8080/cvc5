; reopt___do_global_dtors_aux_0_0x401280.block_0_401296.2 @ 0x40129e: register value preserved (rbx, after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x401296_rbx fnstart_rbx))))
(exit)
