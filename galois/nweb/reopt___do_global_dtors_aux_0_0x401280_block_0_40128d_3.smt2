; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.0 @ 0x401291: return address is next instruction
(set-logic ALL)
...
(check-sat-assuming ((not (= (mem_readbv64 mem0 rsp0) #x0000000000401296))))
(exit)
