; web.block_0_40169f.3 @ 0x4016ab: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(assert (= %t122 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40169f_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x40169f_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
