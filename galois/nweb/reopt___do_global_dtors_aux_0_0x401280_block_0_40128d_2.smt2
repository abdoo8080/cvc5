; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.0 @ 0x401291: direction flag is expected value (function call)
(set-logic ALL)
...
(check-sat-assuming ((not (not a0x40128d_df))))
(exit)
