; reopt___do_global_dtors_aux_0_0x401280.block_0_4012a0.0 @ 0x4012a0: direction flag is expected value (function return)
(set-logic ALL)
...
(check-sat-assuming ((not (not a0x4012a0_df))))
(exit)
