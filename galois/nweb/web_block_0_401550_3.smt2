; web.block_0_401550.3 @ 0x401555: precondition ((= (llvm t35) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t21 #b1) (= %t16 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))))
(exit)
