; web.block_0_4017ab.1 @ 0x4017b6: precondition ((= (llvm t203) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t197 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
