; web.block_0_4017dd.5 @ 0x4017f5: precondition ((= (llvm t222) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t211 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
