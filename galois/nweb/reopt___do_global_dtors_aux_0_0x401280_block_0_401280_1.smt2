; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.1 @ 0x401284: read heap address not in stack space
(set-logic ALL)
...
(check-sat-assuming ((not (not_in_stack_range #x00000000004041c0 #x0000000000000008))))
(exit)
