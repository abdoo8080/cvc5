; web.block_0_401834.2 @ 0x401837: precondition ((= (llvm t249) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t241 #b1)) (= %t235 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040)))))))
(exit)
