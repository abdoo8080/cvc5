; web.block_0_40158a.5 @ 0x401592: precondition ((= (llvm t53) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t50 #b1)) (= %t44 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))))
(exit)
