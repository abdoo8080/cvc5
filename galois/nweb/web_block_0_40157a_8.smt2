; web.block_0_40157a.2 @ 0x40157a: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(assert (= %t37 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40157a_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x40157a_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
