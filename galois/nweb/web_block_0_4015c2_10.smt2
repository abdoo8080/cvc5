; web.block_0_4015c2.3 @ 0x4015c6: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(assert (= %t72 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4015c2_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x4015c2_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
