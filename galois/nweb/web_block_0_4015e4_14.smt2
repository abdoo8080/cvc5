; web.block_0_4015e4.2 @ 0x401600: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x4015e4_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
