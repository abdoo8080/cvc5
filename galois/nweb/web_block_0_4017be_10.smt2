; web.block_0_4017be.5 @ 0x4017d7: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t209 #b1) (= a0x4017be_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
