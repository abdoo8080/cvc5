; web.block_0_4015ce.1 @ 0x4015df: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4015ce_rax () (_ BitVec 64))
(declare-fun a0x4015ce_rcx () (_ BitVec 64))
(declare-fun a0x4015ce_rdx () (_ BitVec 64))
(declare-fun a0x4015ce_rbx () (_ BitVec 64))
(declare-fun a0x4015ce_rsp () (_ BitVec 64))
(declare-fun a0x4015ce_rbp () (_ BitVec 64))
(declare-fun a0x4015ce_rsi () (_ BitVec 64))
(declare-fun a0x4015ce_rdi () (_ BitVec 64))
(declare-fun a0x4015ce_r8 () (_ BitVec 64))
(declare-fun a0x4015ce_r9 () (_ BitVec 64))
(declare-fun a0x4015ce_r10 () (_ BitVec 64))
(declare-fun a0x4015ce_r11 () (_ BitVec 64))
(declare-fun a0x4015ce_r12 () (_ BitVec 64))
(declare-fun a0x4015ce_r13 () (_ BitVec 64))
(declare-fun a0x4015ce_r14 () (_ BitVec 64))
(declare-fun a0x4015ce_r15 () (_ BitVec 64))
(declare-fun a0x4015ce_cf () Bool)
(declare-fun a0x4015ce_RESERVED_1 () Bool)
(declare-fun a0x4015ce_pf () Bool)
(declare-fun a0x4015ce_RESERVED_3 () Bool)
(declare-fun a0x4015ce_af () Bool)
(declare-fun a0x4015ce_RESERVED_5 () Bool)
(declare-fun a0x4015ce_zf () Bool)
(declare-fun a0x4015ce_sf () Bool)
(declare-fun a0x4015ce_tf () Bool)
(declare-fun a0x4015ce_if () Bool)
(define-fun a0x4015ce_df () Bool false)
(declare-fun a0x4015ce_of () Bool)
(declare-fun a0x4015ce_iopl1 () Bool)
(declare-fun a0x4015ce_iopl2 () Bool)
(declare-fun a0x4015ce_nt () Bool)
(declare-fun a0x4015ce_RESERVED_15 () Bool)
(declare-fun a0x4015ce_rf () Bool)
(declare-fun a0x4015ce_vm () Bool)
(declare-fun a0x4015ce_ac () Bool)
(declare-fun a0x4015ce_vif () Bool)
(declare-fun a0x4015ce_vip () Bool)
(declare-fun a0x4015ce_id () Bool)
(declare-fun a0x4015ce_el () Bool)
(declare-fun a0x4015ce_el0 () Bool)
(declare-fun a0x4015ce_el1 () Bool)
(declare-fun a0x4015ce_el2 () Bool)
(declare-fun a0x4015ce_el3 () Bool)
(declare-fun a0x4015ce_el4 () Bool)
(declare-fun a0x4015ce_el5 () Bool)
(declare-fun a0x4015ce_el6 () Bool)
(declare-fun a0x4015ce_el7 () Bool)
(declare-fun a0x4015ce_el8 () Bool)
(declare-fun a0x4015ce_xmm0 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm1 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm2 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm3 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm4 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm5 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm6 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm7 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm8 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm9 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm10 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm11 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm12 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm13 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm14 () (_ BitVec 512))
(declare-fun a0x4015ce_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t75 () (_ BitVec 64))
(declare-fun %t76 () (_ BitVec 64))
(declare-fun %t77 () (_ BitVec 32))
(declare-fun %t78 () (_ BitVec 32))
(assert (= %t75 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t76 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t77 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t78 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4015ce_rbx fnstart_rbx))
(assert (= a0x4015ce_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4015ce_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4015ce_r12 fnstart_r12))
(assert (= a0x4015ce_r13 fnstart_r13))
(assert (= a0x4015ce_r14 fnstart_r14))
(assert (= a0x4015ce_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t79 = add i64 %t76, 1
(define-fun %t79 () (_ BitVec 64) (bvadd %t76 #x0000000000000001))
; LLVM:     jump label %block_0_40158a
(define-fun addr () (_ BitVec 64) (bvadd a0x4015ce_rbp #xffffffffffffffe0))
...
(define-fun addr0 () (_ BitVec 64) (bvadd a0x4015ce_rbp #xffffffffffffffe0))
...
(assert true)
(assert (= a0x4015ce_df false))
(assert (= %t75 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t79 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t77 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t78 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4015ce_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x4015ce_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
