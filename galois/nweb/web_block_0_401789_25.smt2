; web.block_0_401789.2 @ 0x40178c: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun %t185 () (_ BitVec 64))
(declare-fun %t186 () (_ BitVec 32))
(declare-fun %t187 () (_ BitVec 32))
(assert (= %t185 a0x401789_rax))
(assert (= %t186 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t187 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401789_rbx fnstart_rbx))
(assert (= a0x401789_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401789_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401789_r12 fnstart_r12))
(assert (= a0x401789_r13 fnstart_r13))
(assert (= a0x401789_r14 fnstart_r14))
(assert (= a0x401789_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t188 = trunc i64 %t185 to i32
(define-fun %t188 () (_ BitVec 32) ((_ extract 31 0) %t185))
; LLVM:     %t189 = icmp eq i32 %t188, 0
(define-fun %t189 () (_ BitVec 1) (ite (= %t188 #x00000000) #b1 #b0))
; LLVM:     br i1 %t189, label %block_0_401792, label %block_0_4017a1
(assert (=> (= %t189 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401789_rax)))) #x00000000) false true) #x00000000004017a1 #x0000000000401792) #x0000000000401792)))
(assert (=> (= %t189 #b1) (= a0x401789_df false)))
(assert (=> (= %t189 #b1) (= %t186 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t189 #b1) (= %t187 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t189 #b1) (= a0x401789_rbx fnstart_rbx)))
(assert (=> (= %t189 #b1) (= a0x401789_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t189 #b1) (= a0x401789_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t189 #b1) (= a0x401789_r12 fnstart_r12)))
(assert (=> (= %t189 #b1) (= a0x401789_r13 fnstart_r13)))
(assert (=> (= %t189 #b1) (= a0x401789_r14 fnstart_r14)))
(assert (=> (= %t189 #b1) (= a0x401789_r15 fnstart_r15)))
(assert (=> (= %t189 #b1) (= (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401789_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401789_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401789_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true) a0x401789_df)))
(assert (=> (= %t189 #b1) (= (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401789_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401789_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401789_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true) (and (not (= (bvand ((_ extract 31 0) a0x401789_rax) #x80000000) #x00000000)) (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401789_rax))) #b010000000000000000000000000000000) #b000000000000000000000000000000000)) false true)))))
(assert (=> (= %t189 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t189 #b1)) (= (ite (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401789_rax)))) #x00000000) false true) #x00000000004017a1 #x0000000000401792) #x00000000004017a1)))
(assert (=> (not (= %t189 #b1)) (= a0x401789_df false)))
(assert (=> (not (= %t189 #b1)) (= %t186 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t189 #b1)) (= %t187 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t189 #b1)) (= a0x401789_rbx fnstart_rbx)))
(assert (=> (not (= %t189 #b1)) (= a0x401789_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t189 #b1)) (= a0x401789_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t189 #b1)) (= a0x401789_r12 fnstart_r12)))
(assert (=> (not (= %t189 #b1)) (= a0x401789_r13 fnstart_r13)))
(assert (=> (not (= %t189 #b1)) (= a0x401789_r14 fnstart_r14)))
(assert (=> (not (= %t189 #b1)) (= a0x401789_r15 fnstart_r15)))
(check-sat-assuming ((not (=> (not (= %t189 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
