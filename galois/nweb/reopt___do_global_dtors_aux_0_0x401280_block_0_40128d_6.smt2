; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.1 @ 0x401291: precondition ((= rbx (fnstart rbx)), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x40128d_rbx fnstart_rbx))))
(exit)
