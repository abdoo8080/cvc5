; web.block_0_401569.3 @ 0x401575: precondition ((= (llvm t39) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t30 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))))
(exit)
