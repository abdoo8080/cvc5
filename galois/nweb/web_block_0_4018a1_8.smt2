; web.block_0_4018a1.1 @ 0x4018b3: precondition ((= (llvm t268) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t263 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))))
(exit)
