; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.1 @ 0x401284: LLVM and machine code load from same heap address
(set-logic ALL)
...
(check-sat-assuming ((not (= #x00000000004041c0 %t0))))
(exit)
