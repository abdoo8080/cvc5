; web.block_0_4016e2.6 @ 0x4016f1: precondition ((= (llvm t154) (mcstack (bvsub stack_high (_ bv20 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t152 #b1) (= %t144 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014)))))))
(exit)
