; web.block_0_401880.2 @ 0x40189c: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x401880_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
