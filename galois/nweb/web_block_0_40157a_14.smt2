; web.block_0_40157a.2 @ 0x40157a: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(declare-fun a0x40157a_rax () (_ BitVec 64))
(declare-fun a0x40157a_rcx () (_ BitVec 64))
(declare-fun a0x40157a_rdx () (_ BitVec 64))
(declare-fun a0x40157a_rbx () (_ BitVec 64))
(declare-fun a0x40157a_rsp () (_ BitVec 64))
(declare-fun a0x40157a_rbp () (_ BitVec 64))
(declare-fun a0x40157a_rsi () (_ BitVec 64))
(declare-fun a0x40157a_rdi () (_ BitVec 64))
(declare-fun a0x40157a_r8 () (_ BitVec 64))
(declare-fun a0x40157a_r9 () (_ BitVec 64))
(declare-fun a0x40157a_r10 () (_ BitVec 64))
(declare-fun a0x40157a_r11 () (_ BitVec 64))
(declare-fun a0x40157a_r12 () (_ BitVec 64))
(declare-fun a0x40157a_r13 () (_ BitVec 64))
(declare-fun a0x40157a_r14 () (_ BitVec 64))
(declare-fun a0x40157a_r15 () (_ BitVec 64))
(declare-fun a0x40157a_cf () Bool)
(declare-fun a0x40157a_RESERVED_1 () Bool)
(declare-fun a0x40157a_pf () Bool)
(declare-fun a0x40157a_RESERVED_3 () Bool)
(declare-fun a0x40157a_af () Bool)
(declare-fun a0x40157a_RESERVED_5 () Bool)
(declare-fun a0x40157a_zf () Bool)
(declare-fun a0x40157a_sf () Bool)
(declare-fun a0x40157a_tf () Bool)
(declare-fun a0x40157a_if () Bool)
(define-fun a0x40157a_df () Bool false)
(declare-fun a0x40157a_of () Bool)
(declare-fun a0x40157a_iopl1 () Bool)
(declare-fun a0x40157a_iopl2 () Bool)
(declare-fun a0x40157a_nt () Bool)
(declare-fun a0x40157a_RESERVED_15 () Bool)
(declare-fun a0x40157a_rf () Bool)
(declare-fun a0x40157a_vm () Bool)
(declare-fun a0x40157a_ac () Bool)
(declare-fun a0x40157a_vif () Bool)
(declare-fun a0x40157a_vip () Bool)
(declare-fun a0x40157a_id () Bool)
(declare-fun a0x40157a_el () Bool)
(declare-fun a0x40157a_el0 () Bool)
(declare-fun a0x40157a_el1 () Bool)
(declare-fun a0x40157a_el2 () Bool)
(declare-fun a0x40157a_el3 () Bool)
(declare-fun a0x40157a_el4 () Bool)
(declare-fun a0x40157a_el5 () Bool)
(declare-fun a0x40157a_el6 () Bool)
(declare-fun a0x40157a_el7 () Bool)
(declare-fun a0x40157a_el8 () Bool)
(declare-fun a0x40157a_xmm0 () (_ BitVec 512))
(declare-fun a0x40157a_xmm1 () (_ BitVec 512))
(declare-fun a0x40157a_xmm2 () (_ BitVec 512))
(declare-fun a0x40157a_xmm3 () (_ BitVec 512))
(declare-fun a0x40157a_xmm4 () (_ BitVec 512))
(declare-fun a0x40157a_xmm5 () (_ BitVec 512))
(declare-fun a0x40157a_xmm6 () (_ BitVec 512))
(declare-fun a0x40157a_xmm7 () (_ BitVec 512))
(declare-fun a0x40157a_xmm8 () (_ BitVec 512))
(declare-fun a0x40157a_xmm9 () (_ BitVec 512))
(declare-fun a0x40157a_xmm10 () (_ BitVec 512))
(declare-fun a0x40157a_xmm11 () (_ BitVec 512))
(declare-fun a0x40157a_xmm12 () (_ BitVec 512))
(declare-fun a0x40157a_xmm13 () (_ BitVec 512))
(declare-fun a0x40157a_xmm14 () (_ BitVec 512))
(declare-fun a0x40157a_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t35 () (_ BitVec 64))
(declare-fun %t36 () (_ BitVec 32))
(declare-fun %t37 () (_ BitVec 32))
(assert (= %t35 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t36 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t37 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40157a_rbx fnstart_rbx))
(assert (= a0x40157a_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40157a_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40157a_r12 fnstart_r12))
(assert (= a0x40157a_r13 fnstart_r13))
(assert (= a0x40157a_r14 fnstart_r14))
(assert (= a0x40157a_r15 fnstart_r15))
(assert (= a0x40157a_af a0x40157a_df))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t38 = inttoptr i64 4211152 to i8*
(define-fun %t38 () (_ BitVec 64) #x00000000004041d0)
; LLVM:     store i8 0, i8* %t38, align 0
(assert (= %t38 #x00000000004041d0))
(assert true)
; LLVM:     jump label %block_0_401582
(assert true)
(assert (= a0x40157a_df false))
(assert (= %t35 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t36 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t37 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40157a_rbx fnstart_rbx))
