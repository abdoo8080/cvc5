; web.block_0_40168a.5 @ 0x401699: precondition ((= (llvm t122) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t119 #b1) (= %t114 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
