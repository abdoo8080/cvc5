; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.1 @ 0x401291: precondition ((= r14 (fnstart r14)), for jump)
(set-logic ALL)
...
(assert (= a0x40128d_r12 fnstart_r12))
(assert (= a0x40128d_r13 fnstart_r13))
(check-sat-assuming ((not (= a0x40128d_r14 fnstart_r14))))
(exit)
