; web.block_0_401834.2 @ 0x401837: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t241 #b1) (= a0x401834_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
