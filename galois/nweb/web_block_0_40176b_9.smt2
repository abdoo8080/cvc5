; web.block_0_40176b.1 @ 0x401784: precondition ((= (llvm t186) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t182 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
