; web.block_0_4017a1.1 @ 0x4017a6: precondition ((= (llvm t198) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t194 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
