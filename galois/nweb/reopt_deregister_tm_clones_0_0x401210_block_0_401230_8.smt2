; reopt_deregister_tm_clones_0_0x401210.block_0_401230.0 @ 0x401230: register value preserved (r14, after return)
(set-logic ALL)
...
(assert (= a0x401230_r12 fnstart_r12))
(assert (= a0x401230_r13 fnstart_r13))
(check-sat-assuming ((not (= a0x401230_r14 fnstart_r14))))
(exit)
