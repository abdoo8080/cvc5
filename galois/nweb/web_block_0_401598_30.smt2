; web.block_0_401598.5 @ 0x4015a7: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun a0x401598_rax () (_ BitVec 64))
(declare-fun a0x401598_rcx () (_ BitVec 64))
(declare-fun a0x401598_rdx () (_ BitVec 64))
(declare-fun a0x401598_rbx () (_ BitVec 64))
(declare-fun a0x401598_rsp () (_ BitVec 64))
(declare-fun a0x401598_rbp () (_ BitVec 64))
(declare-fun a0x401598_rsi () (_ BitVec 64))
(declare-fun a0x401598_rdi () (_ BitVec 64))
(declare-fun a0x401598_r8 () (_ BitVec 64))
(declare-fun a0x401598_r9 () (_ BitVec 64))
(declare-fun a0x401598_r10 () (_ BitVec 64))
(declare-fun a0x401598_r11 () (_ BitVec 64))
(declare-fun a0x401598_r12 () (_ BitVec 64))
(declare-fun a0x401598_r13 () (_ BitVec 64))
(declare-fun a0x401598_r14 () (_ BitVec 64))
(declare-fun a0x401598_r15 () (_ BitVec 64))
(declare-fun a0x401598_cf () Bool)
(declare-fun a0x401598_RESERVED_1 () Bool)
(declare-fun a0x401598_pf () Bool)
(declare-fun a0x401598_RESERVED_3 () Bool)
(declare-fun a0x401598_af () Bool)
(declare-fun a0x401598_RESERVED_5 () Bool)
(declare-fun a0x401598_zf () Bool)
(declare-fun a0x401598_sf () Bool)
(declare-fun a0x401598_tf () Bool)
(declare-fun a0x401598_if () Bool)
(define-fun a0x401598_df () Bool false)
(declare-fun a0x401598_of () Bool)
(declare-fun a0x401598_iopl1 () Bool)
(declare-fun a0x401598_iopl2 () Bool)
(declare-fun a0x401598_nt () Bool)
(declare-fun a0x401598_RESERVED_15 () Bool)
(declare-fun a0x401598_rf () Bool)
(declare-fun a0x401598_vm () Bool)
(declare-fun a0x401598_ac () Bool)
(declare-fun a0x401598_vif () Bool)
(declare-fun a0x401598_vip () Bool)
(declare-fun a0x401598_id () Bool)
(declare-fun a0x401598_el () Bool)
(declare-fun a0x401598_el0 () Bool)
(declare-fun a0x401598_el1 () Bool)
(declare-fun a0x401598_el2 () Bool)
(declare-fun a0x401598_el3 () Bool)
(declare-fun a0x401598_el4 () Bool)
(declare-fun a0x401598_el5 () Bool)
(declare-fun a0x401598_el6 () Bool)
(declare-fun a0x401598_el7 () Bool)
(declare-fun a0x401598_el8 () Bool)
(declare-fun a0x401598_xmm0 () (_ BitVec 512))
(declare-fun a0x401598_xmm1 () (_ BitVec 512))
(declare-fun a0x401598_xmm2 () (_ BitVec 512))
(declare-fun a0x401598_xmm3 () (_ BitVec 512))
(declare-fun a0x401598_xmm4 () (_ BitVec 512))
(declare-fun a0x401598_xmm5 () (_ BitVec 512))
(declare-fun a0x401598_xmm6 () (_ BitVec 512))
(declare-fun a0x401598_xmm7 () (_ BitVec 512))
(declare-fun a0x401598_xmm8 () (_ BitVec 512))
(declare-fun a0x401598_xmm9 () (_ BitVec 512))
(declare-fun a0x401598_xmm10 () (_ BitVec 512))
(declare-fun a0x401598_xmm11 () (_ BitVec 512))
(declare-fun a0x401598_xmm12 () (_ BitVec 512))
(declare-fun a0x401598_xmm13 () (_ BitVec 512))
(declare-fun a0x401598_xmm14 () (_ BitVec 512))
(declare-fun a0x401598_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t51 () (_ BitVec 64))
(declare-fun %t52 () (_ BitVec 64))
(declare-fun %t53 () (_ BitVec 32))
(declare-fun %t54 () (_ BitVec 32))
(assert (= %t51 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t52 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t53 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t54 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401598_rbx fnstart_rbx))
(assert (= a0x401598_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401598_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401598_r12 fnstart_r12))
(assert (= a0x401598_r13 fnstart_r13))
(assert (= a0x401598_r14 fnstart_r14))
(assert (= a0x401598_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t55 = add i64 %t52, 4211152
(define-fun %t55 () (_ BitVec 64) (bvadd %t52 #x00000000004041d0))
; LLVM:     %t56 = inttoptr i64 %t55 to i8*
(define-fun %t56 () (_ BitVec 64) %t55)
; LLVM:     %t57 = load i8* %t56, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x401598_rbp #xffffffffffffffe0))
...
(define-fun %t57 () (_ BitVec 8) (mem_readbv8 init_mem addr0))
; LLVM:     %t58 = sext i8 %t57 to i32
(define-fun %t58 () (_ BitVec 32) ((_ sign_extend 24) %t57))
; LLVM:     %t59 = icmp eq i32 %t58, 13
(define-fun %t59 () (_ BitVec 1) (ite (= %t58 #x0000000d) #b1 #b0))
; LLVM:     br i1 %t59, label %block_0_4015c2, label %block_0_4015ad
(define-fun rax () (_ BitVec 64) ((_ zero_extend 32) ((_ sign_extend 24) readv0)))
(assert (=> (= %t59 #b1) (= (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111110011 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) #x00000000004015c2 #x00000000004015ad) #x00000000004015c2)))
(assert (=> (= %t59 #b1) (= a0x401598_df false)))
(assert (=> (= %t59 #b1) (= %t51 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))
(assert (=> (= %t59 #b1) (= %t52 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (= %t59 #b1) (= %t53 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t59 #b1) (= %t54 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t59 #b1) (= a0x401598_rbx fnstart_rbx)))
(assert (=> (= %t59 #b1) (= a0x401598_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t59 #b1) (= a0x401598_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t59 #b1) (= a0x401598_r12 fnstart_r12)))
(assert (=> (= %t59 #b1) (= a0x401598_r13 fnstart_r13)))
(assert (=> (= %t59 #b1) (= a0x401598_r14 fnstart_r14)))
(assert (=> (= %t59 #b1) (= a0x401598_r15 fnstart_r15)))
(assert (=> (= %t59 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t59 #b1)) (= (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111110011 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) #x00000000004015c2 #x00000000004015ad) #x00000000004015ad)))
(assert (=> (not (= %t59 #b1)) (= a0x401598_df false)))
(assert (=> (not (= %t59 #b1)) (= %t51 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))
(assert (=> (not (= %t59 #b1)) (= %t52 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (not (= %t59 #b1)) (= %t53 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t59 #b1)) (= %t54 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t59 #b1)) (= a0x401598_rbx fnstart_rbx)))
(assert (=> (not (= %t59 #b1)) (= a0x401598_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t59 #b1)) (= a0x401598_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t59 #b1)) (= a0x401598_r12 fnstart_r12)))
(assert (=> (not (= %t59 #b1)) (= a0x401598_r13 fnstart_r13)))
(assert (=> (not (= %t59 #b1)) (= a0x401598_r14 fnstart_r14)))
(assert (=> (not (= %t59 #b1)) (= a0x401598_r15 fnstart_r15)))
(check-sat-assuming ((not (=> (not (= %t59 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
