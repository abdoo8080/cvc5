; reopt_deregister_tm_clones_0_0x401210.block_0_401230.0 @ 0x401230: direction flag is expected value (function return)
(set-logic ALL)
...
(check-sat-assuming ((not (not a0x401230_df))))
(exit)
