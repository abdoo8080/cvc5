; web.block_0_4019c4.2 @ 0x4019d5: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4019c4_rax () (_ BitVec 64))
(declare-fun a0x4019c4_rcx () (_ BitVec 64))
(declare-fun a0x4019c4_rdx () (_ BitVec 64))
(declare-fun a0x4019c4_rbx () (_ BitVec 64))
(declare-fun a0x4019c4_rsp () (_ BitVec 64))
(declare-fun a0x4019c4_rbp () (_ BitVec 64))
(declare-fun a0x4019c4_rsi () (_ BitVec 64))
(declare-fun a0x4019c4_rdi () (_ BitVec 64))
(declare-fun a0x4019c4_r8 () (_ BitVec 64))
(declare-fun a0x4019c4_r9 () (_ BitVec 64))
(declare-fun a0x4019c4_r10 () (_ BitVec 64))
(declare-fun a0x4019c4_r11 () (_ BitVec 64))
(declare-fun a0x4019c4_r12 () (_ BitVec 64))
(declare-fun a0x4019c4_r13 () (_ BitVec 64))
(declare-fun a0x4019c4_r14 () (_ BitVec 64))
(declare-fun a0x4019c4_r15 () (_ BitVec 64))
(declare-fun a0x4019c4_cf () Bool)
(declare-fun a0x4019c4_RESERVED_1 () Bool)
(declare-fun a0x4019c4_pf () Bool)
(declare-fun a0x4019c4_RESERVED_3 () Bool)
(declare-fun a0x4019c4_af () Bool)
(declare-fun a0x4019c4_RESERVED_5 () Bool)
(declare-fun a0x4019c4_zf () Bool)
(declare-fun a0x4019c4_sf () Bool)
(declare-fun a0x4019c4_tf () Bool)
(declare-fun a0x4019c4_if () Bool)
(define-fun a0x4019c4_df () Bool false)
(declare-fun a0x4019c4_of () Bool)
(declare-fun a0x4019c4_iopl1 () Bool)
(declare-fun a0x4019c4_iopl2 () Bool)
(declare-fun a0x4019c4_nt () Bool)
(declare-fun a0x4019c4_RESERVED_15 () Bool)
(declare-fun a0x4019c4_rf () Bool)
(declare-fun a0x4019c4_vm () Bool)
(declare-fun a0x4019c4_ac () Bool)
(declare-fun a0x4019c4_vif () Bool)
(declare-fun a0x4019c4_vip () Bool)
(declare-fun a0x4019c4_id () Bool)
(declare-fun a0x4019c4_el () Bool)
(declare-fun a0x4019c4_el0 () Bool)
(declare-fun a0x4019c4_el1 () Bool)
(declare-fun a0x4019c4_el2 () Bool)
(declare-fun a0x4019c4_el3 () Bool)
(declare-fun a0x4019c4_el4 () Bool)
(declare-fun a0x4019c4_el5 () Bool)
(declare-fun a0x4019c4_el6 () Bool)
(declare-fun a0x4019c4_el7 () Bool)
(declare-fun a0x4019c4_el8 () Bool)
(declare-fun a0x4019c4_xmm0 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm1 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm2 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm3 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm4 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm5 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm6 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm7 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm8 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm9 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm10 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm11 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm12 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm13 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm14 () (_ BitVec 512))
(declare-fun a0x4019c4_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t325 () (_ BitVec 64))
(declare-fun %t326 () (_ BitVec 32))
(declare-fun %t327 () (_ BitVec 32))
(assert (= %t325 a0x4019c4_rax))
(assert (= %t325 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t326 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t327 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4019c4_rbx fnstart_rbx))
(assert (= a0x4019c4_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4019c4_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4019c4_r12 fnstart_r12))
(assert (= a0x4019c4_r13 fnstart_r13))
(assert (= a0x4019c4_r14 fnstart_r14))
(assert (= a0x4019c4_r15 fnstart_r15))
(assert (= a0x4019c4_cf a0x4019c4_af))
(assert (= a0x4019c4_cf a0x4019c4_df))
(assert (= a0x4019c4_cf a0x4019c4_of))
(assert (= a0x4019c4_rax (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t328 = zext i32 %t327 to i64
(define-fun %t328 () (_ BitVec 64) ((_ zero_extend 32) %t327))
; LLVM:     %t329 = call i64 @write (i64 %t328,i64 4211152,i64 %t325)
(define-fun addr () (_ BitVec 64) (bvadd a0x4019c4_rbp #xfffffffffffffffc))
...
(define-fun addr0 () (_ BitVec 64) (bvadd a0x4019c4_rbp #xffffffffffffffd8))
(declare-fun readv0 () (_ BitVec 64))
(assert (on_stack addr0 #x0000000000000008))
(assert (= readv0 (mem_readbv64 init_mem addr0)))
(define-fun rsp () (_ BitVec 64) (bvsub a0x4019c4_rsp #x0000000000000008))
(define-fun addr1 () (_ BitVec 64) (bvsub a0x4019c4_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr1 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr1 #x00000000004019da))
(assert (= %t328 rdi))
(assert true)
(assert (= %t325 readv0))
(assert (not a0x4019c4_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004019da))
(declare-fun a0x4019da_xmm15 () (_ BitVec 512))
(declare-fun a0x4019da_xmm14 () (_ BitVec 512))
(declare-fun a0x4019da_xmm13 () (_ BitVec 512))
(declare-fun a0x4019da_xmm12 () (_ BitVec 512))
(declare-fun a0x4019da_xmm11 () (_ BitVec 512))
(declare-fun a0x4019da_xmm10 () (_ BitVec 512))
(declare-fun a0x4019da_xmm9 () (_ BitVec 512))
(declare-fun a0x4019da_xmm8 () (_ BitVec 512))
(declare-fun a0x4019da_xmm7 () (_ BitVec 512))
(declare-fun a0x4019da_xmm6 () (_ BitVec 512))
(declare-fun a0x4019da_xmm5 () (_ BitVec 512))
(declare-fun a0x4019da_xmm4 () (_ BitVec 512))
(declare-fun a0x4019da_xmm3 () (_ BitVec 512))
(declare-fun a0x4019da_xmm2 () (_ BitVec 512))
(declare-fun a0x4019da_xmm1 () (_ BitVec 512))
(declare-fun a0x4019da_xmm0 () (_ BitVec 512))
(declare-fun a0x4019da_el8 () Bool)
(declare-fun a0x4019da_el7 () Bool)
(declare-fun a0x4019da_el6 () Bool)
(declare-fun a0x4019da_el5 () Bool)
(declare-fun a0x4019da_el4 () Bool)
(declare-fun a0x4019da_el3 () Bool)
(declare-fun a0x4019da_el2 () Bool)
(declare-fun a0x4019da_el1 () Bool)
(declare-fun a0x4019da_el0 () Bool)
(declare-fun a0x4019da_el () Bool)
(declare-fun a0x4019da_id () Bool)
(declare-fun a0x4019da_vip () Bool)
(declare-fun a0x4019da_vif () Bool)
(declare-fun a0x4019da_ac () Bool)
(declare-fun a0x4019da_vm () Bool)
(declare-fun a0x4019da_rf () Bool)
(declare-fun a0x4019da_RESERVED_15 () Bool)
(declare-fun a0x4019da_nt () Bool)
(declare-fun a0x4019da_iopl2 () Bool)
(declare-fun a0x4019da_iopl1 () Bool)
(declare-fun a0x4019da_of () Bool)
(define-fun a0x4019da_df () Bool false)
(declare-fun a0x4019da_if () Bool)
(declare-fun a0x4019da_tf () Bool)
(declare-fun a0x4019da_sf () Bool)
(declare-fun a0x4019da_zf () Bool)
(declare-fun a0x4019da_RESERVED_5 () Bool)
(declare-fun a0x4019da_af () Bool)
(declare-fun a0x4019da_RESERVED_3 () Bool)
(declare-fun a0x4019da_pf () Bool)
(declare-fun a0x4019da_RESERVED_1 () Bool)
(declare-fun a0x4019da_cf () Bool)
(declare-fun a0x4019da_r15 () (_ BitVec 64))
(declare-fun a0x4019da_r14 () (_ BitVec 64))
(declare-fun a0x4019da_r13 () (_ BitVec 64))
(declare-fun a0x4019da_r12 () (_ BitVec 64))
(declare-fun a0x4019da_r11 () (_ BitVec 64))
(declare-fun a0x4019da_r10 () (_ BitVec 64))
(declare-fun a0x4019da_r9 () (_ BitVec 64))
(declare-fun a0x4019da_r8 () (_ BitVec 64))
(declare-fun a0x4019da_rdi () (_ BitVec 64))
(declare-fun a0x4019da_rsi () (_ BitVec 64))
(declare-fun a0x4019da_rbp () (_ BitVec 64))
(declare-fun a0x4019da_rsp () (_ BitVec 64))
(declare-fun a0x4019da_rbx () (_ BitVec 64))
(declare-fun a0x4019da_rdx () (_ BitVec 64))
(declare-fun a0x4019da_rcx () (_ BitVec 64))
(declare-fun a0x4019da_rax () (_ BitVec 64))
...
(define-fun %t329 () (_ BitVec 64) a0x4019da_rax)
; LLVM:     jump label %block_0_4019da
(assert true)
(assert (= a0x4019da_df false))
(assert (= %t326 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t327 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4019c4_rbx fnstart_rbx))
