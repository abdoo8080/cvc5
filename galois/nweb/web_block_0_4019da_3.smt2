; web.block_0_4019da.0 @ 0x4019da: precondition ((= (llvm t316) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(assert (= %t330 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(check-sat-assuming ((not (= %t331 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
