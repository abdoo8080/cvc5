; web.block_0_401834.2 @ 0x401837: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun %t234 () (_ BitVec 64))
(declare-fun %t235 () (_ BitVec 64))
(declare-fun %t236 () (_ BitVec 64))
(declare-fun %t237 () (_ BitVec 32))
(declare-fun %t238 () (_ BitVec 32))
(declare-fun %t239 () (_ BitVec 32))
(assert (= %t234 a0x401834_rax))
(assert (= %t235 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t236 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t237 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000001c))))
(assert (= %t238 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t239 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401834_rbx fnstart_rbx))
(assert (= a0x401834_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401834_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401834_r12 fnstart_r12))
(assert (= a0x401834_r13 fnstart_r13))
(assert (= a0x401834_r14 fnstart_r14))
(assert (= a0x401834_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t240 = trunc i64 %t234 to i32
(define-fun %t240 () (_ BitVec 32) ((_ extract 31 0) %t234))
; LLVM:     %t241 = icmp eq i32 %t240, 0
(define-fun %t241 () (_ BitVec 1) (ite (= %t240 #x00000000) #b1 #b0))
; LLVM:     br i1 %t241, label %block_0_40183d, label %block_0_40185f
(assert (=> (= %t241 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax)))) #x00000000) false true) #x000000000040185f #x000000000040183d) #x000000000040183d)))
(assert (=> (= %t241 #b1) (= a0x401834_df false)))
(assert (=> (= %t241 #b1) (= %t236 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (= %t241 #b1) (= %t238 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t241 #b1) (= %t239 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t241 #b1) (= a0x401834_rbx fnstart_rbx)))
(assert (=> (= %t241 #b1) (= a0x401834_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t241 #b1) (= a0x401834_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t241 #b1) (= a0x401834_r12 fnstart_r12)))
(assert (=> (= %t241 #b1) (= a0x401834_r13 fnstart_r13)))
(assert (=> (= %t241 #b1) (= a0x401834_r14 fnstart_r14)))
(assert (=> (= %t241 #b1) (= a0x401834_r15 fnstart_r15)))
(assert (=> (= %t241 #b1) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401834_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true))))
(assert (=> (= %t241 #b1) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) a0x401834_df)))
(assert (=> (= %t241 #b1) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (and (not (= (bvand ((_ extract 31 0) a0x401834_rax) #x80000000) #x00000000)) (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b010000000000000000000000000000000) #b000000000000000000000000000000000)) false true)))))
(assert (=> (= %t241 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t241 #b1)) (= (ite (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax)))) #x00000000) false true) #x000000000040185f #x000000000040183d) #x000000000040185f)))
(assert (=> (not (= %t241 #b1)) (= a0x401834_df false)))
(assert (=> (not (= %t241 #b1)) (= %t235 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040)))))
(assert (=> (not (= %t241 #b1)) (= %t236 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (not (= %t241 #b1)) (= %t237 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000001c)))))
(assert (=> (not (= %t241 #b1)) (= %t238 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t241 #b1)) (= %t239 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t241 #b1)) (= a0x401834_rbx fnstart_rbx)))
(assert (=> (not (= %t241 #b1)) (= a0x401834_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t241 #b1)) (= a0x401834_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t241 #b1)) (= a0x401834_r12 fnstart_r12)))
(assert (=> (not (= %t241 #b1)) (= a0x401834_r13 fnstart_r13)))
(assert (=> (not (= %t241 #b1)) (= a0x401834_r14 fnstart_r14)))
(assert (=> (not (= %t241 #b1)) (= a0x401834_r15 fnstart_r15)))
(assert (=> (not (= %t241 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401834_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true))))
(assert (=> (not (= %t241 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) a0x401834_df)))
(assert (=> (not (= %t241 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (and (not (= (bvand ((_ extract 31 0) a0x401834_rax) #x80000000) #x00000000)) (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401834_rax))) #b010000000000000000000000000000000) #b000000000000000000000000000000000)) false true)))))
(check-sat-assuming ((not (=> (not (= %t241 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
