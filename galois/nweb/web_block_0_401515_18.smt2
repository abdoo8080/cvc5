; web.block_0_401515.1 @ 0x40151e: precondition ((= (llvm t8) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t7 #b1)) (= %t4 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000030)))))))
(exit)
