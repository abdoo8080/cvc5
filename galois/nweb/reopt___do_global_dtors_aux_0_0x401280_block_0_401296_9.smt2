; reopt___do_global_dtors_aux_0_0x401280.block_0_401296.2 @ 0x40129e: register value preserved (r12, after return)
(set-logic ALL)
...
(assert (= a0x401296_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x401296_r12 fnstart_r12))))
(exit)
