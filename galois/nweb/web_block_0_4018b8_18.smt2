; web.block_0_4018b8.2 @ 0x4018be: precondition ((= (llvm t279) (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t272 #b1)) (= %t271 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000018)))))))
(exit)
