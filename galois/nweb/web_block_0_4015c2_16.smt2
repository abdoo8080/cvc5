; web.block_0_4015c2.3 @ 0x4015c6: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(declare-fun a0x4015c2_rax () (_ BitVec 64))
(declare-fun a0x4015c2_rcx () (_ BitVec 64))
(declare-fun a0x4015c2_rdx () (_ BitVec 64))
(declare-fun a0x4015c2_rbx () (_ BitVec 64))
(declare-fun a0x4015c2_rsp () (_ BitVec 64))
(declare-fun a0x4015c2_rbp () (_ BitVec 64))
(declare-fun a0x4015c2_rsi () (_ BitVec 64))
(declare-fun a0x4015c2_rdi () (_ BitVec 64))
(declare-fun a0x4015c2_r8 () (_ BitVec 64))
(declare-fun a0x4015c2_r9 () (_ BitVec 64))
(declare-fun a0x4015c2_r10 () (_ BitVec 64))
(declare-fun a0x4015c2_r11 () (_ BitVec 64))
(declare-fun a0x4015c2_r12 () (_ BitVec 64))
(declare-fun a0x4015c2_r13 () (_ BitVec 64))
(declare-fun a0x4015c2_r14 () (_ BitVec 64))
(declare-fun a0x4015c2_r15 () (_ BitVec 64))
(declare-fun a0x4015c2_cf () Bool)
(declare-fun a0x4015c2_RESERVED_1 () Bool)
(declare-fun a0x4015c2_pf () Bool)
(declare-fun a0x4015c2_RESERVED_3 () Bool)
(declare-fun a0x4015c2_af () Bool)
(declare-fun a0x4015c2_RESERVED_5 () Bool)
(declare-fun a0x4015c2_zf () Bool)
(declare-fun a0x4015c2_sf () Bool)
(declare-fun a0x4015c2_tf () Bool)
(declare-fun a0x4015c2_if () Bool)
(define-fun a0x4015c2_df () Bool false)
(declare-fun a0x4015c2_of () Bool)
(declare-fun a0x4015c2_iopl1 () Bool)
(declare-fun a0x4015c2_iopl2 () Bool)
(declare-fun a0x4015c2_nt () Bool)
(declare-fun a0x4015c2_RESERVED_15 () Bool)
(declare-fun a0x4015c2_rf () Bool)
(declare-fun a0x4015c2_vm () Bool)
(declare-fun a0x4015c2_ac () Bool)
(declare-fun a0x4015c2_vif () Bool)
(declare-fun a0x4015c2_vip () Bool)
(declare-fun a0x4015c2_id () Bool)
(declare-fun a0x4015c2_el () Bool)
(declare-fun a0x4015c2_el0 () Bool)
(declare-fun a0x4015c2_el1 () Bool)
(declare-fun a0x4015c2_el2 () Bool)
(declare-fun a0x4015c2_el3 () Bool)
(declare-fun a0x4015c2_el4 () Bool)
(declare-fun a0x4015c2_el5 () Bool)
(declare-fun a0x4015c2_el6 () Bool)
(declare-fun a0x4015c2_el7 () Bool)
(declare-fun a0x4015c2_el8 () Bool)
(declare-fun a0x4015c2_xmm0 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm1 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm2 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm3 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm4 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm5 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm6 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm7 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm8 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm9 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm10 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm11 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm12 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm13 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm14 () (_ BitVec 512))
(declare-fun a0x4015c2_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t69 () (_ BitVec 64))
(declare-fun %t70 () (_ BitVec 64))
(declare-fun %t71 () (_ BitVec 32))
(declare-fun %t72 () (_ BitVec 32))
(assert (= %t69 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t70 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t71 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t72 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4015c2_rbx fnstart_rbx))
(assert (= a0x4015c2_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4015c2_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4015c2_r12 fnstart_r12))
(assert (= a0x4015c2_r13 fnstart_r13))
(assert (= a0x4015c2_r14 fnstart_r14))
(assert (= a0x4015c2_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t73 = add i64 %t70, 4211152
(define-fun %t73 () (_ BitVec 64) (bvadd %t70 #x00000000004041d0))
; LLVM:     %t74 = inttoptr i64 %t73 to i8*
(define-fun %t74 () (_ BitVec 64) %t73)
; LLVM:     store i8 42, i8* %t74, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x4015c2_rbp #xffffffffffffffe0))
...
(assert (= %t74 addr0))
(assert true)
; LLVM:     jump label %block_0_4015ce
(assert true)
(assert (= a0x4015c2_df false))
(assert (= %t69 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t70 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t71 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t72 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
...
(assert (= a0x4015c2_r14 fnstart_r14))
(assert (= a0x4015c2_r15 fnstart_r15))
(check-sat-assuming ((not (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))))
(exit)
