; web.block_0_401959.2 @ 0x401975: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t302 () (_ BitVec 32))
(declare-fun %t303 () (_ BitVec 32))
(declare-fun %t304 () (_ BitVec 32))
(assert (= %t302 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t303 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t304 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401959_rbx fnstart_rbx))
(assert (= a0x401959_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401959_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401959_r12 fnstart_r12))
(assert (= a0x401959_r13 fnstart_r13))
(assert (= a0x401959_r14 fnstart_r14))
(assert (= a0x401959_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t305 = zext i32 %t303 to i64
(define-fun %t305 () (_ BitVec 64) ((_ zero_extend 32) %t303))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x401959_rbp #xfffffffffffffff8))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x401959_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x401959_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x000000000040197a))
(assert true)
(assert true)
(assert true)
(assert (= %t305 rcx))
(assert (not a0x401959_df))
(assert (= (mem_readbv64 mem rsp) #x000000000040197a))
...
; LLVM:     jump label %block_0_40197a
(assert true)
(assert (= a0x40197a_df false))
(assert (= %t302 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t304 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401959_rbx fnstart_rbx))
