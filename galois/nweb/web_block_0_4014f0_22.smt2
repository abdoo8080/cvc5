; web.block_0_4014f0.4 @ 0x401510: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
; LLVM:     %t0 = trunc i64 %arg0 to i32
(define-fun %t0 () (_ BitVec 32) ((_ extract 31 0) %arg0))
; LLVM:     %t1 = trunc i64 %arg1 to i32
(define-fun %t1 () (_ BitVec 32) ((_ extract 31 0) %arg1))
; LLVM:     %t2 = zext i32 %t0 to i64
(define-fun %t2 () (_ BitVec 64) ((_ zero_extend 32) %t0))
; LLVM:     %t3 = call i64 @read (i64 %t2,i64 4211152,i64 8096)
...
(define-fun rsp0 () (_ BitVec 64) ((_ extract 63 0) (bvadd #b01111111111111111111111111111111111111111111111111111111111000000 (concat #b0 rsp))))
(define-fun addr () (_ BitVec 64) (bvadd rsp #xfffffffffffffffc))
(assert (is_in_mc_only_stack_range addr #x0000000000000004))
(define-fun mem0 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 mem addr ((_ extract 31 0) fnstart_rdi)))
(define-fun addr0 () (_ BitVec 64) (bvadd rsp #xfffffffffffffff8))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000004))
(define-fun mem1 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 mem0 addr0 ((_ extract 31 0) fnstart_rsi)))
(define-fun addr1 () (_ BitVec 64) (bvadd rsp #xfffffffffffffffc))
(declare-fun readv () (_ BitVec 32))
(assert (on_stack addr1 #x0000000000000004))
(assert (= readv (mem_readbv32 mem1 addr1)))
(define-fun rdi () (_ BitVec 64) ((_ zero_extend 32) readv))
(define-fun rsp1 () (_ BitVec 64) (bvsub rsp0 #x0000000000000008))
(define-fun addr2 () (_ BitVec 64) (bvsub rsp0 #x0000000000000008))
(assert (is_in_mc_only_stack_range addr2 #x0000000000000008))
(define-fun mem2 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 mem1 addr2 #x0000000000401515))
(assert (= %t2 rdi))
(assert true)
(assert true)
(assert (not fnstart_df))
(assert (= (mem_readbv64 mem2 rsp1) #x0000000000401515))
...
(declare-fun mem3 () (Array (_ BitVec 64) (_ BitVec 8)))
(assert (eqrange mem3 mem2 (bvadd rsp1 #x0000000000000008) (bvadd fnstart_rsp #x0000000000000007)))
(define-fun %t3 () (_ BitVec 64) a0x401515_rax)
; LLVM:     jump label %block_0_401515
(assert true)
(assert (= a0x401515_df false))
(assert (= %t3 a0x401515_rax))
(assert (= %t1 (mem_readbv32 mem3 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t0 (mem_readbv32 mem3 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= fnstart_rbx fnstart_rbx))
(assert (= (bvadd rsp1 #x0000000000000008) (bvsub fnstart_rsp #x0000000000000048)))
(assert (= rsp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= fnstart_r12 fnstart_r12))
(assert (= fnstart_r13 fnstart_r13))
(assert (= fnstart_r14 fnstart_r14))
(assert (= fnstart_r15 fnstart_r15))
(check-sat-assuming ((not (= (mem_readbv64 mem3 (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))))
(exit)
