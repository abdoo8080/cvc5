; web.block_0_401931.1 @ 0x401954: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t296 () (_ BitVec 64))
(declare-fun %t297 () (_ BitVec 64))
(declare-fun %t298 () (_ BitVec 32))
(declare-fun %t299 () (_ BitVec 32))
(declare-fun %t300 () (_ BitVec 32))
(assert (= %t296 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t297 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000038))))
(assert (= %t298 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t299 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t300 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401931_rbx fnstart_rbx))
(assert (= a0x401931_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401931_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401931_r12 fnstart_r12))
(assert (= a0x401931_r13 fnstart_r13))
(assert (= a0x401931_r14 fnstart_r14))
(assert (= a0x401931_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t301 = call i64 @sprintf (i64 4211152,i64 4203403,i64 23,i64 %t297,i64 %t296)
(define-fun addr () (_ BitVec 64) (bvadd a0x401931_rbp #xffffffffffffffd0))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem addr)))
(define-fun addr0 () (_ BitVec 64) (bvadd a0x401931_rbp #xffffffffffffffc8))
(declare-fun readv0 () (_ BitVec 64))
(assert (on_stack addr0 #x0000000000000008))
(assert (= readv0 (mem_readbv64 init_mem addr0)))
(define-fun rax () (_ BitVec 64) (bvor (bvand a0x401931_rax #xffffffffffffff00) #x0000000000000000))
(define-fun rsp () (_ BitVec 64) (bvsub a0x401931_rsp #x0000000000000008))
(define-fun addr1 () (_ BitVec 64) (bvsub a0x401931_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr1 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr1 #x0000000000401959))
(assert true)
(assert true)
(assert true)
(assert (= %t297 readv))
(assert (= %t296 readv0))
(assert (not a0x401931_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401959))
(declare-fun a0x401959_xmm15 () (_ BitVec 512))
(declare-fun a0x401959_xmm14 () (_ BitVec 512))
(declare-fun a0x401959_xmm13 () (_ BitVec 512))
(declare-fun a0x401959_xmm12 () (_ BitVec 512))
(declare-fun a0x401959_xmm11 () (_ BitVec 512))
(declare-fun a0x401959_xmm10 () (_ BitVec 512))
(declare-fun a0x401959_xmm9 () (_ BitVec 512))
(declare-fun a0x401959_xmm8 () (_ BitVec 512))
(declare-fun a0x401959_xmm7 () (_ BitVec 512))
(declare-fun a0x401959_xmm6 () (_ BitVec 512))
(declare-fun a0x401959_xmm5 () (_ BitVec 512))
(declare-fun a0x401959_xmm4 () (_ BitVec 512))
(declare-fun a0x401959_xmm3 () (_ BitVec 512))
(declare-fun a0x401959_xmm2 () (_ BitVec 512))
(declare-fun a0x401959_xmm1 () (_ BitVec 512))
(declare-fun a0x401959_xmm0 () (_ BitVec 512))
(declare-fun a0x401959_el8 () Bool)
(declare-fun a0x401959_el7 () Bool)
(declare-fun a0x401959_el6 () Bool)
(declare-fun a0x401959_el5 () Bool)
(declare-fun a0x401959_el4 () Bool)
(declare-fun a0x401959_el3 () Bool)
(declare-fun a0x401959_el2 () Bool)
(declare-fun a0x401959_el1 () Bool)
(declare-fun a0x401959_el0 () Bool)
(declare-fun a0x401959_el () Bool)
(declare-fun a0x401959_id () Bool)
(declare-fun a0x401959_vip () Bool)
(declare-fun a0x401959_vif () Bool)
(declare-fun a0x401959_ac () Bool)
(declare-fun a0x401959_vm () Bool)
(declare-fun a0x401959_rf () Bool)
(declare-fun a0x401959_RESERVED_15 () Bool)
(declare-fun a0x401959_nt () Bool)
(declare-fun a0x401959_iopl2 () Bool)
(declare-fun a0x401959_iopl1 () Bool)
(declare-fun a0x401959_of () Bool)
(define-fun a0x401959_df () Bool false)
(declare-fun a0x401959_if () Bool)
(declare-fun a0x401959_tf () Bool)
(declare-fun a0x401959_sf () Bool)
(declare-fun a0x401959_zf () Bool)
(declare-fun a0x401959_RESERVED_5 () Bool)
(declare-fun a0x401959_af () Bool)
(declare-fun a0x401959_RESERVED_3 () Bool)
(declare-fun a0x401959_pf () Bool)
(declare-fun a0x401959_RESERVED_1 () Bool)
(declare-fun a0x401959_cf () Bool)
(declare-fun a0x401959_r15 () (_ BitVec 64))
(declare-fun a0x401959_r14 () (_ BitVec 64))
(declare-fun a0x401959_r13 () (_ BitVec 64))
(declare-fun a0x401959_r12 () (_ BitVec 64))
(declare-fun a0x401959_r11 () (_ BitVec 64))
(declare-fun a0x401959_r10 () (_ BitVec 64))
(declare-fun a0x401959_r9 () (_ BitVec 64))
(declare-fun a0x401959_r8 () (_ BitVec 64))
(declare-fun a0x401959_rdi () (_ BitVec 64))
(declare-fun a0x401959_rsi () (_ BitVec 64))
(declare-fun a0x401959_rbp () (_ BitVec 64))
(declare-fun a0x401959_rsp () (_ BitVec 64))
(declare-fun a0x401959_rbx () (_ BitVec 64))
(declare-fun a0x401959_rdx () (_ BitVec 64))
(declare-fun a0x401959_rcx () (_ BitVec 64))
(declare-fun a0x401959_rax () (_ BitVec 64))
...
(define-fun %t301 () (_ BitVec 64) a0x401959_rax)
; LLVM:     jump label %block_0_401959
(assert true)
(assert (= a0x401959_df false))
(assert (= %t298 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t299 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t300 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401931_rbx fnstart_rbx))
