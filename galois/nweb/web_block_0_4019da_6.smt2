; web.block_0_4019da.0 @ 0x4019da: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x4019da_rbx fnstart_rbx))
(assert (= a0x4019da_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x4019da_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
