; web.block_0_4016f7.7 @ 0x40170a: precondition ((= (llvm t167) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t163 #b1) (= %t156 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
