; web.block_0_40168a.5 @ 0x401699: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t119 #b1) (= a0x40168a_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
