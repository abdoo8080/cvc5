; web.block_0_4015ad.5 @ 0x4015bc: instruction pointer is expected value (true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t68 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111110110 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) false true) #x00000000004015ce #x00000000004015c2) #x00000000004015c2)))))
(exit)
