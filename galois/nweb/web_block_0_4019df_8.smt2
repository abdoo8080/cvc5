; web.block_0_4019df.1 @ 0x4019e4: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4019df_rax () (_ BitVec 64))
(declare-fun a0x4019df_rcx () (_ BitVec 64))
(declare-fun a0x4019df_rdx () (_ BitVec 64))
(declare-fun a0x4019df_rbx () (_ BitVec 64))
(declare-fun a0x4019df_rsp () (_ BitVec 64))
(declare-fun a0x4019df_rbp () (_ BitVec 64))
(declare-fun a0x4019df_rsi () (_ BitVec 64))
(declare-fun a0x4019df_rdi () (_ BitVec 64))
(declare-fun a0x4019df_r8 () (_ BitVec 64))
(declare-fun a0x4019df_r9 () (_ BitVec 64))
(declare-fun a0x4019df_r10 () (_ BitVec 64))
(declare-fun a0x4019df_r11 () (_ BitVec 64))
(declare-fun a0x4019df_r12 () (_ BitVec 64))
(declare-fun a0x4019df_r13 () (_ BitVec 64))
(declare-fun a0x4019df_r14 () (_ BitVec 64))
(declare-fun a0x4019df_r15 () (_ BitVec 64))
(declare-fun a0x4019df_cf () Bool)
(declare-fun a0x4019df_RESERVED_1 () Bool)
(declare-fun a0x4019df_pf () Bool)
(declare-fun a0x4019df_RESERVED_3 () Bool)
(declare-fun a0x4019df_af () Bool)
(declare-fun a0x4019df_RESERVED_5 () Bool)
(declare-fun a0x4019df_zf () Bool)
(declare-fun a0x4019df_sf () Bool)
(declare-fun a0x4019df_tf () Bool)
(declare-fun a0x4019df_if () Bool)
(define-fun a0x4019df_df () Bool false)
(declare-fun a0x4019df_of () Bool)
(declare-fun a0x4019df_iopl1 () Bool)
(declare-fun a0x4019df_iopl2 () Bool)
(declare-fun a0x4019df_nt () Bool)
(declare-fun a0x4019df_RESERVED_15 () Bool)
(declare-fun a0x4019df_rf () Bool)
(declare-fun a0x4019df_vm () Bool)
(declare-fun a0x4019df_ac () Bool)
(declare-fun a0x4019df_vif () Bool)
(declare-fun a0x4019df_vip () Bool)
(declare-fun a0x4019df_id () Bool)
(declare-fun a0x4019df_el () Bool)
(declare-fun a0x4019df_el0 () Bool)
(declare-fun a0x4019df_el1 () Bool)
(declare-fun a0x4019df_el2 () Bool)
(declare-fun a0x4019df_el3 () Bool)
(declare-fun a0x4019df_el4 () Bool)
(declare-fun a0x4019df_el5 () Bool)
(declare-fun a0x4019df_el6 () Bool)
(declare-fun a0x4019df_el7 () Bool)
(declare-fun a0x4019df_el8 () Bool)
(declare-fun a0x4019df_xmm0 () (_ BitVec 512))
(declare-fun a0x4019df_xmm1 () (_ BitVec 512))
(declare-fun a0x4019df_xmm2 () (_ BitVec 512))
(declare-fun a0x4019df_xmm3 () (_ BitVec 512))
(declare-fun a0x4019df_xmm4 () (_ BitVec 512))
(declare-fun a0x4019df_xmm5 () (_ BitVec 512))
(declare-fun a0x4019df_xmm6 () (_ BitVec 512))
(declare-fun a0x4019df_xmm7 () (_ BitVec 512))
(declare-fun a0x4019df_xmm8 () (_ BitVec 512))
(declare-fun a0x4019df_xmm9 () (_ BitVec 512))
(declare-fun a0x4019df_xmm10 () (_ BitVec 512))
(declare-fun a0x4019df_xmm11 () (_ BitVec 512))
(declare-fun a0x4019df_xmm12 () (_ BitVec 512))
(declare-fun a0x4019df_xmm13 () (_ BitVec 512))
(declare-fun a0x4019df_xmm14 () (_ BitVec 512))
(declare-fun a0x4019df_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t332 () (_ BitVec 32))
(assert (= %t332 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4019df_rbx fnstart_rbx))
(assert (= a0x4019df_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4019df_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4019df_r12 fnstart_r12))
(assert (= a0x4019df_r13 fnstart_r13))
(assert (= a0x4019df_r14 fnstart_r14))
(assert (= a0x4019df_r15 fnstart_r15))
(assert (= a0x4019df_cf a0x4019df_af))
(assert (= a0x4019df_cf a0x4019df_df))
(assert (= a0x4019df_cf a0x4019df_of))
(assert (= a0x4019df_rax (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t333 = call i64 @sleep (i64 1)
(define-fun rsp () (_ BitVec 64) (bvsub a0x4019df_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x4019df_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x00000000004019e9))
(assert true)
(assert (not a0x4019df_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004019e9))
...
(define-fun %t333 () (_ BitVec 64) a0x4019e9_rax)
; LLVM:     jump label %block_0_4019e9
(assert true)
(assert (= a0x4019e9_df false))
(assert (= %t332 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4019df_rbx fnstart_rbx))
