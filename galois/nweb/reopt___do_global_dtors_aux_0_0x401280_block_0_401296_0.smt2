; reopt___do_global_dtors_aux_0_0x401280.block_0_401296.1 @ 0x401296: LLVM and machine code store to same heap address
(set-logic ALL)
...
(check-sat-assuming ((not (= %t3 #x00000000004041c0))))
(exit)
