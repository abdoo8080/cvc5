; web.block_0_40191f.2 @ 0x40192c: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40191f_rax () (_ BitVec 64))
(declare-fun a0x40191f_rcx () (_ BitVec 64))
(declare-fun a0x40191f_rdx () (_ BitVec 64))
(declare-fun a0x40191f_rbx () (_ BitVec 64))
(declare-fun a0x40191f_rsp () (_ BitVec 64))
(declare-fun a0x40191f_rbp () (_ BitVec 64))
(declare-fun a0x40191f_rsi () (_ BitVec 64))
(declare-fun a0x40191f_rdi () (_ BitVec 64))
(declare-fun a0x40191f_r8 () (_ BitVec 64))
(declare-fun a0x40191f_r9 () (_ BitVec 64))
(declare-fun a0x40191f_r10 () (_ BitVec 64))
(declare-fun a0x40191f_r11 () (_ BitVec 64))
(declare-fun a0x40191f_r12 () (_ BitVec 64))
(declare-fun a0x40191f_r13 () (_ BitVec 64))
(declare-fun a0x40191f_r14 () (_ BitVec 64))
(declare-fun a0x40191f_r15 () (_ BitVec 64))
(declare-fun a0x40191f_cf () Bool)
(declare-fun a0x40191f_RESERVED_1 () Bool)
(declare-fun a0x40191f_pf () Bool)
(declare-fun a0x40191f_RESERVED_3 () Bool)
(declare-fun a0x40191f_af () Bool)
(declare-fun a0x40191f_RESERVED_5 () Bool)
(declare-fun a0x40191f_zf () Bool)
(declare-fun a0x40191f_sf () Bool)
(declare-fun a0x40191f_tf () Bool)
(declare-fun a0x40191f_if () Bool)
(define-fun a0x40191f_df () Bool false)
(declare-fun a0x40191f_of () Bool)
(declare-fun a0x40191f_iopl1 () Bool)
(declare-fun a0x40191f_iopl2 () Bool)
(declare-fun a0x40191f_nt () Bool)
(declare-fun a0x40191f_RESERVED_15 () Bool)
(declare-fun a0x40191f_rf () Bool)
(declare-fun a0x40191f_vm () Bool)
(declare-fun a0x40191f_ac () Bool)
(declare-fun a0x40191f_vif () Bool)
(declare-fun a0x40191f_vip () Bool)
(declare-fun a0x40191f_id () Bool)
(declare-fun a0x40191f_el () Bool)
(declare-fun a0x40191f_el0 () Bool)
(declare-fun a0x40191f_el1 () Bool)
(declare-fun a0x40191f_el2 () Bool)
(declare-fun a0x40191f_el3 () Bool)
(declare-fun a0x40191f_el4 () Bool)
(declare-fun a0x40191f_el5 () Bool)
(declare-fun a0x40191f_el6 () Bool)
(declare-fun a0x40191f_el7 () Bool)
(declare-fun a0x40191f_el8 () Bool)
(declare-fun a0x40191f_xmm0 () (_ BitVec 512))
(declare-fun a0x40191f_xmm1 () (_ BitVec 512))
(declare-fun a0x40191f_xmm2 () (_ BitVec 512))
(declare-fun a0x40191f_xmm3 () (_ BitVec 512))
(declare-fun a0x40191f_xmm4 () (_ BitVec 512))
(declare-fun a0x40191f_xmm5 () (_ BitVec 512))
(declare-fun a0x40191f_xmm6 () (_ BitVec 512))
(declare-fun a0x40191f_xmm7 () (_ BitVec 512))
(declare-fun a0x40191f_xmm8 () (_ BitVec 512))
(declare-fun a0x40191f_xmm9 () (_ BitVec 512))
(declare-fun a0x40191f_xmm10 () (_ BitVec 512))
(declare-fun a0x40191f_xmm11 () (_ BitVec 512))
(declare-fun a0x40191f_xmm12 () (_ BitVec 512))
(declare-fun a0x40191f_xmm13 () (_ BitVec 512))
(declare-fun a0x40191f_xmm14 () (_ BitVec 512))
(declare-fun a0x40191f_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t289 () (_ BitVec 64))
(declare-fun %t290 () (_ BitVec 64))
(declare-fun %t291 () (_ BitVec 32))
(declare-fun %t292 () (_ BitVec 32))
(declare-fun %t293 () (_ BitVec 32))
(assert (= %t289 a0x40191f_rax))
(assert (= %t290 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t291 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t292 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t293 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40191f_rbx fnstart_rbx))
(assert (= a0x40191f_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40191f_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40191f_r12 fnstart_r12))
(assert (= a0x40191f_r13 fnstart_r13))
(assert (= a0x40191f_r14 fnstart_r14))
(assert (= a0x40191f_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t294 = zext i32 %t291 to i64
(define-fun %t294 () (_ BitVec 64) ((_ zero_extend 32) %t291))
; LLVM:     %t295 = call i64 @lseek (i64 %t294,i64 0,i64 0)
(define-fun addr () (_ BitVec 64) (bvadd a0x40191f_rbp #xffffffffffffffd0))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr a0x40191f_rax))
(define-fun addr0 () (_ BitVec 64) (bvadd a0x40191f_rbp #xfffffffffffffff0))
(declare-fun readv () (_ BitVec 32))
(assert (on_stack addr0 #x0000000000000004))
(assert (= readv (mem_readbv32 mem addr0)))
(define-fun rdi () (_ BitVec 64) ((_ zero_extend 32) readv))
(define-fun rax () (_ BitVec 64) ((_ zero_extend 32) (bvxor ((_ extract 31 0) a0x40191f_rax) ((_ extract 31 0) a0x40191f_rax))))
(define-fun rsi () (_ BitVec 64) ((_ zero_extend 32) ((_ extract 31 0) rax)))
(define-fun rdx () (_ BitVec 64) ((_ zero_extend 32) (bvxor ((_ extract 31 0) a0x40191f_rdx) ((_ extract 31 0) a0x40191f_rdx))))
(define-fun rsp () (_ BitVec 64) (bvsub a0x40191f_rsp #x0000000000000008))
(define-fun addr1 () (_ BitVec 64) (bvsub a0x40191f_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr1 #x0000000000000008))
(define-fun mem0 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 mem addr1 #x0000000000401931))
(assert (= %t294 rdi))
(assert (= #x0000000000000000 rsi))
(assert (= #x0000000000000000 rdx))
(assert (not a0x40191f_df))
(assert (= (mem_readbv64 mem0 rsp) #x0000000000401931))
(declare-fun a0x401931_xmm15 () (_ BitVec 512))
(declare-fun a0x401931_xmm14 () (_ BitVec 512))
(declare-fun a0x401931_xmm13 () (_ BitVec 512))
(declare-fun a0x401931_xmm12 () (_ BitVec 512))
(declare-fun a0x401931_xmm11 () (_ BitVec 512))
(declare-fun a0x401931_xmm10 () (_ BitVec 512))
(declare-fun a0x401931_xmm9 () (_ BitVec 512))
(declare-fun a0x401931_xmm8 () (_ BitVec 512))
(declare-fun a0x401931_xmm7 () (_ BitVec 512))
(declare-fun a0x401931_xmm6 () (_ BitVec 512))
(declare-fun a0x401931_xmm5 () (_ BitVec 512))
(declare-fun a0x401931_xmm4 () (_ BitVec 512))
(declare-fun a0x401931_xmm3 () (_ BitVec 512))
(declare-fun a0x401931_xmm2 () (_ BitVec 512))
(declare-fun a0x401931_xmm1 () (_ BitVec 512))
(declare-fun a0x401931_xmm0 () (_ BitVec 512))
(declare-fun a0x401931_el8 () Bool)
(declare-fun a0x401931_el7 () Bool)
(declare-fun a0x401931_el6 () Bool)
(declare-fun a0x401931_el5 () Bool)
(declare-fun a0x401931_el4 () Bool)
(declare-fun a0x401931_el3 () Bool)
(declare-fun a0x401931_el2 () Bool)
(declare-fun a0x401931_el1 () Bool)
(declare-fun a0x401931_el0 () Bool)
(declare-fun a0x401931_el () Bool)
(declare-fun a0x401931_id () Bool)
(declare-fun a0x401931_vip () Bool)
(declare-fun a0x401931_vif () Bool)
(declare-fun a0x401931_ac () Bool)
(declare-fun a0x401931_vm () Bool)
(declare-fun a0x401931_rf () Bool)
(declare-fun a0x401931_RESERVED_15 () Bool)
(declare-fun a0x401931_nt () Bool)
(declare-fun a0x401931_iopl2 () Bool)
(declare-fun a0x401931_iopl1 () Bool)
(declare-fun a0x401931_of () Bool)
(define-fun a0x401931_df () Bool false)
(declare-fun a0x401931_if () Bool)
(declare-fun a0x401931_tf () Bool)
(declare-fun a0x401931_sf () Bool)
(declare-fun a0x401931_zf () Bool)
(declare-fun a0x401931_RESERVED_5 () Bool)
(declare-fun a0x401931_af () Bool)
(declare-fun a0x401931_RESERVED_3 () Bool)
(declare-fun a0x401931_pf () Bool)
(declare-fun a0x401931_RESERVED_1 () Bool)
(declare-fun a0x401931_cf () Bool)
(declare-fun a0x401931_r15 () (_ BitVec 64))
(declare-fun a0x401931_r14 () (_ BitVec 64))
(declare-fun a0x401931_r13 () (_ BitVec 64))
(declare-fun a0x401931_r12 () (_ BitVec 64))
(declare-fun a0x401931_r11 () (_ BitVec 64))
(declare-fun a0x401931_r10 () (_ BitVec 64))
(declare-fun a0x401931_r9 () (_ BitVec 64))
(declare-fun a0x401931_r8 () (_ BitVec 64))
(declare-fun a0x401931_rdi () (_ BitVec 64))
(declare-fun a0x401931_rsi () (_ BitVec 64))
(declare-fun a0x401931_rbp () (_ BitVec 64))
(declare-fun a0x401931_rsp () (_ BitVec 64))
(declare-fun a0x401931_rbx () (_ BitVec 64))
(declare-fun a0x401931_rdx () (_ BitVec 64))
(declare-fun a0x401931_rcx () (_ BitVec 64))
(declare-fun a0x401931_rax () (_ BitVec 64))
...
(define-fun %t295 () (_ BitVec 64) a0x401931_rax)
; LLVM:     jump label %block_0_401931
(assert true)
(assert (= a0x401931_df false))
(assert (= %t290 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t289 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000038))))
(assert (= %t291 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t292 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t293 (mem_readbv32 mem1 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40191f_rbx fnstart_rbx))
(check-sat-assuming ((not (= (bvadd rsp #x0000000000000008) (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
