; web.block_0_401623.2 @ 0x401626: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun %t86 () (_ BitVec 64))
(declare-fun %t87 () (_ BitVec 32))
(declare-fun %t88 () (_ BitVec 32))
(assert (= %t86 a0x401623_rax))
(assert (= %t87 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t88 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401623_rbx fnstart_rbx))
(assert (= a0x401623_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401623_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401623_r12 fnstart_r12))
(assert (= a0x401623_r13 fnstart_r13))
(assert (= a0x401623_r14 fnstart_r14))
(assert (= a0x401623_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t89 = trunc i64 %t86 to i32
(define-fun %t89 () (_ BitVec 32) ((_ extract 31 0) %t86))
; LLVM:     %t90 = icmp eq i32 %t89, 0
(define-fun %t90 () (_ BitVec 1) (ite (= %t89 #x00000000) #b1 #b0))
; LLVM:     br i1 %t90, label %block_0_401674, label %block_0_40162c
(assert (=> (= %t90 #b1) (= (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax)))) #x00000000) #x0000000000401674 #x000000000040162c) #x0000000000401674)))
(assert (=> (= %t90 #b1) (= a0x401623_df false)))
(assert (=> (= %t90 #b1) (= %t87 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t90 #b1) (= %t88 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t90 #b1) (= a0x401623_rbx fnstart_rbx)))
(assert (=> (= %t90 #b1) (= a0x401623_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t90 #b1) (= a0x401623_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t90 #b1) (= a0x401623_r12 fnstart_r12)))
(assert (=> (= %t90 #b1) (= a0x401623_r13 fnstart_r13)))
(assert (=> (= %t90 #b1) (= a0x401623_r14 fnstart_r14)))
(assert (=> (= %t90 #b1) (= a0x401623_r15 fnstart_r15)))
(assert (=> (= %t90 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t90 #b1)) (= (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax)))) #x00000000) #x0000000000401674 #x000000000040162c) #x000000000040162c)))
(assert (=> (not (= %t90 #b1)) (= a0x401623_df false)))
(assert (=> (not (= %t90 #b1)) (= %t87 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t90 #b1)) (= %t88 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t90 #b1)) (= a0x401623_rbx fnstart_rbx)))
(assert (=> (not (= %t90 #b1)) (= a0x401623_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t90 #b1)) (= a0x401623_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t90 #b1)) (= a0x401623_r12 fnstart_r12)))
(assert (=> (not (= %t90 #b1)) (= a0x401623_r13 fnstart_r13)))
(assert (=> (not (= %t90 #b1)) (= a0x401623_r14 fnstart_r14)))
(assert (=> (not (= %t90 #b1)) (= a0x401623_r15 fnstart_r15)))
(assert (=> (not (= %t90 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401623_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true))))
(assert (=> (not (= %t90 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) a0x401623_df)))
(assert (=> (not (= %t90 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (and (not (= (bvand ((_ extract 31 0) a0x401623_rax) #x80000000) #x00000000)) (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401623_rax))) #b010000000000000000000000000000000) #b000000000000000000000000000000000)) false true)))))
(check-sat-assuming ((not (=> (not (= %t90 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
