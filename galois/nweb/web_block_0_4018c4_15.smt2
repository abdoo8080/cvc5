; web.block_0_4018c4.2 @ 0x4018e4: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4018c4_rax () (_ BitVec 64))
(declare-fun a0x4018c4_rcx () (_ BitVec 64))
(declare-fun a0x4018c4_rdx () (_ BitVec 64))
(declare-fun a0x4018c4_rbx () (_ BitVec 64))
(declare-fun a0x4018c4_rsp () (_ BitVec 64))
(declare-fun a0x4018c4_rbp () (_ BitVec 64))
(declare-fun a0x4018c4_rsi () (_ BitVec 64))
(declare-fun a0x4018c4_rdi () (_ BitVec 64))
(declare-fun a0x4018c4_r8 () (_ BitVec 64))
(declare-fun a0x4018c4_r9 () (_ BitVec 64))
(declare-fun a0x4018c4_r10 () (_ BitVec 64))
(declare-fun a0x4018c4_r11 () (_ BitVec 64))
(declare-fun a0x4018c4_r12 () (_ BitVec 64))
(declare-fun a0x4018c4_r13 () (_ BitVec 64))
(declare-fun a0x4018c4_r14 () (_ BitVec 64))
(declare-fun a0x4018c4_r15 () (_ BitVec 64))
(declare-fun a0x4018c4_cf () Bool)
(declare-fun a0x4018c4_RESERVED_1 () Bool)
(declare-fun a0x4018c4_pf () Bool)
(declare-fun a0x4018c4_RESERVED_3 () Bool)
(declare-fun a0x4018c4_af () Bool)
(declare-fun a0x4018c4_RESERVED_5 () Bool)
(declare-fun a0x4018c4_zf () Bool)
(declare-fun a0x4018c4_sf () Bool)
(declare-fun a0x4018c4_tf () Bool)
(declare-fun a0x4018c4_if () Bool)
(define-fun a0x4018c4_df () Bool false)
(declare-fun a0x4018c4_of () Bool)
(declare-fun a0x4018c4_iopl1 () Bool)
(declare-fun a0x4018c4_iopl2 () Bool)
(declare-fun a0x4018c4_nt () Bool)
(declare-fun a0x4018c4_RESERVED_15 () Bool)
(declare-fun a0x4018c4_rf () Bool)
(declare-fun a0x4018c4_vm () Bool)
(declare-fun a0x4018c4_ac () Bool)
(declare-fun a0x4018c4_vif () Bool)
(declare-fun a0x4018c4_vip () Bool)
(declare-fun a0x4018c4_id () Bool)
(declare-fun a0x4018c4_el () Bool)
(declare-fun a0x4018c4_el0 () Bool)
(declare-fun a0x4018c4_el1 () Bool)
(declare-fun a0x4018c4_el2 () Bool)
(declare-fun a0x4018c4_el3 () Bool)
(declare-fun a0x4018c4_el4 () Bool)
(declare-fun a0x4018c4_el5 () Bool)
(declare-fun a0x4018c4_el6 () Bool)
(declare-fun a0x4018c4_el7 () Bool)
(declare-fun a0x4018c4_el8 () Bool)
(declare-fun a0x4018c4_xmm0 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm1 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm2 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm3 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm4 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm5 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm6 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm7 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm8 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm9 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm10 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm11 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm12 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm13 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm14 () (_ BitVec 512))
(declare-fun a0x4018c4_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t273 () (_ BitVec 64))
(declare-fun %t274 () (_ BitVec 32))
(declare-fun %t275 () (_ BitVec 32))
(declare-fun %t276 () (_ BitVec 32))
(assert (= %t273 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t274 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t275 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t276 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4018c4_rbx fnstart_rbx))
(assert (= a0x4018c4_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4018c4_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4018c4_r12 fnstart_r12))
(assert (= a0x4018c4_r13 fnstart_r13))
(assert (= a0x4018c4_r14 fnstart_r14))
(assert (= a0x4018c4_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t277 = zext i32 %t276 to i64
(define-fun %t277 () (_ BitVec 64) ((_ zero_extend 32) %t276))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x4018c4_rbp #xfffffffffffffffc))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x4018c4_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x4018c4_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x00000000004018e9))
(assert true)
(assert true)
(assert true)
(assert (= %t277 rcx))
(assert (not a0x4018c4_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004018e9))
...
; LLVM:     jump label %block_0_4018e9
(assert true)
(assert (= a0x4018e9_df false))
(assert (= %t273 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t274 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t275 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t276 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4018c4_rbx fnstart_rbx))
