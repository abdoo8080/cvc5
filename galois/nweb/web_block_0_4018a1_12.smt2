; web.block_0_4018a1.1 @ 0x4018b3: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t263 () (_ BitVec 64))
(declare-fun %t264 () (_ BitVec 32))
(declare-fun %t265 () (_ BitVec 32))
(assert (= %t263 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t264 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t265 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4018a1_rbx fnstart_rbx))
(assert (= a0x4018a1_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4018a1_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4018a1_r12 fnstart_r12))
(assert (= a0x4018a1_r13 fnstart_r13))
(assert (= a0x4018a1_r14 fnstart_r14))
(assert (= a0x4018a1_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t266 = call i64 @open (i64 4211157,i64 0)
(define-fun rsi () (_ BitVec 64) ((_ zero_extend 32) (bvxor ((_ extract 31 0) a0x4018a1_rsi) ((_ extract 31 0) a0x4018a1_rsi))))
(define-fun rax () (_ BitVec 64) (bvor (bvand a0x4018a1_rax #xffffffffffffff00) #x0000000000000000))
(define-fun rsp () (_ BitVec 64) (bvsub a0x4018a1_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x4018a1_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x00000000004018b8))
(assert true)
(assert (= #x0000000000000000 rsi))
(assert (not a0x4018a1_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004018b8))
(declare-fun a0x4018b8_xmm15 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm14 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm13 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm12 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm11 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm10 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm9 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm8 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm7 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm6 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm5 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm4 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm3 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm2 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm1 () (_ BitVec 512))
(declare-fun a0x4018b8_xmm0 () (_ BitVec 512))
(declare-fun a0x4018b8_el8 () Bool)
(declare-fun a0x4018b8_el7 () Bool)
(declare-fun a0x4018b8_el6 () Bool)
(declare-fun a0x4018b8_el5 () Bool)
(declare-fun a0x4018b8_el4 () Bool)
(declare-fun a0x4018b8_el3 () Bool)
(declare-fun a0x4018b8_el2 () Bool)
(declare-fun a0x4018b8_el1 () Bool)
(declare-fun a0x4018b8_el0 () Bool)
(declare-fun a0x4018b8_el () Bool)
(declare-fun a0x4018b8_id () Bool)
(declare-fun a0x4018b8_vip () Bool)
(declare-fun a0x4018b8_vif () Bool)
(declare-fun a0x4018b8_ac () Bool)
(declare-fun a0x4018b8_vm () Bool)
(declare-fun a0x4018b8_rf () Bool)
(declare-fun a0x4018b8_RESERVED_15 () Bool)
(declare-fun a0x4018b8_nt () Bool)
(declare-fun a0x4018b8_iopl2 () Bool)
(declare-fun a0x4018b8_iopl1 () Bool)
(declare-fun a0x4018b8_of () Bool)
(define-fun a0x4018b8_df () Bool false)
(declare-fun a0x4018b8_if () Bool)
(declare-fun a0x4018b8_tf () Bool)
(declare-fun a0x4018b8_sf () Bool)
(declare-fun a0x4018b8_zf () Bool)
(declare-fun a0x4018b8_RESERVED_5 () Bool)
(declare-fun a0x4018b8_af () Bool)
(declare-fun a0x4018b8_RESERVED_3 () Bool)
(declare-fun a0x4018b8_pf () Bool)
(declare-fun a0x4018b8_RESERVED_1 () Bool)
(declare-fun a0x4018b8_cf () Bool)
(declare-fun a0x4018b8_r15 () (_ BitVec 64))
(declare-fun a0x4018b8_r14 () (_ BitVec 64))
(declare-fun a0x4018b8_r13 () (_ BitVec 64))
(declare-fun a0x4018b8_r12 () (_ BitVec 64))
(declare-fun a0x4018b8_r11 () (_ BitVec 64))
(declare-fun a0x4018b8_r10 () (_ BitVec 64))
(declare-fun a0x4018b8_r9 () (_ BitVec 64))
(declare-fun a0x4018b8_r8 () (_ BitVec 64))
(declare-fun a0x4018b8_rdi () (_ BitVec 64))
(declare-fun a0x4018b8_rsi () (_ BitVec 64))
(declare-fun a0x4018b8_rbp () (_ BitVec 64))
(declare-fun a0x4018b8_rsp () (_ BitVec 64))
(declare-fun a0x4018b8_rbx () (_ BitVec 64))
(declare-fun a0x4018b8_rdx () (_ BitVec 64))
(declare-fun a0x4018b8_rcx () (_ BitVec 64))
(declare-fun a0x4018b8_rax () (_ BitVec 64))
...
(define-fun %t266 () (_ BitVec 64) a0x4018b8_rax)
; LLVM:     jump label %block_0_4018b8
(assert true)
(assert (= a0x4018b8_df false))
(assert (= %t266 a0x4018b8_rax))
(assert (= %t263 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t264 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t265 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4018a1_rbx fnstart_rbx))
