; web.block_0_401875.1 @ 0x40187a: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t258 #b1) (= a0x401875_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
