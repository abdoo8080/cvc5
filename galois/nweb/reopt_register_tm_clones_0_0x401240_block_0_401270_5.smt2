; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: register value preserved (rbx, after return)
(set-logic ALL)
...
(declare-fun a0x401270_rax () (_ BitVec 64))
(declare-fun a0x401270_rcx () (_ BitVec 64))
(declare-fun a0x401270_rdx () (_ BitVec 64))
(declare-fun a0x401270_rbx () (_ BitVec 64))
(declare-fun a0x401270_rsp () (_ BitVec 64))
(declare-fun a0x401270_rbp () (_ BitVec 64))
(declare-fun a0x401270_rsi () (_ BitVec 64))
(declare-fun a0x401270_rdi () (_ BitVec 64))
(declare-fun a0x401270_r8 () (_ BitVec 64))
(declare-fun a0x401270_r9 () (_ BitVec 64))
(declare-fun a0x401270_r10 () (_ BitVec 64))
(declare-fun a0x401270_r11 () (_ BitVec 64))
(declare-fun a0x401270_r12 () (_ BitVec 64))
(declare-fun a0x401270_r13 () (_ BitVec 64))
(declare-fun a0x401270_r14 () (_ BitVec 64))
(declare-fun a0x401270_r15 () (_ BitVec 64))
(declare-fun a0x401270_cf () Bool)
(declare-fun a0x401270_RESERVED_1 () Bool)
(declare-fun a0x401270_pf () Bool)
(declare-fun a0x401270_RESERVED_3 () Bool)
(declare-fun a0x401270_af () Bool)
(declare-fun a0x401270_RESERVED_5 () Bool)
(declare-fun a0x401270_zf () Bool)
(declare-fun a0x401270_sf () Bool)
(declare-fun a0x401270_tf () Bool)
(declare-fun a0x401270_if () Bool)
(define-fun a0x401270_df () Bool false)
(declare-fun a0x401270_of () Bool)
(declare-fun a0x401270_iopl1 () Bool)
(declare-fun a0x401270_iopl2 () Bool)
(declare-fun a0x401270_nt () Bool)
(declare-fun a0x401270_RESERVED_15 () Bool)
(declare-fun a0x401270_rf () Bool)
(declare-fun a0x401270_vm () Bool)
(declare-fun a0x401270_ac () Bool)
(declare-fun a0x401270_vif () Bool)
(declare-fun a0x401270_vip () Bool)
(declare-fun a0x401270_id () Bool)
(declare-fun a0x401270_el () Bool)
(declare-fun a0x401270_el0 () Bool)
(declare-fun a0x401270_el1 () Bool)
(declare-fun a0x401270_el2 () Bool)
(declare-fun a0x401270_el3 () Bool)
(declare-fun a0x401270_el4 () Bool)
(declare-fun a0x401270_el5 () Bool)
(declare-fun a0x401270_el6 () Bool)
(declare-fun a0x401270_el7 () Bool)
(declare-fun a0x401270_el8 () Bool)
(declare-fun a0x401270_xmm0 () (_ BitVec 512))
(declare-fun a0x401270_xmm1 () (_ BitVec 512))
(declare-fun a0x401270_xmm2 () (_ BitVec 512))
(declare-fun a0x401270_xmm3 () (_ BitVec 512))
(declare-fun a0x401270_xmm4 () (_ BitVec 512))
(declare-fun a0x401270_xmm5 () (_ BitVec 512))
(declare-fun a0x401270_xmm6 () (_ BitVec 512))
(declare-fun a0x401270_xmm7 () (_ BitVec 512))
(declare-fun a0x401270_xmm8 () (_ BitVec 512))
(declare-fun a0x401270_xmm9 () (_ BitVec 512))
(declare-fun a0x401270_xmm10 () (_ BitVec 512))
(declare-fun a0x401270_xmm11 () (_ BitVec 512))
(declare-fun a0x401270_xmm12 () (_ BitVec 512))
(declare-fun a0x401270_xmm13 () (_ BitVec 512))
(declare-fun a0x401270_xmm14 () (_ BitVec 512))
(declare-fun a0x401270_xmm15 () (_ BitVec 512))
(assert (= a0x401270_rbx fnstart_rbx))
(assert (= a0x401270_rsp fnstart_rsp))
(assert (= a0x401270_rbp fnstart_rbp))
(assert (= a0x401270_rax a0x401270_rsi))
(assert (= a0x401270_r12 fnstart_r12))
(assert (= a0x401270_r13 fnstart_r13))
(assert (= a0x401270_r14 fnstart_r14))
(assert (= a0x401270_r15 fnstart_r15))
(assert (= a0x401270_cf a0x401270_sf))
(assert (= a0x401270_cf a0x401270_df))
(assert (= a0x401270_cf a0x401270_of))
; LLVM:     ret void
(declare-fun readv () (_ BitVec 64))
(assert (on_stack a0x401270_rsp #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem a0x401270_rsp)))
(define-fun rsp () (_ BitVec 64) (bvadd a0x401270_rsp #x0000000000000008))
(assert (= rsp (bvadd fnstart_rsp #x0000000000000008)))
(assert (= readv (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x401270_df))
(assert (= a0x401270_rbp fnstart_rbp))
(check-sat-assuming ((not (= a0x401270_rbx fnstart_rbx))))
(exit)
