; web.block_0_40158a.5 @ 0x401592: precondition ((= (llvm t51) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t50 #b1)) (= %t42 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))))
(exit)
