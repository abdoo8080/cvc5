; web.block_0_401834.2 @ 0x401837: precondition ((= (llvm t242) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t241 #b1) (= %t236 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
