; web.block_0_401653.2 @ 0x40166f: precondition ((= (llvm t102) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t99 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
