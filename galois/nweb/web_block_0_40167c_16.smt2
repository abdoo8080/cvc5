; web.block_0_40167c.5 @ 0x401684: precondition ((= (llvm t112) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t111 #b1)) (= %t104 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
