; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: register value preserved (r14, after return)
(set-logic ALL)
...
(assert (= a0x401270_r12 fnstart_r12))
(assert (= a0x401270_r13 fnstart_r13))
(check-sat-assuming ((not (= a0x401270_r14 fnstart_r14))))
(exit)
