; web.block_0_40197a.1 @ 0x401985: precondition ((= (llvm t310) (mcstack (bvsub stack_high (_ bv68 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t307 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000044))))))
(exit)
