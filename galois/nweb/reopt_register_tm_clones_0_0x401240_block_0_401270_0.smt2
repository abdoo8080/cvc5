; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: machine code reads from unallocated stack space
(set-logic ALL)
...
(check-sat-assuming ((not (on_stack a0x401270_rsp #x0000000000000008))))
(exit)
