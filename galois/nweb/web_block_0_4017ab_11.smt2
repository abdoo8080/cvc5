; web.block_0_4017ab.1 @ 0x4017b6: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t196 () (_ BitVec 64))
(declare-fun %t197 () (_ BitVec 32))
(declare-fun %t198 () (_ BitVec 32))
(assert (= %t196 a0x4017ab_rax))
(assert (= %t197 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t198 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4017ab_rbx fnstart_rbx))
(assert (= a0x4017ab_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4017ab_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4017ab_r12 fnstart_r12))
(assert (= a0x4017ab_r13 fnstart_r13))
(assert (= a0x4017ab_r14 fnstart_r14))
(assert (= a0x4017ab_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t199 = trunc i64 %t196 to i32
(define-fun %t199 () (_ BitVec 32) ((_ extract 31 0) %t196))
; LLVM:     jump label %block_0_4017be
(define-fun addr () (_ BitVec 64) (bvadd a0x4017ab_rbp #xffffffffffffffec))
(assert (is_in_mc_only_stack_range addr #x0000000000000004))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 init_mem addr ((_ extract 31 0) a0x4017ab_rax)))
(define-fun addr0 () (_ BitVec 64) (bvadd a0x4017ab_rbp #xffffffffffffffc8))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem0 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 mem addr0 #x0000000000000000))
(define-fun addr1 () (_ BitVec 64) (bvadd a0x4017ab_rbp #xffffffffffffffe0))
(assert (is_in_mc_only_stack_range addr1 #x0000000000000008))
(define-fun mem1 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 mem0 addr1 #x0000000000000000))
(assert true)
(assert (= a0x4017ab_df false))
(assert (= #x0000000000000000 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= #x0000000000000000 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t199 (mem_readbv32 mem1 (bvsub fnstart_rsp #x000000000000001c))))
(assert (= %t197 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t198 (mem_readbv32 mem1 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4017ab_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x4017ab_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
