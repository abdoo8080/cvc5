; _dl_relocate_static_pie.block_0_401200.0 @ 0x401204: machine code reads from unallocated stack space
(set-logic ALL)
...
(check-sat-assuming ((not (on_stack fnstart_rsp #x0000000000000008))))
(exit)
