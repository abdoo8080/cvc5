; web.block_0_401569.3 @ 0x401575: precondition ((= (llvm t40) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(assert (= %t30 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(check-sat-assuming ((not (= %t31 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
