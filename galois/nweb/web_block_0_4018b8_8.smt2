; web.block_0_4018b8.2 @ 0x4018be: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t272 #b1) (= a0x4018b8_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
