; web.block_0_40168a.5 @ 0x401699: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun a0x40168a_rax () (_ BitVec 64))
(declare-fun a0x40168a_rcx () (_ BitVec 64))
(declare-fun a0x40168a_rdx () (_ BitVec 64))
(declare-fun a0x40168a_rbx () (_ BitVec 64))
(declare-fun a0x40168a_rsp () (_ BitVec 64))
(declare-fun a0x40168a_rbp () (_ BitVec 64))
(declare-fun a0x40168a_rsi () (_ BitVec 64))
(declare-fun a0x40168a_rdi () (_ BitVec 64))
(declare-fun a0x40168a_r8 () (_ BitVec 64))
(declare-fun a0x40168a_r9 () (_ BitVec 64))
(declare-fun a0x40168a_r10 () (_ BitVec 64))
(declare-fun a0x40168a_r11 () (_ BitVec 64))
(declare-fun a0x40168a_r12 () (_ BitVec 64))
(declare-fun a0x40168a_r13 () (_ BitVec 64))
(declare-fun a0x40168a_r14 () (_ BitVec 64))
(declare-fun a0x40168a_r15 () (_ BitVec 64))
(declare-fun a0x40168a_cf () Bool)
(declare-fun a0x40168a_RESERVED_1 () Bool)
(declare-fun a0x40168a_pf () Bool)
(declare-fun a0x40168a_RESERVED_3 () Bool)
(declare-fun a0x40168a_af () Bool)
(declare-fun a0x40168a_RESERVED_5 () Bool)
(declare-fun a0x40168a_zf () Bool)
(declare-fun a0x40168a_sf () Bool)
(declare-fun a0x40168a_tf () Bool)
(declare-fun a0x40168a_if () Bool)
(define-fun a0x40168a_df () Bool false)
(declare-fun a0x40168a_of () Bool)
(declare-fun a0x40168a_iopl1 () Bool)
(declare-fun a0x40168a_iopl2 () Bool)
(declare-fun a0x40168a_nt () Bool)
(declare-fun a0x40168a_RESERVED_15 () Bool)
(declare-fun a0x40168a_rf () Bool)
(declare-fun a0x40168a_vm () Bool)
(declare-fun a0x40168a_ac () Bool)
(declare-fun a0x40168a_vif () Bool)
(declare-fun a0x40168a_vip () Bool)
(declare-fun a0x40168a_id () Bool)
(declare-fun a0x40168a_el () Bool)
(declare-fun a0x40168a_el0 () Bool)
(declare-fun a0x40168a_el1 () Bool)
(declare-fun a0x40168a_el2 () Bool)
(declare-fun a0x40168a_el3 () Bool)
(declare-fun a0x40168a_el4 () Bool)
(declare-fun a0x40168a_el5 () Bool)
(declare-fun a0x40168a_el6 () Bool)
(declare-fun a0x40168a_el7 () Bool)
(declare-fun a0x40168a_el8 () Bool)
(declare-fun a0x40168a_xmm0 () (_ BitVec 512))
(declare-fun a0x40168a_xmm1 () (_ BitVec 512))
(declare-fun a0x40168a_xmm2 () (_ BitVec 512))
(declare-fun a0x40168a_xmm3 () (_ BitVec 512))
(declare-fun a0x40168a_xmm4 () (_ BitVec 512))
(declare-fun a0x40168a_xmm5 () (_ BitVec 512))
(declare-fun a0x40168a_xmm6 () (_ BitVec 512))
(declare-fun a0x40168a_xmm7 () (_ BitVec 512))
(declare-fun a0x40168a_xmm8 () (_ BitVec 512))
(declare-fun a0x40168a_xmm9 () (_ BitVec 512))
(declare-fun a0x40168a_xmm10 () (_ BitVec 512))
(declare-fun a0x40168a_xmm11 () (_ BitVec 512))
(declare-fun a0x40168a_xmm12 () (_ BitVec 512))
(declare-fun a0x40168a_xmm13 () (_ BitVec 512))
(declare-fun a0x40168a_xmm14 () (_ BitVec 512))
(declare-fun a0x40168a_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t112 () (_ BitVec 64))
(declare-fun %t113 () (_ BitVec 32))
(declare-fun %t114 () (_ BitVec 32))
(assert (= %t112 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t113 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t114 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40168a_rbx fnstart_rbx))
(assert (= a0x40168a_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40168a_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40168a_r12 fnstart_r12))
(assert (= a0x40168a_r13 fnstart_r13))
(assert (= a0x40168a_r14 fnstart_r14))
(assert (= a0x40168a_r15 fnstart_r15))
(assert (= a0x40168a_af a0x40168a_df))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t115 = add i64 %t112, 4211152
(define-fun %t115 () (_ BitVec 64) (bvadd %t112 #x00000000004041d0))
; LLVM:     %t116 = inttoptr i64 %t115 to i8*
(define-fun %t116 () (_ BitVec 64) %t115)
; LLVM:     %t117 = load i8* %t116, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x40168a_rbp #xffffffffffffffe0))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack addr #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem addr)))
(define-fun addr0 () (_ BitVec 64) (bvadd #x0000000000000000 (bvadd (bvmul #x0000000000000001 readv) #x00000000004041d0)))
(declare-fun readv0 () (_ BitVec 8))
(assert (= addr0 %t116))
(assert (not_in_stack_range addr0 #x0000000000000008))
(assert (= readv0 (mem_readbv8 init_mem addr0)))
(define-fun %t117 () (_ BitVec 8) (mem_readbv8 init_mem addr0))
; LLVM:     %t118 = sext i8 %t117 to i32
(define-fun %t118 () (_ BitVec 32) ((_ sign_extend 24) %t117))
; LLVM:     %t119 = icmp eq i32 %t118, 32
(define-fun %t119 () (_ BitVec 1) (ite (= %t118 #x00000020) #b1 #b0))
; LLVM:     br i1 %t119, label %block_0_40169f, label %block_0_4016b0
(define-fun rax () (_ BitVec 64) ((_ zero_extend 32) ((_ sign_extend 24) readv0)))
(assert (=> (= %t119 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111100000 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) false true) #x00000000004016b0 #x000000000040169f) #x000000000040169f)))
(assert (=> (= %t119 #b1) (= a0x40168a_df false)))
(assert (=> (= %t119 #b1) (= %t112 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (= %t119 #b1) (= %t113 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t119 #b1) (= %t114 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t119 #b1) (= a0x40168a_rbx fnstart_rbx)))
(assert (=> (= %t119 #b1) (= a0x40168a_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t119 #b1) (= a0x40168a_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t119 #b1) (= a0x40168a_r12 fnstart_r12)))
(assert (=> (= %t119 #b1) (= a0x40168a_r13 fnstart_r13)))
(assert (=> (= %t119 #b1) (= a0x40168a_r14 fnstart_r14)))
(assert (=> (= %t119 #b1) (= a0x40168a_r15 fnstart_r15)))
(assert (=> (= %t119 #b1) (= (ite (ite (not (= (bvand (bvxor #x00000020 ((_ extract 31 0) rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b011111111111111111111111111100000 (concat #b0 ((_ extract 31 0) rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b011111111111111111111111111100000 (concat #b0 ((_ extract 31 0) rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true) a0x40168a_df)))
(assert (=> (= %t119 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t119 #b1)) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111100000 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) false true) #x00000000004016b0 #x000000000040169f) #x00000000004016b0)))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_df false)))
(assert (=> (not (= %t119 #b1)) (= %t112 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (not (= %t119 #b1)) (= %t113 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t119 #b1)) (= %t114 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_rbx fnstart_rbx)))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_r12 fnstart_r12)))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_r13 fnstart_r13)))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_r14 fnstart_r14)))
(assert (=> (not (= %t119 #b1)) (= a0x40168a_r15 fnstart_r15)))
(assert (=> (not (= %t119 #b1)) (= (ite (ite (not (= (bvand (bvxor #x00000020 ((_ extract 31 0) rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b011111111111111111111111111100000 (concat #b0 ((_ extract 31 0) rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b011111111111111111111111111100000 (concat #b0 ((_ extract 31 0) rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true) a0x40168a_df)))
(check-sat-assuming ((not (=> (not (= %t119 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
