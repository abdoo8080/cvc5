; web.block_0_401569.3 @ 0x401575: precondition ((= (llvm t41) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(assert (= %t30 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t31 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(check-sat-assuming ((not (= %t32 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
