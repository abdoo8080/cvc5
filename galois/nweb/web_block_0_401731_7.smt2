; web.block_0_401731.1 @ 0x40173f: precondition ((= (llvm t135) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t172 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
