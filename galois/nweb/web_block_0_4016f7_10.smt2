; web.block_0_4016f7.7 @ 0x40170a: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t163 #b1) (= a0x4016f7_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
