; web.block_0_401623.2 @ 0x401626: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t90 #b1) (= a0x401623_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
