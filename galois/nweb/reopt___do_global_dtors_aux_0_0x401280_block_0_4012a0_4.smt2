; reopt___do_global_dtors_aux_0_0x401280.block_0_4012a0.0 @ 0x4012a0: register value preserved (rbp, after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x4012a0_rbp fnstart_rbp))))
(exit)
