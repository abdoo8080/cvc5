; web.block_0_4015ad.5 @ 0x4015bc: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t68 #b1)) (= a0x4015ad_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
