; web.block_0_40169f.3 @ 0x4016ab: precondition ((= (llvm t129) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t120 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
