; web.block_0_401880.2 @ 0x40189c: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x401880_rax () (_ BitVec 64))
(declare-fun a0x401880_rcx () (_ BitVec 64))
(declare-fun a0x401880_rdx () (_ BitVec 64))
(declare-fun a0x401880_rbx () (_ BitVec 64))
(declare-fun a0x401880_rsp () (_ BitVec 64))
(declare-fun a0x401880_rbp () (_ BitVec 64))
(declare-fun a0x401880_rsi () (_ BitVec 64))
(declare-fun a0x401880_rdi () (_ BitVec 64))
(declare-fun a0x401880_r8 () (_ BitVec 64))
(declare-fun a0x401880_r9 () (_ BitVec 64))
(declare-fun a0x401880_r10 () (_ BitVec 64))
(declare-fun a0x401880_r11 () (_ BitVec 64))
(declare-fun a0x401880_r12 () (_ BitVec 64))
(declare-fun a0x401880_r13 () (_ BitVec 64))
(declare-fun a0x401880_r14 () (_ BitVec 64))
(declare-fun a0x401880_r15 () (_ BitVec 64))
(declare-fun a0x401880_cf () Bool)
(declare-fun a0x401880_RESERVED_1 () Bool)
(declare-fun a0x401880_pf () Bool)
(declare-fun a0x401880_RESERVED_3 () Bool)
(declare-fun a0x401880_af () Bool)
(declare-fun a0x401880_RESERVED_5 () Bool)
(declare-fun a0x401880_zf () Bool)
(declare-fun a0x401880_sf () Bool)
(declare-fun a0x401880_tf () Bool)
(declare-fun a0x401880_if () Bool)
(define-fun a0x401880_df () Bool false)
(declare-fun a0x401880_of () Bool)
(declare-fun a0x401880_iopl1 () Bool)
(declare-fun a0x401880_iopl2 () Bool)
(declare-fun a0x401880_nt () Bool)
(declare-fun a0x401880_RESERVED_15 () Bool)
(declare-fun a0x401880_rf () Bool)
(declare-fun a0x401880_vm () Bool)
(declare-fun a0x401880_ac () Bool)
(declare-fun a0x401880_vif () Bool)
(declare-fun a0x401880_vip () Bool)
(declare-fun a0x401880_id () Bool)
(declare-fun a0x401880_el () Bool)
(declare-fun a0x401880_el0 () Bool)
(declare-fun a0x401880_el1 () Bool)
(declare-fun a0x401880_el2 () Bool)
(declare-fun a0x401880_el3 () Bool)
(declare-fun a0x401880_el4 () Bool)
(declare-fun a0x401880_el5 () Bool)
(declare-fun a0x401880_el6 () Bool)
(declare-fun a0x401880_el7 () Bool)
(declare-fun a0x401880_el8 () Bool)
(declare-fun a0x401880_xmm0 () (_ BitVec 512))
(declare-fun a0x401880_xmm1 () (_ BitVec 512))
(declare-fun a0x401880_xmm2 () (_ BitVec 512))
(declare-fun a0x401880_xmm3 () (_ BitVec 512))
(declare-fun a0x401880_xmm4 () (_ BitVec 512))
(declare-fun a0x401880_xmm5 () (_ BitVec 512))
(declare-fun a0x401880_xmm6 () (_ BitVec 512))
(declare-fun a0x401880_xmm7 () (_ BitVec 512))
(declare-fun a0x401880_xmm8 () (_ BitVec 512))
(declare-fun a0x401880_xmm9 () (_ BitVec 512))
(declare-fun a0x401880_xmm10 () (_ BitVec 512))
(declare-fun a0x401880_xmm11 () (_ BitVec 512))
(declare-fun a0x401880_xmm12 () (_ BitVec 512))
(declare-fun a0x401880_xmm13 () (_ BitVec 512))
(declare-fun a0x401880_xmm14 () (_ BitVec 512))
(declare-fun a0x401880_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t259 () (_ BitVec 64))
(declare-fun %t260 () (_ BitVec 32))
(declare-fun %t261 () (_ BitVec 32))
(assert (= %t259 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t260 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t261 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401880_rbx fnstart_rbx))
(assert (= a0x401880_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401880_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401880_r12 fnstart_r12))
(assert (= a0x401880_r13 fnstart_r13))
(assert (= a0x401880_r14 fnstart_r14))
(assert (= a0x401880_r15 fnstart_r15))
(assert (= a0x401880_cf a0x401880_af))
(assert (= a0x401880_cf a0x401880_df))
(assert (= a0x401880_cf a0x401880_of))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t262 = zext i32 %t261 to i64
(define-fun %t262 () (_ BitVec 64) ((_ zero_extend 32) %t261))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x401880_rbp #xfffffffffffffffc))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x401880_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x401880_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x00000000004018a1))
(assert true)
(assert true)
(assert true)
(assert (= %t262 rcx))
(assert (not a0x401880_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004018a1))
(declare-fun a0x4018a1_xmm15 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm14 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm13 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm12 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm11 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm10 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm9 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm8 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm7 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm6 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm5 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm4 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm3 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm2 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm1 () (_ BitVec 512))
(declare-fun a0x4018a1_xmm0 () (_ BitVec 512))
(declare-fun a0x4018a1_el8 () Bool)
(declare-fun a0x4018a1_el7 () Bool)
(declare-fun a0x4018a1_el6 () Bool)
(declare-fun a0x4018a1_el5 () Bool)
(declare-fun a0x4018a1_el4 () Bool)
(declare-fun a0x4018a1_el3 () Bool)
(declare-fun a0x4018a1_el2 () Bool)
(declare-fun a0x4018a1_el1 () Bool)
(declare-fun a0x4018a1_el0 () Bool)
(declare-fun a0x4018a1_el () Bool)
(declare-fun a0x4018a1_id () Bool)
(declare-fun a0x4018a1_vip () Bool)
(declare-fun a0x4018a1_vif () Bool)
(declare-fun a0x4018a1_ac () Bool)
(declare-fun a0x4018a1_vm () Bool)
(declare-fun a0x4018a1_rf () Bool)
(declare-fun a0x4018a1_RESERVED_15 () Bool)
(declare-fun a0x4018a1_nt () Bool)
(declare-fun a0x4018a1_iopl2 () Bool)
(declare-fun a0x4018a1_iopl1 () Bool)
(declare-fun a0x4018a1_of () Bool)
(define-fun a0x4018a1_df () Bool false)
(declare-fun a0x4018a1_if () Bool)
(declare-fun a0x4018a1_tf () Bool)
(declare-fun a0x4018a1_sf () Bool)
(declare-fun a0x4018a1_zf () Bool)
(declare-fun a0x4018a1_RESERVED_5 () Bool)
(declare-fun a0x4018a1_af () Bool)
(declare-fun a0x4018a1_RESERVED_3 () Bool)
(declare-fun a0x4018a1_pf () Bool)
(declare-fun a0x4018a1_RESERVED_1 () Bool)
(declare-fun a0x4018a1_cf () Bool)
(declare-fun a0x4018a1_r15 () (_ BitVec 64))
(declare-fun a0x4018a1_r14 () (_ BitVec 64))
(declare-fun a0x4018a1_r13 () (_ BitVec 64))
(declare-fun a0x4018a1_r12 () (_ BitVec 64))
(declare-fun a0x4018a1_r11 () (_ BitVec 64))
(declare-fun a0x4018a1_r10 () (_ BitVec 64))
(declare-fun a0x4018a1_r9 () (_ BitVec 64))
(declare-fun a0x4018a1_r8 () (_ BitVec 64))
(declare-fun a0x4018a1_rdi () (_ BitVec 64))
(declare-fun a0x4018a1_rsi () (_ BitVec 64))
(declare-fun a0x4018a1_rbp () (_ BitVec 64))
(declare-fun a0x4018a1_rsp () (_ BitVec 64))
(declare-fun a0x4018a1_rbx () (_ BitVec 64))
(declare-fun a0x4018a1_rdx () (_ BitVec 64))
(declare-fun a0x4018a1_rcx () (_ BitVec 64))
(declare-fun a0x4018a1_rax () (_ BitVec 64))
...
; LLVM:     jump label %block_0_4018a1
(assert true)
(assert (= a0x4018a1_df false))
(assert (= %t259 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t260 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t261 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401880_rbx fnstart_rbx))
