; web.block_0_401524.1 @ 0x401529: precondition ((= (llvm t16) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t11 #b1)) (= %t8 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))))
(exit)
