; web.block_0_4015ad.5 @ 0x4015bc: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun a0x4015ad_rax () (_ BitVec 64))
(declare-fun a0x4015ad_rcx () (_ BitVec 64))
(declare-fun a0x4015ad_rdx () (_ BitVec 64))
(declare-fun a0x4015ad_rbx () (_ BitVec 64))
(declare-fun a0x4015ad_rsp () (_ BitVec 64))
(declare-fun a0x4015ad_rbp () (_ BitVec 64))
(declare-fun a0x4015ad_rsi () (_ BitVec 64))
(declare-fun a0x4015ad_rdi () (_ BitVec 64))
(declare-fun a0x4015ad_r8 () (_ BitVec 64))
(declare-fun a0x4015ad_r9 () (_ BitVec 64))
(declare-fun a0x4015ad_r10 () (_ BitVec 64))
(declare-fun a0x4015ad_r11 () (_ BitVec 64))
(declare-fun a0x4015ad_r12 () (_ BitVec 64))
(declare-fun a0x4015ad_r13 () (_ BitVec 64))
(declare-fun a0x4015ad_r14 () (_ BitVec 64))
(declare-fun a0x4015ad_r15 () (_ BitVec 64))
(declare-fun a0x4015ad_cf () Bool)
(declare-fun a0x4015ad_RESERVED_1 () Bool)
(declare-fun a0x4015ad_pf () Bool)
(declare-fun a0x4015ad_RESERVED_3 () Bool)
(declare-fun a0x4015ad_af () Bool)
(declare-fun a0x4015ad_RESERVED_5 () Bool)
(declare-fun a0x4015ad_zf () Bool)
(declare-fun a0x4015ad_sf () Bool)
(declare-fun a0x4015ad_tf () Bool)
(declare-fun a0x4015ad_if () Bool)
(define-fun a0x4015ad_df () Bool false)
(declare-fun a0x4015ad_of () Bool)
(declare-fun a0x4015ad_iopl1 () Bool)
(declare-fun a0x4015ad_iopl2 () Bool)
(declare-fun a0x4015ad_nt () Bool)
(declare-fun a0x4015ad_RESERVED_15 () Bool)
(declare-fun a0x4015ad_rf () Bool)
(declare-fun a0x4015ad_vm () Bool)
(declare-fun a0x4015ad_ac () Bool)
(declare-fun a0x4015ad_vif () Bool)
(declare-fun a0x4015ad_vip () Bool)
(declare-fun a0x4015ad_id () Bool)
(declare-fun a0x4015ad_el () Bool)
(declare-fun a0x4015ad_el0 () Bool)
(declare-fun a0x4015ad_el1 () Bool)
(declare-fun a0x4015ad_el2 () Bool)
(declare-fun a0x4015ad_el3 () Bool)
(declare-fun a0x4015ad_el4 () Bool)
(declare-fun a0x4015ad_el5 () Bool)
(declare-fun a0x4015ad_el6 () Bool)
(declare-fun a0x4015ad_el7 () Bool)
(declare-fun a0x4015ad_el8 () Bool)
(declare-fun a0x4015ad_xmm0 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm1 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm2 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm3 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm4 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm5 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm6 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm7 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm8 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm9 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm10 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm11 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm12 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm13 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm14 () (_ BitVec 512))
(declare-fun a0x4015ad_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t60 () (_ BitVec 64))
(declare-fun %t61 () (_ BitVec 64))
(declare-fun %t62 () (_ BitVec 32))
(declare-fun %t63 () (_ BitVec 32))
(assert (= %t60 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t61 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t62 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t63 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4015ad_rbx fnstart_rbx))
(assert (= a0x4015ad_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4015ad_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4015ad_r12 fnstart_r12))
(assert (= a0x4015ad_r13 fnstart_r13))
(assert (= a0x4015ad_r14 fnstart_r14))
(assert (= a0x4015ad_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t64 = add i64 %t61, 4211152
(define-fun %t64 () (_ BitVec 64) (bvadd %t61 #x00000000004041d0))
; LLVM:     %t65 = inttoptr i64 %t64 to i8*
(define-fun %t65 () (_ BitVec 64) %t64)
; LLVM:     %t66 = load i8* %t65, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x4015ad_rbp #xffffffffffffffe0))
...
(define-fun %t66 () (_ BitVec 8) (mem_readbv8 init_mem addr0))
; LLVM:     %t67 = sext i8 %t66 to i32
(define-fun %t67 () (_ BitVec 32) ((_ sign_extend 24) %t66))
; LLVM:     %t68 = icmp eq i32 %t67, 10
(define-fun %t68 () (_ BitVec 1) (ite (= %t67 #x0000000a) #b1 #b0))
; LLVM:     br i1 %t68, label %block_0_4015c2, label %block_0_4015ce
(define-fun rax () (_ BitVec 64) ((_ zero_extend 32) ((_ sign_extend 24) readv0)))
(assert (=> (= %t68 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111110110 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) false true) #x00000000004015ce #x00000000004015c2) #x00000000004015c2)))
(assert (=> (= %t68 #b1) (= a0x4015ad_df false)))
(assert (=> (= %t68 #b1) (= %t60 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))
(assert (=> (= %t68 #b1) (= %t61 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (= %t68 #b1) (= %t62 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t68 #b1) (= %t63 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t68 #b1) (= a0x4015ad_rbx fnstart_rbx)))
(assert (=> (= %t68 #b1) (= a0x4015ad_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t68 #b1) (= a0x4015ad_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t68 #b1) (= a0x4015ad_r12 fnstart_r12)))
(assert (=> (= %t68 #b1) (= a0x4015ad_r13 fnstart_r13)))
(assert (=> (= %t68 #b1) (= a0x4015ad_r14 fnstart_r14)))
(assert (=> (= %t68 #b1) (= a0x4015ad_r15 fnstart_r15)))
(assert (=> (= %t68 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t68 #b1)) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111110110 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) false true) #x00000000004015ce #x00000000004015c2) #x00000000004015ce)))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_df false)))
(assert (=> (not (= %t68 #b1)) (= %t60 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))
(assert (=> (not (= %t68 #b1)) (= %t61 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (not (= %t68 #b1)) (= %t62 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t68 #b1)) (= %t63 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_rbx fnstart_rbx)))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_r12 fnstart_r12)))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_r13 fnstart_r13)))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_r14 fnstart_r14)))
(assert (=> (not (= %t68 #b1)) (= a0x4015ad_r15 fnstart_r15)))
(check-sat-assuming ((not (=> (not (= %t68 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
