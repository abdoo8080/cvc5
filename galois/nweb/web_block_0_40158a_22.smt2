; web.block_0_40158a.5 @ 0x401592: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t50 #b1)) (= a0x40158a_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
