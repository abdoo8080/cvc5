; web.block_0_401931.1 @ 0x401954: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x401931_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
