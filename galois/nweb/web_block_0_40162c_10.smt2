; web.block_0_40162c.1 @ 0x401645: precondition ((= (llvm t96) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t92 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
