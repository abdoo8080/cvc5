; web.block_0_401731.1 @ 0x40173f: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t169 () (_ BitVec 64))
(declare-fun %t170 () (_ BitVec 32))
(declare-fun %t171 () (_ BitVec 32))
(declare-fun %t172 () (_ BitVec 32))
(assert (= %t169 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t170 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014))))
(assert (= %t171 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t172 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401731_rbx fnstart_rbx))
(assert (= a0x401731_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401731_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401731_r12 fnstart_r12))
(assert (= a0x401731_r13 fnstart_r13))
(assert (= a0x401731_r14 fnstart_r14))
(assert (= a0x401731_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t173 = add i32 %t170, 1
(define-fun %t173 () (_ BitVec 32) (bvadd %t170 #x00000001))
; LLVM:     jump label %block_0_4016cd
(define-fun addr () (_ BitVec 64) (bvadd a0x401731_rbp #xfffffffffffffff4))
...
(define-fun addr0 () (_ BitVec 64) (bvadd a0x401731_rbp #xfffffffffffffff4))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000004))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 init_mem addr0 ((_ extract 31 0) rax0)))
(assert true)
(assert (= a0x401731_df false))
(assert (= %t169 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t173 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000014))))
(assert (= %t171 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t172 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401731_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x401731_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
