; web.block_0_401789.2 @ 0x40178c: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t189 #b1)) (= a0x401789_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
