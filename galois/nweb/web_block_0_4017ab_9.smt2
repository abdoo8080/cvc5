; web.block_0_4017ab.1 @ 0x4017b6: precondition ((= (llvm t204) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t198 (mem_readbv32 mem1 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
