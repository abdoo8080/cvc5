; web.block_0_4017fa.8 @ 0x40182f: precondition ((= (llvm t236) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t222 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
