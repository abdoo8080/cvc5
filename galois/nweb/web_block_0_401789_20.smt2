; web.block_0_401789.2 @ 0x40178c: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t189 #b1)) (= a0x401789_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
