; web.block_0_4015ad.5 @ 0x4015bc: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t68 #b1) (= a0x4015ad_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
