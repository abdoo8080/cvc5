; web.block_0_4019b6.3 @ 0x4019be: precondition ((= rax (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t324 #b1) (= a0x4019b6_rax (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000030)))))))
(exit)
