; web.block_0_40169f.3 @ 0x4016ab: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(declare-fun a0x40169f_rax () (_ BitVec 64))
(declare-fun a0x40169f_rcx () (_ BitVec 64))
(declare-fun a0x40169f_rdx () (_ BitVec 64))
(declare-fun a0x40169f_rbx () (_ BitVec 64))
(declare-fun a0x40169f_rsp () (_ BitVec 64))
(declare-fun a0x40169f_rbp () (_ BitVec 64))
(declare-fun a0x40169f_rsi () (_ BitVec 64))
(declare-fun a0x40169f_rdi () (_ BitVec 64))
(declare-fun a0x40169f_r8 () (_ BitVec 64))
(declare-fun a0x40169f_r9 () (_ BitVec 64))
(declare-fun a0x40169f_r10 () (_ BitVec 64))
(declare-fun a0x40169f_r11 () (_ BitVec 64))
(declare-fun a0x40169f_r12 () (_ BitVec 64))
(declare-fun a0x40169f_r13 () (_ BitVec 64))
(declare-fun a0x40169f_r14 () (_ BitVec 64))
(declare-fun a0x40169f_r15 () (_ BitVec 64))
(declare-fun a0x40169f_cf () Bool)
(declare-fun a0x40169f_RESERVED_1 () Bool)
(declare-fun a0x40169f_pf () Bool)
(declare-fun a0x40169f_RESERVED_3 () Bool)
(declare-fun a0x40169f_af () Bool)
(declare-fun a0x40169f_RESERVED_5 () Bool)
(declare-fun a0x40169f_zf () Bool)
(declare-fun a0x40169f_sf () Bool)
(declare-fun a0x40169f_tf () Bool)
(declare-fun a0x40169f_if () Bool)
(define-fun a0x40169f_df () Bool false)
(declare-fun a0x40169f_of () Bool)
(declare-fun a0x40169f_iopl1 () Bool)
(declare-fun a0x40169f_iopl2 () Bool)
(declare-fun a0x40169f_nt () Bool)
(declare-fun a0x40169f_RESERVED_15 () Bool)
(declare-fun a0x40169f_rf () Bool)
(declare-fun a0x40169f_vm () Bool)
(declare-fun a0x40169f_ac () Bool)
(declare-fun a0x40169f_vif () Bool)
(declare-fun a0x40169f_vip () Bool)
(declare-fun a0x40169f_id () Bool)
(declare-fun a0x40169f_el () Bool)
(declare-fun a0x40169f_el0 () Bool)
(declare-fun a0x40169f_el1 () Bool)
(declare-fun a0x40169f_el2 () Bool)
(declare-fun a0x40169f_el3 () Bool)
(declare-fun a0x40169f_el4 () Bool)
(declare-fun a0x40169f_el5 () Bool)
(declare-fun a0x40169f_el6 () Bool)
(declare-fun a0x40169f_el7 () Bool)
(declare-fun a0x40169f_el8 () Bool)
(declare-fun a0x40169f_xmm0 () (_ BitVec 512))
(declare-fun a0x40169f_xmm1 () (_ BitVec 512))
(declare-fun a0x40169f_xmm2 () (_ BitVec 512))
(declare-fun a0x40169f_xmm3 () (_ BitVec 512))
(declare-fun a0x40169f_xmm4 () (_ BitVec 512))
(declare-fun a0x40169f_xmm5 () (_ BitVec 512))
(declare-fun a0x40169f_xmm6 () (_ BitVec 512))
(declare-fun a0x40169f_xmm7 () (_ BitVec 512))
(declare-fun a0x40169f_xmm8 () (_ BitVec 512))
(declare-fun a0x40169f_xmm9 () (_ BitVec 512))
(declare-fun a0x40169f_xmm10 () (_ BitVec 512))
(declare-fun a0x40169f_xmm11 () (_ BitVec 512))
(declare-fun a0x40169f_xmm12 () (_ BitVec 512))
(declare-fun a0x40169f_xmm13 () (_ BitVec 512))
(declare-fun a0x40169f_xmm14 () (_ BitVec 512))
(declare-fun a0x40169f_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t120 () (_ BitVec 64))
(declare-fun %t121 () (_ BitVec 32))
(declare-fun %t122 () (_ BitVec 32))
(assert (= %t120 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t121 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t122 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40169f_rbx fnstart_rbx))
(assert (= a0x40169f_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40169f_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40169f_r12 fnstart_r12))
(assert (= a0x40169f_r13 fnstart_r13))
(assert (= a0x40169f_r14 fnstart_r14))
(assert (= a0x40169f_r15 fnstart_r15))
(assert (= a0x40169f_af a0x40169f_df))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t123 = add i64 %t120, 4211152
(define-fun %t123 () (_ BitVec 64) (bvadd %t120 #x00000000004041d0))
; LLVM:     %t124 = inttoptr i64 %t123 to i8*
(define-fun %t124 () (_ BitVec 64) %t123)
; LLVM:     store i8 0, i8* %t124, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x40169f_rbp #xffffffffffffffe0))
...
(assert (= %t124 addr0))
(assert true)
; LLVM:     jump label %block_0_4016c6
(assert true)
(assert (= a0x40169f_df false))
(assert (= %t120 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t121 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t122 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40169f_rbx fnstart_rbx))
