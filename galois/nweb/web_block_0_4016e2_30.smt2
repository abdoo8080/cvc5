; web.block_0_4016e2.6 @ 0x4016f1: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun a0x4016e2_rax () (_ BitVec 64))
(declare-fun a0x4016e2_rcx () (_ BitVec 64))
(declare-fun a0x4016e2_rdx () (_ BitVec 64))
(declare-fun a0x4016e2_rbx () (_ BitVec 64))
(declare-fun a0x4016e2_rsp () (_ BitVec 64))
(declare-fun a0x4016e2_rbp () (_ BitVec 64))
(declare-fun a0x4016e2_rsi () (_ BitVec 64))
(declare-fun a0x4016e2_rdi () (_ BitVec 64))
(declare-fun a0x4016e2_r8 () (_ BitVec 64))
(declare-fun a0x4016e2_r9 () (_ BitVec 64))
(declare-fun a0x4016e2_r10 () (_ BitVec 64))
(declare-fun a0x4016e2_r11 () (_ BitVec 64))
(declare-fun a0x4016e2_r12 () (_ BitVec 64))
(declare-fun a0x4016e2_r13 () (_ BitVec 64))
(declare-fun a0x4016e2_r14 () (_ BitVec 64))
(declare-fun a0x4016e2_r15 () (_ BitVec 64))
(declare-fun a0x4016e2_cf () Bool)
(declare-fun a0x4016e2_RESERVED_1 () Bool)
(declare-fun a0x4016e2_pf () Bool)
(declare-fun a0x4016e2_RESERVED_3 () Bool)
(declare-fun a0x4016e2_af () Bool)
(declare-fun a0x4016e2_RESERVED_5 () Bool)
(declare-fun a0x4016e2_zf () Bool)
(declare-fun a0x4016e2_sf () Bool)
(declare-fun a0x4016e2_tf () Bool)
(declare-fun a0x4016e2_if () Bool)
(define-fun a0x4016e2_df () Bool false)
(declare-fun a0x4016e2_of () Bool)
(declare-fun a0x4016e2_iopl1 () Bool)
(declare-fun a0x4016e2_iopl2 () Bool)
(declare-fun a0x4016e2_nt () Bool)
(declare-fun a0x4016e2_RESERVED_15 () Bool)
(declare-fun a0x4016e2_rf () Bool)
(declare-fun a0x4016e2_vm () Bool)
(declare-fun a0x4016e2_ac () Bool)
(declare-fun a0x4016e2_vif () Bool)
(declare-fun a0x4016e2_vip () Bool)
(declare-fun a0x4016e2_id () Bool)
(declare-fun a0x4016e2_el () Bool)
(declare-fun a0x4016e2_el0 () Bool)
(declare-fun a0x4016e2_el1 () Bool)
(declare-fun a0x4016e2_el2 () Bool)
(declare-fun a0x4016e2_el3 () Bool)
(declare-fun a0x4016e2_el4 () Bool)
(declare-fun a0x4016e2_el5 () Bool)
(declare-fun a0x4016e2_el6 () Bool)
(declare-fun a0x4016e2_el7 () Bool)
(declare-fun a0x4016e2_el8 () Bool)
(declare-fun a0x4016e2_xmm0 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm1 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm2 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm3 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm4 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm5 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm6 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm7 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm8 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm9 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm10 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm11 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm12 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm13 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm14 () (_ BitVec 512))
(declare-fun a0x4016e2_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t143 () (_ BitVec 64))
(declare-fun %t144 () (_ BitVec 32))
(declare-fun %t145 () (_ BitVec 32))
(declare-fun %t146 () (_ BitVec 32))
(assert (= %t143 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t144 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014))))
(assert (= %t145 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t146 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4016e2_rbx fnstart_rbx))
(assert (= a0x4016e2_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4016e2_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4016e2_r12 fnstart_r12))
(assert (= a0x4016e2_r13 fnstart_r13))
(assert (= a0x4016e2_r14 fnstart_r14))
(assert (= a0x4016e2_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t147 = sext i32 %t144 to i64
(define-fun %t147 () (_ BitVec 64) ((_ sign_extend 32) %t144))
; LLVM:     %t148 = add i64 %t147, 4211152
(define-fun %t148 () (_ BitVec 64) (bvadd %t147 #x00000000004041d0))
; LLVM:     %t149 = inttoptr i64 %t148 to i8*
(define-fun %t149 () (_ BitVec 64) %t148)
; LLVM:     %t150 = load i8* %t149, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x4016e2_rbp #xfffffffffffffff4))
...
(define-fun addr0 () (_ BitVec 64) (bvadd #x0000000000000000 (bvadd (bvmul #x0000000000000001 rax) #x00000000004041d0)))
(declare-fun readv0 () (_ BitVec 8))
(assert (= addr0 %t149))
(assert (not_in_stack_range addr0 #x0000000000000008))
(assert (= readv0 (mem_readbv8 init_mem addr0)))
(define-fun %t150 () (_ BitVec 8) (mem_readbv8 init_mem addr0))
; LLVM:     %t151 = sext i8 %t150 to i32
(define-fun %t151 () (_ BitVec 32) ((_ sign_extend 24) %t150))
; LLVM:     %t152 = icmp eq i32 %t151, 46
(define-fun %t152 () (_ BitVec 1) (ite (= %t151 #x0000002e) #b1 #b0))
; LLVM:     br i1 %t152, label %block_0_4016f7, label %block_0_401731
(define-fun rax0 () (_ BitVec 64) ((_ zero_extend 32) ((_ sign_extend 24) readv0)))
(assert (=> (= %t152 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111010010 (concat #b0 ((_ extract 31 0) rax0)))) #x00000000) false true) #x0000000000401731 #x00000000004016f7) #x00000000004016f7)))
(assert (=> (= %t152 #b1) (= a0x4016e2_df false)))
(assert (=> (= %t152 #b1) (= %t143 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (= %t152 #b1) (= %t144 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014)))))
(assert (=> (= %t152 #b1) (= %t145 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t152 #b1) (= %t146 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t152 #b1) (= a0x4016e2_rbx fnstart_rbx)))
(assert (=> (= %t152 #b1) (= a0x4016e2_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t152 #b1) (= a0x4016e2_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t152 #b1) (= a0x4016e2_r12 fnstart_r12)))
(assert (=> (= %t152 #b1) (= a0x4016e2_r13 fnstart_r13)))
(assert (=> (= %t152 #b1) (= a0x4016e2_r14 fnstart_r14)))
(assert (=> (= %t152 #b1) (= a0x4016e2_r15 fnstart_r15)))
(assert (=> (= %t152 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t152 #b1)) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111010010 (concat #b0 ((_ extract 31 0) rax0)))) #x00000000) false true) #x0000000000401731 #x00000000004016f7) #x0000000000401731)))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_df false)))
(assert (=> (not (= %t152 #b1)) (= %t143 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (not (= %t152 #b1)) (= %t144 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014)))))
(assert (=> (not (= %t152 #b1)) (= %t145 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t152 #b1)) (= %t146 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_rbx fnstart_rbx)))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_r12 fnstart_r12)))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_r13 fnstart_r13)))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_r14 fnstart_r14)))
(assert (=> (not (= %t152 #b1)) (= a0x4016e2_r15 fnstart_r15)))
(check-sat-assuming ((not (=> (not (= %t152 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
