; web.block_0_401744.1 @ 0x40175d: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x401744_rax () (_ BitVec 64))
(declare-fun a0x401744_rcx () (_ BitVec 64))
(declare-fun a0x401744_rdx () (_ BitVec 64))
(declare-fun a0x401744_rbx () (_ BitVec 64))
(declare-fun a0x401744_rsp () (_ BitVec 64))
(declare-fun a0x401744_rbp () (_ BitVec 64))
(declare-fun a0x401744_rsi () (_ BitVec 64))
(declare-fun a0x401744_rdi () (_ BitVec 64))
(declare-fun a0x401744_r8 () (_ BitVec 64))
(declare-fun a0x401744_r9 () (_ BitVec 64))
(declare-fun a0x401744_r10 () (_ BitVec 64))
(declare-fun a0x401744_r11 () (_ BitVec 64))
(declare-fun a0x401744_r12 () (_ BitVec 64))
(declare-fun a0x401744_r13 () (_ BitVec 64))
(declare-fun a0x401744_r14 () (_ BitVec 64))
(declare-fun a0x401744_r15 () (_ BitVec 64))
(declare-fun a0x401744_cf () Bool)
(declare-fun a0x401744_RESERVED_1 () Bool)
(declare-fun a0x401744_pf () Bool)
(declare-fun a0x401744_RESERVED_3 () Bool)
(declare-fun a0x401744_af () Bool)
(declare-fun a0x401744_RESERVED_5 () Bool)
(declare-fun a0x401744_zf () Bool)
(declare-fun a0x401744_sf () Bool)
(declare-fun a0x401744_tf () Bool)
(declare-fun a0x401744_if () Bool)
(define-fun a0x401744_df () Bool false)
(declare-fun a0x401744_of () Bool)
(declare-fun a0x401744_iopl1 () Bool)
(declare-fun a0x401744_iopl2 () Bool)
(declare-fun a0x401744_nt () Bool)
(declare-fun a0x401744_RESERVED_15 () Bool)
(declare-fun a0x401744_rf () Bool)
(declare-fun a0x401744_vm () Bool)
(declare-fun a0x401744_ac () Bool)
(declare-fun a0x401744_vif () Bool)
(declare-fun a0x401744_vip () Bool)
(declare-fun a0x401744_id () Bool)
(declare-fun a0x401744_el () Bool)
(declare-fun a0x401744_el0 () Bool)
(declare-fun a0x401744_el1 () Bool)
(declare-fun a0x401744_el2 () Bool)
(declare-fun a0x401744_el3 () Bool)
(declare-fun a0x401744_el4 () Bool)
(declare-fun a0x401744_el5 () Bool)
(declare-fun a0x401744_el6 () Bool)
(declare-fun a0x401744_el7 () Bool)
(declare-fun a0x401744_el8 () Bool)
(declare-fun a0x401744_xmm0 () (_ BitVec 512))
(declare-fun a0x401744_xmm1 () (_ BitVec 512))
(declare-fun a0x401744_xmm2 () (_ BitVec 512))
(declare-fun a0x401744_xmm3 () (_ BitVec 512))
(declare-fun a0x401744_xmm4 () (_ BitVec 512))
(declare-fun a0x401744_xmm5 () (_ BitVec 512))
(declare-fun a0x401744_xmm6 () (_ BitVec 512))
(declare-fun a0x401744_xmm7 () (_ BitVec 512))
(declare-fun a0x401744_xmm8 () (_ BitVec 512))
(declare-fun a0x401744_xmm9 () (_ BitVec 512))
(declare-fun a0x401744_xmm10 () (_ BitVec 512))
(declare-fun a0x401744_xmm11 () (_ BitVec 512))
(declare-fun a0x401744_xmm12 () (_ BitVec 512))
(declare-fun a0x401744_xmm13 () (_ BitVec 512))
(declare-fun a0x401744_xmm14 () (_ BitVec 512))
(declare-fun a0x401744_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t174 () (_ BitVec 32))
(declare-fun %t175 () (_ BitVec 32))
(assert (= %t174 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t175 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401744_rbx fnstart_rbx))
(assert (= a0x401744_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401744_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401744_r12 fnstart_r12))
(assert (= a0x401744_r13 fnstart_r13))
(assert (= a0x401744_r14 fnstart_r14))
(assert (= a0x401744_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t176 = call i64 @strncmp (i64 4211152,i64 4204231,i64 6)
(define-fun rsp () (_ BitVec 64) (bvsub a0x401744_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x401744_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x0000000000401762))
(assert true)
(assert true)
(assert true)
(assert (not a0x401744_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401762))
...
(define-fun %t176 () (_ BitVec 64) a0x401762_rax)
; LLVM:     jump label %block_0_401762
(assert true)
(assert (= a0x401762_df false))
(assert (= %t176 a0x401762_rax))
(assert (= %t174 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t175 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401744_rbx fnstart_rbx))
