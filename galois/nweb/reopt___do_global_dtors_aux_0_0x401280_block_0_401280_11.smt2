; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.3 @ 0x40128b: precondition ((= cf af), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t2 #b1) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00 readv) #x10) #x00)) (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b000010000) #b000000000)) (not (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b000010000) #b000000000)))) false true))))))
(exit)
