; web.block_0_40185f.1 @ 0x401870: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x40185f_rbx fnstart_rbx))
(assert (= a0x40185f_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x40185f_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
