; web.block_0_4017ab.1 @ 0x4017b6: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x4017ab_rbx fnstart_rbx))
(assert (= a0x4017ab_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x4017ab_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
