; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: return address preserved (after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= readv (mem_readbv64 init_mem fnstart_rsp)))))
(exit)
