; web.block_0_401550.3 @ 0x401555: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t21 #b1)) (= a0x401550_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
