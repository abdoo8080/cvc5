; web.block_0_4017be.5 @ 0x4017d7: precondition ((= (llvm t257) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t209 #b1) (= %t204 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
