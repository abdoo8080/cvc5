; web.block_0_401582.0 @ 0x401582: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x401582_rax () (_ BitVec 64))
(declare-fun a0x401582_rcx () (_ BitVec 64))
(declare-fun a0x401582_rdx () (_ BitVec 64))
(declare-fun a0x401582_rbx () (_ BitVec 64))
(declare-fun a0x401582_rsp () (_ BitVec 64))
(declare-fun a0x401582_rbp () (_ BitVec 64))
(declare-fun a0x401582_rsi () (_ BitVec 64))
(declare-fun a0x401582_rdi () (_ BitVec 64))
(declare-fun a0x401582_r8 () (_ BitVec 64))
(declare-fun a0x401582_r9 () (_ BitVec 64))
(declare-fun a0x401582_r10 () (_ BitVec 64))
(declare-fun a0x401582_r11 () (_ BitVec 64))
(declare-fun a0x401582_r12 () (_ BitVec 64))
(declare-fun a0x401582_r13 () (_ BitVec 64))
(declare-fun a0x401582_r14 () (_ BitVec 64))
(declare-fun a0x401582_r15 () (_ BitVec 64))
(declare-fun a0x401582_cf () Bool)
(declare-fun a0x401582_RESERVED_1 () Bool)
(declare-fun a0x401582_pf () Bool)
(declare-fun a0x401582_RESERVED_3 () Bool)
(declare-fun a0x401582_af () Bool)
(declare-fun a0x401582_RESERVED_5 () Bool)
(declare-fun a0x401582_zf () Bool)
(declare-fun a0x401582_sf () Bool)
(declare-fun a0x401582_tf () Bool)
(declare-fun a0x401582_if () Bool)
(define-fun a0x401582_df () Bool false)
(declare-fun a0x401582_of () Bool)
(declare-fun a0x401582_iopl1 () Bool)
(declare-fun a0x401582_iopl2 () Bool)
(declare-fun a0x401582_nt () Bool)
(declare-fun a0x401582_RESERVED_15 () Bool)
(declare-fun a0x401582_rf () Bool)
(declare-fun a0x401582_vm () Bool)
(declare-fun a0x401582_ac () Bool)
(declare-fun a0x401582_vif () Bool)
(declare-fun a0x401582_vip () Bool)
(declare-fun a0x401582_id () Bool)
(declare-fun a0x401582_el () Bool)
(declare-fun a0x401582_el0 () Bool)
(declare-fun a0x401582_el1 () Bool)
(declare-fun a0x401582_el2 () Bool)
(declare-fun a0x401582_el3 () Bool)
(declare-fun a0x401582_el4 () Bool)
(declare-fun a0x401582_el5 () Bool)
(declare-fun a0x401582_el6 () Bool)
(declare-fun a0x401582_el7 () Bool)
(declare-fun a0x401582_el8 () Bool)
(declare-fun a0x401582_xmm0 () (_ BitVec 512))
(declare-fun a0x401582_xmm1 () (_ BitVec 512))
(declare-fun a0x401582_xmm2 () (_ BitVec 512))
(declare-fun a0x401582_xmm3 () (_ BitVec 512))
(declare-fun a0x401582_xmm4 () (_ BitVec 512))
(declare-fun a0x401582_xmm5 () (_ BitVec 512))
(declare-fun a0x401582_xmm6 () (_ BitVec 512))
(declare-fun a0x401582_xmm7 () (_ BitVec 512))
(declare-fun a0x401582_xmm8 () (_ BitVec 512))
(declare-fun a0x401582_xmm9 () (_ BitVec 512))
(declare-fun a0x401582_xmm10 () (_ BitVec 512))
(declare-fun a0x401582_xmm11 () (_ BitVec 512))
(declare-fun a0x401582_xmm12 () (_ BitVec 512))
(declare-fun a0x401582_xmm13 () (_ BitVec 512))
(declare-fun a0x401582_xmm14 () (_ BitVec 512))
(declare-fun a0x401582_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t39 () (_ BitVec 64))
(declare-fun %t40 () (_ BitVec 32))
(declare-fun %t41 () (_ BitVec 32))
(assert (= %t39 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t40 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t41 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401582_rbx fnstart_rbx))
(assert (= a0x401582_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401582_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401582_r12 fnstart_r12))
(assert (= a0x401582_r13 fnstart_r13))
(assert (= a0x401582_r14 fnstart_r14))
(assert (= a0x401582_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     jump label %block_0_40158a
(define-fun addr () (_ BitVec 64) (bvadd a0x401582_rbp #xffffffffffffffe0))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x0000000000000000))
(assert true)
(assert (= a0x401582_df false))
(assert (= %t39 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= #x0000000000000000 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t40 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t41 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401582_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x401582_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
