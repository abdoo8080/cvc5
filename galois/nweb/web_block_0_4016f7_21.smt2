; web.block_0_4016f7.7 @ 0x40170a: precondition ((= (llvm t171) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t163 #b1)) (= %t155 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))))
(exit)
