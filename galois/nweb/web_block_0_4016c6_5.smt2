; web.block_0_4016c6.0 @ 0x4016c6: precondition ((= (llvm t134) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t130 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
