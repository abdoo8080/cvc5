; web.block_0_401931.1 @ 0x401954: precondition ((= (llvm t302) (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t298 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))))
(exit)
