; web.block_0_401515.1 @ 0x40151e: precondition ((= (llvm t10) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t7 #b1)) (= %t6 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
