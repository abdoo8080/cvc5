; web.block_0_4016c6.0 @ 0x4016c6: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4016c6_rax () (_ BitVec 64))
(declare-fun a0x4016c6_rcx () (_ BitVec 64))
(declare-fun a0x4016c6_rdx () (_ BitVec 64))
(declare-fun a0x4016c6_rbx () (_ BitVec 64))
(declare-fun a0x4016c6_rsp () (_ BitVec 64))
(declare-fun a0x4016c6_rbp () (_ BitVec 64))
(declare-fun a0x4016c6_rsi () (_ BitVec 64))
(declare-fun a0x4016c6_rdi () (_ BitVec 64))
(declare-fun a0x4016c6_r8 () (_ BitVec 64))
(declare-fun a0x4016c6_r9 () (_ BitVec 64))
(declare-fun a0x4016c6_r10 () (_ BitVec 64))
(declare-fun a0x4016c6_r11 () (_ BitVec 64))
(declare-fun a0x4016c6_r12 () (_ BitVec 64))
(declare-fun a0x4016c6_r13 () (_ BitVec 64))
(declare-fun a0x4016c6_r14 () (_ BitVec 64))
(declare-fun a0x4016c6_r15 () (_ BitVec 64))
(declare-fun a0x4016c6_cf () Bool)
(declare-fun a0x4016c6_RESERVED_1 () Bool)
(declare-fun a0x4016c6_pf () Bool)
(declare-fun a0x4016c6_RESERVED_3 () Bool)
(declare-fun a0x4016c6_af () Bool)
(declare-fun a0x4016c6_RESERVED_5 () Bool)
(declare-fun a0x4016c6_zf () Bool)
(declare-fun a0x4016c6_sf () Bool)
(declare-fun a0x4016c6_tf () Bool)
(declare-fun a0x4016c6_if () Bool)
(define-fun a0x4016c6_df () Bool false)
(declare-fun a0x4016c6_of () Bool)
(declare-fun a0x4016c6_iopl1 () Bool)
(declare-fun a0x4016c6_iopl2 () Bool)
(declare-fun a0x4016c6_nt () Bool)
(declare-fun a0x4016c6_RESERVED_15 () Bool)
(declare-fun a0x4016c6_rf () Bool)
(declare-fun a0x4016c6_vm () Bool)
(declare-fun a0x4016c6_ac () Bool)
(declare-fun a0x4016c6_vif () Bool)
(declare-fun a0x4016c6_vip () Bool)
(declare-fun a0x4016c6_id () Bool)
(declare-fun a0x4016c6_el () Bool)
(declare-fun a0x4016c6_el0 () Bool)
(declare-fun a0x4016c6_el1 () Bool)
(declare-fun a0x4016c6_el2 () Bool)
(declare-fun a0x4016c6_el3 () Bool)
(declare-fun a0x4016c6_el4 () Bool)
(declare-fun a0x4016c6_el5 () Bool)
(declare-fun a0x4016c6_el6 () Bool)
(declare-fun a0x4016c6_el7 () Bool)
(declare-fun a0x4016c6_el8 () Bool)
(declare-fun a0x4016c6_xmm0 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm1 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm2 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm3 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm4 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm5 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm6 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm7 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm8 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm9 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm10 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm11 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm12 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm13 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm14 () (_ BitVec 512))
(declare-fun a0x4016c6_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t129 () (_ BitVec 64))
(declare-fun %t130 () (_ BitVec 32))
(declare-fun %t131 () (_ BitVec 32))
(assert (= %t129 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t130 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t131 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4016c6_rbx fnstart_rbx))
(assert (= a0x4016c6_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4016c6_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4016c6_r12 fnstart_r12))
(assert (= a0x4016c6_r13 fnstart_r13))
(assert (= a0x4016c6_r14 fnstart_r14))
(assert (= a0x4016c6_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     jump label %block_0_4016cd
(define-fun addr () (_ BitVec 64) (bvadd a0x4016c6_rbp #xfffffffffffffff4))
(assert (is_in_mc_only_stack_range addr #x0000000000000004))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 init_mem addr #x00000000))
(assert true)
(assert (= a0x4016c6_df false))
(assert (= %t129 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= #x00000000 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000014))))
(assert (= %t130 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t131 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4016c6_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x4016c6_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
