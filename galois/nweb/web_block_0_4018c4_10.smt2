; web.block_0_4018c4.2 @ 0x4018e4: precondition ((= (llvm t278) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t273 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))))
(exit)
