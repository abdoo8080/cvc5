; web.block_0_4019da.0 @ 0x4019da: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(declare-fun %t330 () (_ BitVec 32))
(declare-fun %t331 () (_ BitVec 32))
(assert (= %t330 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t331 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4019da_rbx fnstart_rbx))
(assert (= a0x4019da_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4019da_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4019da_r12 fnstart_r12))
(assert (= a0x4019da_r13 fnstart_r13))
(assert (= a0x4019da_r14 fnstart_r14))
(assert (= a0x4019da_r15 fnstart_r15))
