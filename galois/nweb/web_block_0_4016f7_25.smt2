; web.block_0_4016f7.7 @ 0x40170a: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t163 #b1)) (= a0x4016f7_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
