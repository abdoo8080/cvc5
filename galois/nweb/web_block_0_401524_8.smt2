; web.block_0_401524.1 @ 0x401529: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t11 #b1) (= a0x401524_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
