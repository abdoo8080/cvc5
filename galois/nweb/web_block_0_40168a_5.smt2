; web.block_0_40168a.5 @ 0x401699: precondition ((= (llvm t120) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t119 #b1) (= %t112 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
