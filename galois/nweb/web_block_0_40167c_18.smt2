; web.block_0_40167c.5 @ 0x401684: precondition ((= (llvm t114) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t111 #b1)) (= %t106 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
