; web.block_0_4017be.5 @ 0x4017d7: precondition ((= (llvm t212) (mcstack (bvsub stack_high (_ bv28 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t209 #b1)) (= %t202 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000001c)))))))
(exit)
