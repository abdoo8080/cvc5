; reopt___do_global_dtors_aux_0_0x401280.block_0_4012a0.0 @ 0x4012a0: machine code reads from unallocated stack space
(set-logic ALL)
...
(check-sat-assuming ((not (on_stack a0x4012a0_rsp #x0000000000000008))))
(exit)
