; web.block_0_4019b6.3 @ 0x4019be: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t324 #b1)) (= a0x4019b6_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
