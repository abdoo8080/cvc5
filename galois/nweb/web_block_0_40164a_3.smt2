; web.block_0_40164a.2 @ 0x40164d: precondition ((= (llvm t103) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t98 #b1) (= %t96 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
