; web.block_0_4019b6.3 @ 0x4019be: precondition ((= (llvm t326) (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t324 #b1)) (= %t320 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000018)))))))
(exit)
