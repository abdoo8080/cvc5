; web.block_0_40169f.3 @ 0x4016ab: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x40169f_rbx fnstart_rbx))
(assert (= a0x40169f_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x40169f_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
