; web.block_0_4017dd.5 @ 0x4017f5: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x4017dd_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
