; web.block_0_401653.2 @ 0x40166f: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x401653_rax () (_ BitVec 64))
(declare-fun a0x401653_rcx () (_ BitVec 64))
(declare-fun a0x401653_rdx () (_ BitVec 64))
(declare-fun a0x401653_rbx () (_ BitVec 64))
(declare-fun a0x401653_rsp () (_ BitVec 64))
(declare-fun a0x401653_rbp () (_ BitVec 64))
(declare-fun a0x401653_rsi () (_ BitVec 64))
(declare-fun a0x401653_rdi () (_ BitVec 64))
(declare-fun a0x401653_r8 () (_ BitVec 64))
(declare-fun a0x401653_r9 () (_ BitVec 64))
(declare-fun a0x401653_r10 () (_ BitVec 64))
(declare-fun a0x401653_r11 () (_ BitVec 64))
(declare-fun a0x401653_r12 () (_ BitVec 64))
(declare-fun a0x401653_r13 () (_ BitVec 64))
(declare-fun a0x401653_r14 () (_ BitVec 64))
(declare-fun a0x401653_r15 () (_ BitVec 64))
(declare-fun a0x401653_cf () Bool)
(declare-fun a0x401653_RESERVED_1 () Bool)
(declare-fun a0x401653_pf () Bool)
(declare-fun a0x401653_RESERVED_3 () Bool)
(declare-fun a0x401653_af () Bool)
(declare-fun a0x401653_RESERVED_5 () Bool)
(declare-fun a0x401653_zf () Bool)
(declare-fun a0x401653_sf () Bool)
(declare-fun a0x401653_tf () Bool)
(declare-fun a0x401653_if () Bool)
(define-fun a0x401653_df () Bool false)
(declare-fun a0x401653_of () Bool)
(declare-fun a0x401653_iopl1 () Bool)
(declare-fun a0x401653_iopl2 () Bool)
(declare-fun a0x401653_nt () Bool)
(declare-fun a0x401653_RESERVED_15 () Bool)
(declare-fun a0x401653_rf () Bool)
(declare-fun a0x401653_vm () Bool)
(declare-fun a0x401653_ac () Bool)
(declare-fun a0x401653_vif () Bool)
(declare-fun a0x401653_vip () Bool)
(declare-fun a0x401653_id () Bool)
(declare-fun a0x401653_el () Bool)
(declare-fun a0x401653_el0 () Bool)
(declare-fun a0x401653_el1 () Bool)
(declare-fun a0x401653_el2 () Bool)
(declare-fun a0x401653_el3 () Bool)
(declare-fun a0x401653_el4 () Bool)
(declare-fun a0x401653_el5 () Bool)
(declare-fun a0x401653_el6 () Bool)
(declare-fun a0x401653_el7 () Bool)
(declare-fun a0x401653_el8 () Bool)
(declare-fun a0x401653_xmm0 () (_ BitVec 512))
(declare-fun a0x401653_xmm1 () (_ BitVec 512))
(declare-fun a0x401653_xmm2 () (_ BitVec 512))
(declare-fun a0x401653_xmm3 () (_ BitVec 512))
(declare-fun a0x401653_xmm4 () (_ BitVec 512))
(declare-fun a0x401653_xmm5 () (_ BitVec 512))
(declare-fun a0x401653_xmm6 () (_ BitVec 512))
(declare-fun a0x401653_xmm7 () (_ BitVec 512))
(declare-fun a0x401653_xmm8 () (_ BitVec 512))
(declare-fun a0x401653_xmm9 () (_ BitVec 512))
(declare-fun a0x401653_xmm10 () (_ BitVec 512))
(declare-fun a0x401653_xmm11 () (_ BitVec 512))
(declare-fun a0x401653_xmm12 () (_ BitVec 512))
(declare-fun a0x401653_xmm13 () (_ BitVec 512))
(declare-fun a0x401653_xmm14 () (_ BitVec 512))
(declare-fun a0x401653_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t100 () (_ BitVec 32))
(declare-fun %t99 () (_ BitVec 32))
(assert (= %t99 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t100 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401653_rbx fnstart_rbx))
(assert (= a0x401653_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401653_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401653_r12 fnstart_r12))
(assert (= a0x401653_r13 fnstart_r13))
(assert (= a0x401653_r14 fnstart_r14))
(assert (= a0x401653_r15 fnstart_r15))
(assert (= a0x401653_cf a0x401653_af))
(assert (= a0x401653_cf a0x401653_df))
(assert (= a0x401653_cf a0x401653_of))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t101 = zext i32 %t100 to i64
(define-fun %t101 () (_ BitVec 64) ((_ zero_extend 32) %t100))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x401653_rbp #xfffffffffffffffc))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x401653_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x401653_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x0000000000401674))
(assert true)
(assert true)
(assert true)
(assert (= %t101 rcx))
(assert (not a0x401653_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401674))
(declare-fun a0x401674_xmm15 () (_ BitVec 512))
(declare-fun a0x401674_xmm14 () (_ BitVec 512))
(declare-fun a0x401674_xmm13 () (_ BitVec 512))
(declare-fun a0x401674_xmm12 () (_ BitVec 512))
(declare-fun a0x401674_xmm11 () (_ BitVec 512))
(declare-fun a0x401674_xmm10 () (_ BitVec 512))
(declare-fun a0x401674_xmm9 () (_ BitVec 512))
(declare-fun a0x401674_xmm8 () (_ BitVec 512))
(declare-fun a0x401674_xmm7 () (_ BitVec 512))
(declare-fun a0x401674_xmm6 () (_ BitVec 512))
(declare-fun a0x401674_xmm5 () (_ BitVec 512))
(declare-fun a0x401674_xmm4 () (_ BitVec 512))
(declare-fun a0x401674_xmm3 () (_ BitVec 512))
(declare-fun a0x401674_xmm2 () (_ BitVec 512))
(declare-fun a0x401674_xmm1 () (_ BitVec 512))
(declare-fun a0x401674_xmm0 () (_ BitVec 512))
(declare-fun a0x401674_el8 () Bool)
(declare-fun a0x401674_el7 () Bool)
(declare-fun a0x401674_el6 () Bool)
(declare-fun a0x401674_el5 () Bool)
(declare-fun a0x401674_el4 () Bool)
(declare-fun a0x401674_el3 () Bool)
(declare-fun a0x401674_el2 () Bool)
(declare-fun a0x401674_el1 () Bool)
(declare-fun a0x401674_el0 () Bool)
(declare-fun a0x401674_el () Bool)
(declare-fun a0x401674_id () Bool)
(declare-fun a0x401674_vip () Bool)
(declare-fun a0x401674_vif () Bool)
(declare-fun a0x401674_ac () Bool)
(declare-fun a0x401674_vm () Bool)
(declare-fun a0x401674_rf () Bool)
(declare-fun a0x401674_RESERVED_15 () Bool)
(declare-fun a0x401674_nt () Bool)
(declare-fun a0x401674_iopl2 () Bool)
(declare-fun a0x401674_iopl1 () Bool)
(declare-fun a0x401674_of () Bool)
(define-fun a0x401674_df () Bool false)
(declare-fun a0x401674_if () Bool)
(declare-fun a0x401674_tf () Bool)
(declare-fun a0x401674_sf () Bool)
(declare-fun a0x401674_zf () Bool)
(declare-fun a0x401674_RESERVED_5 () Bool)
(declare-fun a0x401674_af () Bool)
(declare-fun a0x401674_RESERVED_3 () Bool)
(declare-fun a0x401674_pf () Bool)
(declare-fun a0x401674_RESERVED_1 () Bool)
(declare-fun a0x401674_cf () Bool)
(declare-fun a0x401674_r15 () (_ BitVec 64))
(declare-fun a0x401674_r14 () (_ BitVec 64))
(declare-fun a0x401674_r13 () (_ BitVec 64))
(declare-fun a0x401674_r12 () (_ BitVec 64))
(declare-fun a0x401674_r11 () (_ BitVec 64))
(declare-fun a0x401674_r10 () (_ BitVec 64))
(declare-fun a0x401674_r9 () (_ BitVec 64))
(declare-fun a0x401674_r8 () (_ BitVec 64))
(declare-fun a0x401674_rdi () (_ BitVec 64))
(declare-fun a0x401674_rsi () (_ BitVec 64))
(declare-fun a0x401674_rbp () (_ BitVec 64))
(declare-fun a0x401674_rsp () (_ BitVec 64))
(declare-fun a0x401674_rbx () (_ BitVec 64))
(declare-fun a0x401674_rdx () (_ BitVec 64))
(declare-fun a0x401674_rcx () (_ BitVec 64))
(declare-fun a0x401674_rax () (_ BitVec 64))
...
; LLVM:     jump label %block_0_401674
(assert true)
(assert (= a0x401674_df false))
(assert (= %t99 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t100 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401653_rbx fnstart_rbx))
