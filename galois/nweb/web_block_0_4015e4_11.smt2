; web.block_0_4015e4.2 @ 0x401600: precondition ((= (llvm t84) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t81 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
