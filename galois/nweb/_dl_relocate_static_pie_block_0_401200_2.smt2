; _dl_relocate_static_pie.block_0_401200.0 @ 0x401204: return address preserved (after return)
(set-logic ALL)
...
(assert (on_stack fnstart_rsp #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem fnstart_rsp)))
(define-fun rsp () (_ BitVec 64) (bvadd fnstart_rsp #x0000000000000008))
