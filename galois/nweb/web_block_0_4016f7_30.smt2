; web.block_0_4016f7.7 @ 0x40170a: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(assert (=> (= %t163 #b1) (= %t155 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t163 #b1) (= %t156 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t163 #b1) (= a0x4016f7_rbx fnstart_rbx)))
(assert (=> (= %t163 #b1) (= a0x4016f7_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t163 #b1) (= a0x4016f7_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t163 #b1) (= a0x4016f7_r12 fnstart_r12)))
(assert (=> (= %t163 #b1) (= a0x4016f7_r13 fnstart_r13)))
(assert (=> (= %t163 #b1) (= a0x4016f7_r14 fnstart_r14)))
(assert (=> (= %t163 #b1) (= a0x4016f7_r15 fnstart_r15)))
(assert (=> (= %t163 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t163 #b1)) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111010010 (concat #b0 ((_ extract 31 0) rax2)))) #x00000000) false true) #x0000000000401731 #x0000000000401710) #x0000000000401731)))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_df false)))
(assert (=> (not (= %t163 #b1)) (= %t153 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))
(assert (=> (not (= %t163 #b1)) (= %t154 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014)))))
(assert (=> (not (= %t163 #b1)) (= %t155 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t163 #b1)) (= %t156 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_rbx fnstart_rbx)))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_r12 fnstart_r12)))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_r13 fnstart_r13)))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_r14 fnstart_r14)))
(assert (=> (not (= %t163 #b1)) (= a0x4016f7_r15 fnstart_r15)))
(check-sat-assuming ((not (=> (not (= %t163 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
