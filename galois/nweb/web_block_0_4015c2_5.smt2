; web.block_0_4015c2.3 @ 0x4015c6: precondition ((= (llvm t75) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t69 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))))
(exit)
