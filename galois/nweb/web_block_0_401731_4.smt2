; web.block_0_401731.1 @ 0x40173f: precondition ((= (llvm t132) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t169 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
