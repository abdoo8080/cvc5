; web.block_0_40190e.2 @ 0x40191a: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40190e_rax () (_ BitVec 64))
(declare-fun a0x40190e_rcx () (_ BitVec 64))
(declare-fun a0x40190e_rdx () (_ BitVec 64))
(declare-fun a0x40190e_rbx () (_ BitVec 64))
(declare-fun a0x40190e_rsp () (_ BitVec 64))
(declare-fun a0x40190e_rbp () (_ BitVec 64))
(declare-fun a0x40190e_rsi () (_ BitVec 64))
(declare-fun a0x40190e_rdi () (_ BitVec 64))
(declare-fun a0x40190e_r8 () (_ BitVec 64))
(declare-fun a0x40190e_r9 () (_ BitVec 64))
(declare-fun a0x40190e_r10 () (_ BitVec 64))
(declare-fun a0x40190e_r11 () (_ BitVec 64))
(declare-fun a0x40190e_r12 () (_ BitVec 64))
(declare-fun a0x40190e_r13 () (_ BitVec 64))
(declare-fun a0x40190e_r14 () (_ BitVec 64))
(declare-fun a0x40190e_r15 () (_ BitVec 64))
(declare-fun a0x40190e_cf () Bool)
(declare-fun a0x40190e_RESERVED_1 () Bool)
(declare-fun a0x40190e_pf () Bool)
(declare-fun a0x40190e_RESERVED_3 () Bool)
(declare-fun a0x40190e_af () Bool)
(declare-fun a0x40190e_RESERVED_5 () Bool)
(declare-fun a0x40190e_zf () Bool)
(declare-fun a0x40190e_sf () Bool)
(declare-fun a0x40190e_tf () Bool)
(declare-fun a0x40190e_if () Bool)
(define-fun a0x40190e_df () Bool false)
(declare-fun a0x40190e_of () Bool)
(declare-fun a0x40190e_iopl1 () Bool)
(declare-fun a0x40190e_iopl2 () Bool)
(declare-fun a0x40190e_nt () Bool)
(declare-fun a0x40190e_RESERVED_15 () Bool)
(declare-fun a0x40190e_rf () Bool)
(declare-fun a0x40190e_vm () Bool)
(declare-fun a0x40190e_ac () Bool)
(declare-fun a0x40190e_vif () Bool)
(declare-fun a0x40190e_vip () Bool)
(declare-fun a0x40190e_id () Bool)
(declare-fun a0x40190e_el () Bool)
(declare-fun a0x40190e_el0 () Bool)
(declare-fun a0x40190e_el1 () Bool)
(declare-fun a0x40190e_el2 () Bool)
(declare-fun a0x40190e_el3 () Bool)
(declare-fun a0x40190e_el4 () Bool)
(declare-fun a0x40190e_el5 () Bool)
(declare-fun a0x40190e_el6 () Bool)
(declare-fun a0x40190e_el7 () Bool)
(declare-fun a0x40190e_el8 () Bool)
(declare-fun a0x40190e_xmm0 () (_ BitVec 512))
(declare-fun a0x40190e_xmm1 () (_ BitVec 512))
(declare-fun a0x40190e_xmm2 () (_ BitVec 512))
(declare-fun a0x40190e_xmm3 () (_ BitVec 512))
(declare-fun a0x40190e_xmm4 () (_ BitVec 512))
(declare-fun a0x40190e_xmm5 () (_ BitVec 512))
(declare-fun a0x40190e_xmm6 () (_ BitVec 512))
(declare-fun a0x40190e_xmm7 () (_ BitVec 512))
(declare-fun a0x40190e_xmm8 () (_ BitVec 512))
(declare-fun a0x40190e_xmm9 () (_ BitVec 512))
(declare-fun a0x40190e_xmm10 () (_ BitVec 512))
(declare-fun a0x40190e_xmm11 () (_ BitVec 512))
(declare-fun a0x40190e_xmm12 () (_ BitVec 512))
(declare-fun a0x40190e_xmm13 () (_ BitVec 512))
(declare-fun a0x40190e_xmm14 () (_ BitVec 512))
(declare-fun a0x40190e_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t283 () (_ BitVec 64))
(declare-fun %t284 () (_ BitVec 32))
(declare-fun %t285 () (_ BitVec 32))
(declare-fun %t286 () (_ BitVec 32))
(assert (= %t283 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t284 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t285 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t286 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40190e_rbx fnstart_rbx))
(assert (= a0x40190e_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40190e_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40190e_r12 fnstart_r12))
(assert (= a0x40190e_r13 fnstart_r13))
(assert (= a0x40190e_r14 fnstart_r14))
(assert (= a0x40190e_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t287 = zext i32 %t284 to i64
(define-fun %t287 () (_ BitVec 64) ((_ zero_extend 32) %t284))
; LLVM:     %t288 = call i64 @lseek (i64 %t287,i64 0,i64 2)
(define-fun addr () (_ BitVec 64) (bvadd a0x40190e_rbp #xfffffffffffffff0))
...
(define-fun rax () (_ BitVec 64) ((_ zero_extend 32) (bvxor ((_ extract 31 0) a0x40190e_rax) ((_ extract 31 0) a0x40190e_rax))))
(define-fun rsi () (_ BitVec 64) ((_ zero_extend 32) ((_ extract 31 0) rax)))
(define-fun rsp () (_ BitVec 64) (bvsub a0x40190e_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x40190e_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x000000000040191f))
(assert (= %t287 rdi))
(assert (= #x0000000000000000 rsi))
(assert true)
(assert (not a0x40190e_df))
(assert (= (mem_readbv64 mem rsp) #x000000000040191f))
...
(define-fun %t288 () (_ BitVec 64) a0x40191f_rax)
; LLVM:     jump label %block_0_40191f
(assert true)
(assert (= a0x40191f_df false))
(assert (= %t288 a0x40191f_rax))
(assert (= %t283 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t284 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t285 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t286 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40190e_rbx fnstart_rbx))
