; reopt_deregister_tm_clones_0_0x401210.block_0_401230.0 @ 0x401230: register value preserved (rbp, after return)
(set-logic ALL)
...
(declare-fun a0x401230_rax () (_ BitVec 64))
(declare-fun a0x401230_rcx () (_ BitVec 64))
(declare-fun a0x401230_rdx () (_ BitVec 64))
(declare-fun a0x401230_rbx () (_ BitVec 64))
(declare-fun a0x401230_rsp () (_ BitVec 64))
(declare-fun a0x401230_rbp () (_ BitVec 64))
(declare-fun a0x401230_rsi () (_ BitVec 64))
(declare-fun a0x401230_rdi () (_ BitVec 64))
(declare-fun a0x401230_r8 () (_ BitVec 64))
(declare-fun a0x401230_r9 () (_ BitVec 64))
(declare-fun a0x401230_r10 () (_ BitVec 64))
(declare-fun a0x401230_r11 () (_ BitVec 64))
(declare-fun a0x401230_r12 () (_ BitVec 64))
(declare-fun a0x401230_r13 () (_ BitVec 64))
(declare-fun a0x401230_r14 () (_ BitVec 64))
(declare-fun a0x401230_r15 () (_ BitVec 64))
(declare-fun a0x401230_cf () Bool)
(declare-fun a0x401230_RESERVED_1 () Bool)
(declare-fun a0x401230_pf () Bool)
(declare-fun a0x401230_RESERVED_3 () Bool)
(declare-fun a0x401230_af () Bool)
(declare-fun a0x401230_RESERVED_5 () Bool)
(declare-fun a0x401230_zf () Bool)
(declare-fun a0x401230_sf () Bool)
(declare-fun a0x401230_tf () Bool)
(declare-fun a0x401230_if () Bool)
(define-fun a0x401230_df () Bool false)
(declare-fun a0x401230_of () Bool)
(declare-fun a0x401230_iopl1 () Bool)
(declare-fun a0x401230_iopl2 () Bool)
(declare-fun a0x401230_nt () Bool)
(declare-fun a0x401230_RESERVED_15 () Bool)
(declare-fun a0x401230_rf () Bool)
(declare-fun a0x401230_vm () Bool)
(declare-fun a0x401230_ac () Bool)
(declare-fun a0x401230_vif () Bool)
(declare-fun a0x401230_vip () Bool)
(declare-fun a0x401230_id () Bool)
(declare-fun a0x401230_el () Bool)
(declare-fun a0x401230_el0 () Bool)
(declare-fun a0x401230_el1 () Bool)
(declare-fun a0x401230_el2 () Bool)
(declare-fun a0x401230_el3 () Bool)
(declare-fun a0x401230_el4 () Bool)
(declare-fun a0x401230_el5 () Bool)
(declare-fun a0x401230_el6 () Bool)
(declare-fun a0x401230_el7 () Bool)
(declare-fun a0x401230_el8 () Bool)
(declare-fun a0x401230_xmm0 () (_ BitVec 512))
(declare-fun a0x401230_xmm1 () (_ BitVec 512))
(declare-fun a0x401230_xmm2 () (_ BitVec 512))
(declare-fun a0x401230_xmm3 () (_ BitVec 512))
(declare-fun a0x401230_xmm4 () (_ BitVec 512))
(declare-fun a0x401230_xmm5 () (_ BitVec 512))
(declare-fun a0x401230_xmm6 () (_ BitVec 512))
(declare-fun a0x401230_xmm7 () (_ BitVec 512))
(declare-fun a0x401230_xmm8 () (_ BitVec 512))
(declare-fun a0x401230_xmm9 () (_ BitVec 512))
(declare-fun a0x401230_xmm10 () (_ BitVec 512))
(declare-fun a0x401230_xmm11 () (_ BitVec 512))
(declare-fun a0x401230_xmm12 () (_ BitVec 512))
(declare-fun a0x401230_xmm13 () (_ BitVec 512))
(declare-fun a0x401230_xmm14 () (_ BitVec 512))
(declare-fun a0x401230_xmm15 () (_ BitVec 512))
(assert (= a0x401230_rbx fnstart_rbx))
(assert (= a0x401230_rsp fnstart_rsp))
(assert (= a0x401230_rbp fnstart_rbp))
(assert (= a0x401230_r12 fnstart_r12))
(assert (= a0x401230_r13 fnstart_r13))
(assert (= a0x401230_r14 fnstart_r14))
(assert (= a0x401230_r15 fnstart_r15))
(assert (= a0x401230_cf a0x401230_af))
(assert (= a0x401230_cf a0x401230_sf))
(assert (= a0x401230_cf a0x401230_df))
; LLVM:     ret void
(declare-fun readv () (_ BitVec 64))
(assert (on_stack a0x401230_rsp #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem a0x401230_rsp)))
(define-fun rsp () (_ BitVec 64) (bvadd a0x401230_rsp #x0000000000000008))
(assert (= rsp (bvadd fnstart_rsp #x0000000000000008)))
(assert (= readv (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x401230_df))
(check-sat-assuming ((not (= a0x401230_rbp fnstart_rbp))))
(exit)
