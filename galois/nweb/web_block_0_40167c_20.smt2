; web.block_0_40167c.5 @ 0x401684: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t111 #b1)) (= a0x40167c_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
