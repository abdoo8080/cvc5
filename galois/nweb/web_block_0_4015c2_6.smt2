; web.block_0_4015c2.3 @ 0x4015c6: precondition ((= (llvm t76) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(assert (= %t69 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(check-sat-assuming ((not (= %t70 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
