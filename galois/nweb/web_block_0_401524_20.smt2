; web.block_0_401524.1 @ 0x401529: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t11 #b1)) (= a0x401524_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
