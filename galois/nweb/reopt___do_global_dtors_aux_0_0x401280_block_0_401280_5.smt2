; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.3 @ 0x40128b: precondition ((= rsp stack_high), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t2 #b1) (= fnstart_rsp fnstart_rsp)))))
(exit)
