; web.block_0_401515.1 @ 0x40151e: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t7 #b1) (= a0x401515_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
