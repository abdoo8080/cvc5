; reopt_frame_dummy_0_0x4012b0.block_0_4012b0.1 @ 0x4012b4: return address preserved (after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= #x00000000004012b6 (mem_readbv64 init_mem fnstart_rsp)))))
(exit)
