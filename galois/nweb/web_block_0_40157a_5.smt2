; web.block_0_40157a.2 @ 0x40157a: precondition ((= (llvm t40) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(assert (= %t35 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(check-sat-assuming ((not (= %t36 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
