; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.3 @ 0x40128b: precondition ((= rbx (fnstart rbx)), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t2 #b1)) (= fnstart_rbx fnstart_rbx)))))
(exit)
