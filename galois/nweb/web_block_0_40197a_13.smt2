; web.block_0_40197a.1 @ 0x401985: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40197a_rax () (_ BitVec 64))
(declare-fun a0x40197a_rcx () (_ BitVec 64))
(declare-fun a0x40197a_rdx () (_ BitVec 64))
(declare-fun a0x40197a_rbx () (_ BitVec 64))
(declare-fun a0x40197a_rsp () (_ BitVec 64))
(declare-fun a0x40197a_rbp () (_ BitVec 64))
(declare-fun a0x40197a_rsi () (_ BitVec 64))
(declare-fun a0x40197a_rdi () (_ BitVec 64))
(declare-fun a0x40197a_r8 () (_ BitVec 64))
(declare-fun a0x40197a_r9 () (_ BitVec 64))
(declare-fun a0x40197a_r10 () (_ BitVec 64))
(declare-fun a0x40197a_r11 () (_ BitVec 64))
(declare-fun a0x40197a_r12 () (_ BitVec 64))
(declare-fun a0x40197a_r13 () (_ BitVec 64))
(declare-fun a0x40197a_r14 () (_ BitVec 64))
(declare-fun a0x40197a_r15 () (_ BitVec 64))
(declare-fun a0x40197a_cf () Bool)
(declare-fun a0x40197a_RESERVED_1 () Bool)
(declare-fun a0x40197a_pf () Bool)
(declare-fun a0x40197a_RESERVED_3 () Bool)
(declare-fun a0x40197a_af () Bool)
(declare-fun a0x40197a_RESERVED_5 () Bool)
(declare-fun a0x40197a_zf () Bool)
(declare-fun a0x40197a_sf () Bool)
(declare-fun a0x40197a_tf () Bool)
(declare-fun a0x40197a_if () Bool)
(define-fun a0x40197a_df () Bool false)
(declare-fun a0x40197a_of () Bool)
(declare-fun a0x40197a_iopl1 () Bool)
(declare-fun a0x40197a_iopl2 () Bool)
(declare-fun a0x40197a_nt () Bool)
(declare-fun a0x40197a_RESERVED_15 () Bool)
(declare-fun a0x40197a_rf () Bool)
(declare-fun a0x40197a_vm () Bool)
(declare-fun a0x40197a_ac () Bool)
(declare-fun a0x40197a_vif () Bool)
(declare-fun a0x40197a_vip () Bool)
(declare-fun a0x40197a_id () Bool)
(declare-fun a0x40197a_el () Bool)
(declare-fun a0x40197a_el0 () Bool)
(declare-fun a0x40197a_el1 () Bool)
(declare-fun a0x40197a_el2 () Bool)
(declare-fun a0x40197a_el3 () Bool)
(declare-fun a0x40197a_el4 () Bool)
(declare-fun a0x40197a_el5 () Bool)
(declare-fun a0x40197a_el6 () Bool)
(declare-fun a0x40197a_el7 () Bool)
(declare-fun a0x40197a_el8 () Bool)
(declare-fun a0x40197a_xmm0 () (_ BitVec 512))
(declare-fun a0x40197a_xmm1 () (_ BitVec 512))
(declare-fun a0x40197a_xmm2 () (_ BitVec 512))
(declare-fun a0x40197a_xmm3 () (_ BitVec 512))
(declare-fun a0x40197a_xmm4 () (_ BitVec 512))
(declare-fun a0x40197a_xmm5 () (_ BitVec 512))
(declare-fun a0x40197a_xmm6 () (_ BitVec 512))
(declare-fun a0x40197a_xmm7 () (_ BitVec 512))
(declare-fun a0x40197a_xmm8 () (_ BitVec 512))
(declare-fun a0x40197a_xmm9 () (_ BitVec 512))
(declare-fun a0x40197a_xmm10 () (_ BitVec 512))
(declare-fun a0x40197a_xmm11 () (_ BitVec 512))
(declare-fun a0x40197a_xmm12 () (_ BitVec 512))
(declare-fun a0x40197a_xmm13 () (_ BitVec 512))
(declare-fun a0x40197a_xmm14 () (_ BitVec 512))
(declare-fun a0x40197a_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t306 () (_ BitVec 32))
(declare-fun %t307 () (_ BitVec 32))
(assert (= %t306 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t307 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40197a_rbx fnstart_rbx))
(assert (= a0x40197a_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40197a_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40197a_r12 fnstart_r12))
(assert (= a0x40197a_r13 fnstart_r13))
(assert (= a0x40197a_r14 fnstart_r14))
(assert (= a0x40197a_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t308 = call i64 @strlen (i64 4211152)
(define-fun addr () (_ BitVec 64) (bvadd a0x40197a_rbp #xfffffffffffffffc))
...
(define-fun addr0 () (_ BitVec 64) (bvadd a0x40197a_rbp #xffffffffffffffc4))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000004))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 init_mem addr0 ((_ extract 31 0) rax)))
(define-fun rsp () (_ BitVec 64) (bvsub a0x40197a_rsp #x0000000000000008))
(define-fun addr1 () (_ BitVec 64) (bvsub a0x40197a_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr1 #x0000000000000008))
(define-fun mem0 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 mem addr1 #x000000000040198a))
(assert true)
(assert (not a0x40197a_df))
(assert (= (mem_readbv64 mem0 rsp) #x000000000040198a))
...
(define-fun %t308 () (_ BitVec 64) a0x40198a_rax)
; LLVM:     jump label %block_0_40198a
(assert true)
(assert (= a0x40198a_df false))
(assert (= %t308 a0x40198a_rax))
(assert (= %t307 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000044))))
(assert (= %t306 (mem_readbv32 mem1 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t307 (mem_readbv32 mem1 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40197a_rbx fnstart_rbx))
