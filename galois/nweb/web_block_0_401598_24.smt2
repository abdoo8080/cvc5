; web.block_0_401598.5 @ 0x4015a7: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t59 #b1)) (= a0x401598_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
