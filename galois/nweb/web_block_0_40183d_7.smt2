; web.block_0_40183d.4 @ 0x40185a: precondition ((= (llvm t256) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t243 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
