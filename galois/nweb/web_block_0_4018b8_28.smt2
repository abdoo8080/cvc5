; web.block_0_4018b8.2 @ 0x4018be: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun %t267 () (_ BitVec 64))
(declare-fun %t268 () (_ BitVec 64))
(declare-fun %t269 () (_ BitVec 32))
(declare-fun %t270 () (_ BitVec 32))
(assert (= %t267 a0x4018b8_rax))
(assert (= %t268 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t269 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t270 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4018b8_rbx fnstart_rbx))
(assert (= a0x4018b8_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4018b8_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4018b8_r12 fnstart_r12))
(assert (= a0x4018b8_r13 fnstart_r13))
(assert (= a0x4018b8_r14 fnstart_r14))
(assert (= a0x4018b8_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t271 = trunc i64 %t267 to i32
(define-fun %t271 () (_ BitVec 32) ((_ extract 31 0) %t267))
; LLVM:     %t272 = icmp eq i32 %t271, 4294967295
(define-fun %t272 () (_ BitVec 1) (ite (= %t271 #xffffffff) #b1 #b0))
; LLVM:     br i1 %t272, label %block_0_4018c4, label %block_0_4018e9
(define-fun addr () (_ BitVec 64) (bvadd a0x4018b8_rbp #xfffffffffffffff0))
(assert (is_in_mc_only_stack_range addr #x0000000000000004))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv32 init_mem addr ((_ extract 31 0) a0x4018b8_rax)))
(assert (=> (= %t272 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b000000000000000000000000000000001 (concat #b0 ((_ extract 31 0) a0x4018b8_rax)))) #x00000000) false true) #x00000000004018e9 #x00000000004018c4) #x00000000004018c4)))
(assert (=> (= %t272 #b1) (= a0x4018b8_df false)))
(assert (=> (= %t272 #b1) (= %t268 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000040)))))
(assert (=> (= %t272 #b1) (= %t271 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000018)))))
(assert (=> (= %t272 #b1) (= %t269 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t272 #b1) (= %t270 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t272 #b1) (= a0x4018b8_rbx fnstart_rbx)))
(assert (=> (= %t272 #b1) (= a0x4018b8_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t272 #b1) (= a0x4018b8_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t272 #b1) (= a0x4018b8_r12 fnstart_r12)))
(assert (=> (= %t272 #b1) (= a0x4018b8_r13 fnstart_r13)))
(assert (=> (= %t272 #b1) (= a0x4018b8_r14 fnstart_r14)))
(assert (=> (= %t272 #b1) (= a0x4018b8_r15 fnstart_r15)))
(assert (=> (= %t272 #b1) (= (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t272 #b1)) (= (ite (ite (= ((_ extract 31 0) (bvadd #b000000000000000000000000000000001 (concat #b0 ((_ extract 31 0) a0x4018b8_rax)))) #x00000000) false true) #x00000000004018e9 #x00000000004018c4) #x00000000004018e9)))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_df false)))
(assert (=> (not (= %t272 #b1)) (= %t268 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000040)))))
(assert (=> (not (= %t272 #b1)) (= %t271 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000018)))))
(assert (=> (not (= %t272 #b1)) (= %t269 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t272 #b1)) (= %t270 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_rbx fnstart_rbx)))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_r12 fnstart_r12)))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_r13 fnstart_r13)))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_r14 fnstart_r14)))
(assert (=> (not (= %t272 #b1)) (= a0x4018b8_r15 fnstart_r15)))
(check-sat-assuming ((not (=> (not (= %t272 #b1)) (= (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
