; web.block_0_4019b6.3 @ 0x4019be: precondition ((= (llvm t325) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t324 #b1)) (= %t319 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000030)))))))
(exit)
