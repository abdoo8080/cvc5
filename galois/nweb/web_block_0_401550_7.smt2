; web.block_0_401550.3 @ 0x401555: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t21 #b1) (= a0x401550_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
