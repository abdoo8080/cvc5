; web.block_0_401674.0 @ 0x401674: precondition ((= (llvm t104) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= #x0000000000000004 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
