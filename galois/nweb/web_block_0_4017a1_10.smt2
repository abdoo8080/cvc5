; web.block_0_4017a1.1 @ 0x4017a6: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t193 () (_ BitVec 32))
(declare-fun %t194 () (_ BitVec 32))
(assert (= %t193 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t194 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4017a1_rbx fnstart_rbx))
(assert (= a0x4017a1_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4017a1_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4017a1_r12 fnstart_r12))
(assert (= a0x4017a1_r13 fnstart_r13))
(assert (= a0x4017a1_r14 fnstart_r14))
(assert (= a0x4017a1_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t195 = call i64 @strlen (i64 4211152)
(define-fun rsp () (_ BitVec 64) (bvsub a0x4017a1_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x4017a1_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x00000000004017ab))
(assert true)
(assert (not a0x4017a1_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004017ab))
(declare-fun a0x4017ab_xmm15 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm14 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm13 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm12 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm11 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm10 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm9 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm8 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm7 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm6 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm5 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm4 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm3 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm2 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm1 () (_ BitVec 512))
(declare-fun a0x4017ab_xmm0 () (_ BitVec 512))
(declare-fun a0x4017ab_el8 () Bool)
(declare-fun a0x4017ab_el7 () Bool)
(declare-fun a0x4017ab_el6 () Bool)
(declare-fun a0x4017ab_el5 () Bool)
(declare-fun a0x4017ab_el4 () Bool)
(declare-fun a0x4017ab_el3 () Bool)
(declare-fun a0x4017ab_el2 () Bool)
(declare-fun a0x4017ab_el1 () Bool)
(declare-fun a0x4017ab_el0 () Bool)
(declare-fun a0x4017ab_el () Bool)
(declare-fun a0x4017ab_id () Bool)
(declare-fun a0x4017ab_vip () Bool)
(declare-fun a0x4017ab_vif () Bool)
(declare-fun a0x4017ab_ac () Bool)
(declare-fun a0x4017ab_vm () Bool)
(declare-fun a0x4017ab_rf () Bool)
(declare-fun a0x4017ab_RESERVED_15 () Bool)
(declare-fun a0x4017ab_nt () Bool)
(declare-fun a0x4017ab_iopl2 () Bool)
(declare-fun a0x4017ab_iopl1 () Bool)
(declare-fun a0x4017ab_of () Bool)
(define-fun a0x4017ab_df () Bool false)
(declare-fun a0x4017ab_if () Bool)
(declare-fun a0x4017ab_tf () Bool)
(declare-fun a0x4017ab_sf () Bool)
(declare-fun a0x4017ab_zf () Bool)
(declare-fun a0x4017ab_RESERVED_5 () Bool)
(declare-fun a0x4017ab_af () Bool)
(declare-fun a0x4017ab_RESERVED_3 () Bool)
(declare-fun a0x4017ab_pf () Bool)
(declare-fun a0x4017ab_RESERVED_1 () Bool)
(declare-fun a0x4017ab_cf () Bool)
(declare-fun a0x4017ab_r15 () (_ BitVec 64))
(declare-fun a0x4017ab_r14 () (_ BitVec 64))
(declare-fun a0x4017ab_r13 () (_ BitVec 64))
(declare-fun a0x4017ab_r12 () (_ BitVec 64))
(declare-fun a0x4017ab_r11 () (_ BitVec 64))
(declare-fun a0x4017ab_r10 () (_ BitVec 64))
(declare-fun a0x4017ab_r9 () (_ BitVec 64))
(declare-fun a0x4017ab_r8 () (_ BitVec 64))
(declare-fun a0x4017ab_rdi () (_ BitVec 64))
(declare-fun a0x4017ab_rsi () (_ BitVec 64))
(declare-fun a0x4017ab_rbp () (_ BitVec 64))
(declare-fun a0x4017ab_rsp () (_ BitVec 64))
(declare-fun a0x4017ab_rbx () (_ BitVec 64))
(declare-fun a0x4017ab_rdx () (_ BitVec 64))
(declare-fun a0x4017ab_rcx () (_ BitVec 64))
(declare-fun a0x4017ab_rax () (_ BitVec 64))
...
(define-fun %t195 () (_ BitVec 64) a0x4017ab_rax)
; LLVM:     jump label %block_0_4017ab
(assert true)
(assert (= a0x4017ab_df false))
(assert (= %t195 a0x4017ab_rax))
(assert (= %t193 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t194 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4017a1_rbx fnstart_rbx))
