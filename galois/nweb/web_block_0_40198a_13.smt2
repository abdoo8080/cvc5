; web.block_0_40198a.2 @ 0x40199a: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x40198a_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
