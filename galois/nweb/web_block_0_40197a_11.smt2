; web.block_0_40197a.1 @ 0x401985: precondition ((= (llvm t312) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t307 (mem_readbv32 mem1 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
