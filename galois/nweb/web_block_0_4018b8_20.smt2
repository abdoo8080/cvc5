; web.block_0_4018b8.2 @ 0x4018be: precondition ((= (llvm t281) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t272 #b1)) (= %t270 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
