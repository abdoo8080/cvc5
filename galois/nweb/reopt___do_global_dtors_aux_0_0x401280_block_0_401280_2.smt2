; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.3 @ 0x40128b: instruction pointer is expected value (true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t2 #b1) (= (ite (ite (= ((_ extract 7 0) (bvadd #b100000000 (concat #b0 readv))) #x00) false true) #x00000000004012a0 #x000000000040128d) #x000000000040128d)))))
(exit)
