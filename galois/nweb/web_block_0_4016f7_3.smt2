; web.block_0_4016f7.7 @ 0x40170a: instruction pointer is expected value (true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t163 #b1) (= (ite (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111010010 (concat #b0 ((_ extract 31 0) rax2)))) #x00000000) false true) #x0000000000401731 #x0000000000401710) #x0000000000401710)))))
(exit)
