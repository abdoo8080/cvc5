; web.block_0_401731.1 @ 0x40173f: precondition ((= (llvm t134) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t171 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
