; web.block_0_4016cd.7 @ 0x4016dc: precondition ((= (llvm t175) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t142 #b1) (= %t135 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
