; web.block_0_401710.2 @ 0x40172c: precondition ((= (llvm t169) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t164 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
