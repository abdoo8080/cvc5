; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: register value preserved (r12, after return)
(set-logic ALL)
...
(assert (= a0x401270_rbp fnstart_rbp))
(assert (= a0x401270_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x401270_r12 fnstart_r12))))
(exit)
