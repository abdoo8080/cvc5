; reopt_register_tm_clones_0_0x401240.block_0_401270.0 @ 0x401270: stack height preserved (after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= rsp (bvadd fnstart_rsp #x0000000000000008)))))
(exit)
