; web.block_0_401623.2 @ 0x401626: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t90 #b1)) (= a0x401623_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
