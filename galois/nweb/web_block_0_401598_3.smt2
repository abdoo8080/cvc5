; web.block_0_401598.5 @ 0x4015a7: instruction pointer is expected value (true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t59 #b1) (= (ite (= ((_ extract 31 0) (bvadd #b011111111111111111111111111110011 (concat #b0 ((_ extract 31 0) rax)))) #x00000000) #x00000000004015c2 #x00000000004015ad) #x00000000004015c2)))))
(exit)
