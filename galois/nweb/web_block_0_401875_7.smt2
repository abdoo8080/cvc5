; web.block_0_401875.1 @ 0x40187a: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t258 #b1) (= a0x401875_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
