; web.block_0_4017be.5 @ 0x4017d7: precondition ((= (llvm t255) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t209 #b1) (= %t200 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040)))))))
(exit)
