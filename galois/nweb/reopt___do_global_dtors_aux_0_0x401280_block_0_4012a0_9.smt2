; reopt___do_global_dtors_aux_0_0x401280.block_0_4012a0.0 @ 0x4012a0: register value preserved (r15, after return)
(set-logic ALL)
...
(assert (= a0x4012a0_r13 fnstart_r13))
(assert (= a0x4012a0_r14 fnstart_r14))
(check-sat-assuming ((not (= a0x4012a0_r15 fnstart_r15))))
(exit)
