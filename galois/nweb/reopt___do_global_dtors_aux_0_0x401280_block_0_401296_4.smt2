; reopt___do_global_dtors_aux_0_0x401280.block_0_401296.2 @ 0x40129e: stack height preserved (after return)
(set-logic ALL)
...
(check-sat-assuming ((not (= rsp0 (bvadd fnstart_rsp #x0000000000000008)))))
(exit)
