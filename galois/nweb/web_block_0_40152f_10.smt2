; web.block_0_40152f.2 @ 0x40154b: precondition ((= (llvm t16) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t12 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000030))))))
(exit)
