; web.block_0_4016cd.7 @ 0x4016dc: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t142 #b1)) (= a0x4016cd_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
