; web.block_0_401834.2 @ 0x401837: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t241 #b1)) (= a0x401834_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
