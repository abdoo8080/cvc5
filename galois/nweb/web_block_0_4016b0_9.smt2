; web.block_0_4016b0.1 @ 0x4016c1: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x4016b0_rbx fnstart_rbx))
(assert (= a0x4016b0_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x4016b0_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
