; web.block_0_4017be.5 @ 0x4017d7: precondition ((= (llvm t211) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t209 #b1)) (= %t201 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
