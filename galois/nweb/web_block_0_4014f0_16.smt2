; web.block_0_4014f0.4 @ 0x401510: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(assert (= fnstart_rbx fnstart_rbx))
(check-sat-assuming ((not (= (bvadd rsp1 #x0000000000000008) (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
