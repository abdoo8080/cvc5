; web.block_0_4019df.1 @ 0x4019e4: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x4019df_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
