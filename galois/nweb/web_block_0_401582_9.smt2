; web.block_0_401582.0 @ 0x401582: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x401582_rbx fnstart_rbx))
(assert (= a0x401582_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x401582_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
