; web.block_0_4015c2.3 @ 0x4015c6: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x4015c2_rbx fnstart_rbx))
(assert (= a0x4015c2_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x4015c2_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
