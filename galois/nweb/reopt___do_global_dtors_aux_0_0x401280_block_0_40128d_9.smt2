; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.1 @ 0x401291: precondition ((= r12 (fnstart r12)), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x40128d_r12 fnstart_r12))))
(exit)
