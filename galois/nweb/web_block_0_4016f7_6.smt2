; web.block_0_4016f7.7 @ 0x40170a: precondition ((= (llvm t165) (mcstack (bvsub stack_high (_ bv20 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t163 #b1) (= %t154 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014)))))))
(exit)
