; web.block_0_401598.5 @ 0x4015a7: precondition ((= (llvm t61) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t59 #b1)) (= %t52 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
