; web.block_0_40168a.5 @ 0x401699: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t119 #b1)) (= a0x40168a_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
