; web.block_0_4015ce.1 @ 0x4015df: precondition ((= (llvm t44) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t77 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
