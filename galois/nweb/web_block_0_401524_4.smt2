; web.block_0_401524.1 @ 0x401529: precondition ((= (llvm t13) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t11 #b1) (= %t9 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))))
(exit)
