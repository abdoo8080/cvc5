; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.3 @ 0x40128b: precondition ((= cf of), for false branch)
(set-logic ALL)
...
; LLVM:     %t0 = inttoptr i64 4211136 to i8*
(define-fun %t0 () (_ BitVec 64) #x00000000004041c0)
; LLVM:     %t1 = load i8* %t0, align 0
(declare-fun readv () (_ BitVec 8))
(assert (= #x00000000004041c0 %t0))
(assert (not_in_stack_range #x00000000004041c0 #x0000000000000008))
(assert (= readv (mem_readbv8 init_mem #x00000000004041c0)))
(define-fun %t1 () (_ BitVec 8) (mem_readbv8 init_mem #x00000000004041c0))
; LLVM:     %t2 = icmp eq i8 %t1, 0
(define-fun %t2 () (_ BitVec 1) (ite (= %t1 #x00) #b1 #b0))
; LLVM:     br i1 %t2, label %block_0_40128d, label %block_0_4012a0
(assert (=> (= %t2 #b1) (= (ite (ite (= ((_ extract 7 0) (bvadd #b100000000 (concat #b0 readv))) #x00) false true) #x00000000004012a0 #x000000000040128d) #x000000000040128d)))
(assert (=> (= %t2 #b1) (= fnstart_df false)))
(assert (=> (= %t2 #b1) (= fnstart_rbx fnstart_rbx)))
(assert (=> (= %t2 #b1) (= fnstart_rsp fnstart_rsp)))
(assert (=> (= %t2 #b1) (= fnstart_rbp fnstart_rbp)))
(assert (=> (= %t2 #b1) (= fnstart_r12 fnstart_r12)))
(assert (=> (= %t2 #b1) (= fnstart_r13 fnstart_r13)))
(assert (=> (= %t2 #b1) (= fnstart_r14 fnstart_r14)))
(assert (=> (= %t2 #b1) (= fnstart_r15 fnstart_r15)))
(assert (=> (= %t2 #b1) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00 readv) #x10) #x00)) (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b000010000) #b000000000)) (not (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b000010000) #b000000000)))) false true))))
(assert (=> (= %t2 #b1) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) fnstart_df)))
(assert (=> (= %t2 #b1) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) (and (not (= (bvand readv #x80) #x00)) (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b010000000) #b000000000)) false true)))))
(assert (=> (not (= %t2 #b1)) (= (ite (ite (= ((_ extract 7 0) (bvadd #b100000000 (concat #b0 readv))) #x00) false true) #x00000000004012a0 #x000000000040128d) #x00000000004012a0)))
(assert (=> (not (= %t2 #b1)) (= fnstart_df false)))
(assert (=> (not (= %t2 #b1)) (= fnstart_rbx fnstart_rbx)))
(assert (=> (not (= %t2 #b1)) (= fnstart_rsp fnstart_rsp)))
(assert (=> (not (= %t2 #b1)) (= fnstart_rbp fnstart_rbp)))
(assert (=> (not (= %t2 #b1)) (= fnstart_r12 fnstart_r12)))
(assert (=> (not (= %t2 #b1)) (= fnstart_r13 fnstart_r13)))
(assert (=> (not (= %t2 #b1)) (= fnstart_r14 fnstart_r14)))
(assert (=> (not (= %t2 #b1)) (= fnstart_r15 fnstart_r15)))
(assert (=> (not (= %t2 #b1)) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00 readv) #x10) #x00)) (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b000010000) #b000000000)) (not (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b000010000) #b000000000)))) false true))))
(assert (=> (not (= %t2 #b1)) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) fnstart_df)))
(check-sat-assuming ((not (=> (not (= %t2 #b1)) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) (and (not (= (bvand readv #x80) #x00)) (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b010000000) #b000000000)) false true)))))))
(exit)
