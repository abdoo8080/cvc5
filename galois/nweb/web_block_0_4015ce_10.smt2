; web.block_0_4015ce.1 @ 0x4015df: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x4015ce_rbx fnstart_rbx))
(assert (= a0x4015ce_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x4015ce_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
