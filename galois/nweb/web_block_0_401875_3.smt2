; web.block_0_401875.1 @ 0x40187a: precondition ((= (llvm t259) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t258 #b1) (= %t255 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040)))))))
(exit)
