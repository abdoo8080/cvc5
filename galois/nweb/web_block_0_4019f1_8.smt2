; web.block_0_4019f1.1 @ 0x4019f6: register value preserved (rbx, after return)
(set-logic ALL)
...
(assert (= a0x4019f1_rbx fnstart_rbx))
(assert (= a0x4019f1_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4019f1_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4019f1_r12 fnstart_r12))
(assert (= a0x4019f1_r13 fnstart_r13))
(assert (= a0x4019f1_r14 fnstart_r14))
(assert (= a0x4019f1_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     call void
(define-fun rsp () (_ BitVec 64) (bvsub a0x4019f1_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x4019f1_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x00000000004019fb))
(assert true)
(assert (not a0x4019f1_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004019fb))
(declare-fun a0x4019fb_xmm15 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm14 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm13 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm12 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm11 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm10 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm9 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm8 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm7 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm6 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm5 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm4 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm3 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm2 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm1 () (_ BitVec 512))
(declare-fun a0x4019fb_xmm0 () (_ BitVec 512))
(declare-fun a0x4019fb_el8 () Bool)
(declare-fun a0x4019fb_el7 () Bool)
(declare-fun a0x4019fb_el6 () Bool)
(declare-fun a0x4019fb_el5 () Bool)
(declare-fun a0x4019fb_el4 () Bool)
(declare-fun a0x4019fb_el3 () Bool)
(declare-fun a0x4019fb_el2 () Bool)
(declare-fun a0x4019fb_el1 () Bool)
(declare-fun a0x4019fb_el0 () Bool)
(declare-fun a0x4019fb_el () Bool)
(declare-fun a0x4019fb_id () Bool)
(declare-fun a0x4019fb_vip () Bool)
(declare-fun a0x4019fb_vif () Bool)
(declare-fun a0x4019fb_ac () Bool)
(declare-fun a0x4019fb_vm () Bool)
(declare-fun a0x4019fb_rf () Bool)
(declare-fun a0x4019fb_RESERVED_15 () Bool)
(declare-fun a0x4019fb_nt () Bool)
(declare-fun a0x4019fb_iopl2 () Bool)
(declare-fun a0x4019fb_iopl1 () Bool)
(declare-fun a0x4019fb_of () Bool)
(define-fun a0x4019fb_df () Bool false)
(declare-fun a0x4019fb_if () Bool)
(declare-fun a0x4019fb_tf () Bool)
(declare-fun a0x4019fb_sf () Bool)
(declare-fun a0x4019fb_zf () Bool)
(declare-fun a0x4019fb_RESERVED_5 () Bool)
(declare-fun a0x4019fb_af () Bool)
(declare-fun a0x4019fb_RESERVED_3 () Bool)
(declare-fun a0x4019fb_pf () Bool)
(declare-fun a0x4019fb_RESERVED_1 () Bool)
(declare-fun a0x4019fb_cf () Bool)
(declare-fun a0x4019fb_r15 () (_ BitVec 64))
(declare-fun a0x4019fb_r14 () (_ BitVec 64))
(declare-fun a0x4019fb_r13 () (_ BitVec 64))
(declare-fun a0x4019fb_r12 () (_ BitVec 64))
(declare-fun a0x4019fb_r11 () (_ BitVec 64))
(declare-fun a0x4019fb_r10 () (_ BitVec 64))
(declare-fun a0x4019fb_r9 () (_ BitVec 64))
(declare-fun a0x4019fb_r8 () (_ BitVec 64))
(declare-fun a0x4019fb_rdi () (_ BitVec 64))
(declare-fun a0x4019fb_rsi () (_ BitVec 64))
(declare-fun a0x4019fb_rbp () (_ BitVec 64))
(declare-fun a0x4019fb_rsp () (_ BitVec 64))
(declare-fun a0x4019fb_rbx () (_ BitVec 64))
(declare-fun a0x4019fb_rdx () (_ BitVec 64))
(declare-fun a0x4019fb_rcx () (_ BitVec 64))
(declare-fun a0x4019fb_rax () (_ BitVec 64))
...
; LLVM:     ret void
(assert (= (bvadd rsp #x0000000000000008) (bvadd fnstart_rsp #x0000000000000008)))
(assert (= #x00000000004019fb (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x4019fb_df))
(assert (= a0x4019f1_rbp fnstart_rbp))
(check-sat-assuming ((not (= a0x4019f1_rbx fnstart_rbx))))
(exit)
