; web.block_0_40198a.2 @ 0x40199a: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40198a_rax () (_ BitVec 64))
(declare-fun a0x40198a_rcx () (_ BitVec 64))
(declare-fun a0x40198a_rdx () (_ BitVec 64))
(declare-fun a0x40198a_rbx () (_ BitVec 64))
(declare-fun a0x40198a_rsp () (_ BitVec 64))
(declare-fun a0x40198a_rbp () (_ BitVec 64))
(declare-fun a0x40198a_rsi () (_ BitVec 64))
(declare-fun a0x40198a_rdi () (_ BitVec 64))
(declare-fun a0x40198a_r8 () (_ BitVec 64))
(declare-fun a0x40198a_r9 () (_ BitVec 64))
(declare-fun a0x40198a_r10 () (_ BitVec 64))
(declare-fun a0x40198a_r11 () (_ BitVec 64))
(declare-fun a0x40198a_r12 () (_ BitVec 64))
(declare-fun a0x40198a_r13 () (_ BitVec 64))
(declare-fun a0x40198a_r14 () (_ BitVec 64))
(declare-fun a0x40198a_r15 () (_ BitVec 64))
(declare-fun a0x40198a_cf () Bool)
(declare-fun a0x40198a_RESERVED_1 () Bool)
(declare-fun a0x40198a_pf () Bool)
(declare-fun a0x40198a_RESERVED_3 () Bool)
(declare-fun a0x40198a_af () Bool)
(declare-fun a0x40198a_RESERVED_5 () Bool)
(declare-fun a0x40198a_zf () Bool)
(declare-fun a0x40198a_sf () Bool)
(declare-fun a0x40198a_tf () Bool)
(declare-fun a0x40198a_if () Bool)
(define-fun a0x40198a_df () Bool false)
(declare-fun a0x40198a_of () Bool)
(declare-fun a0x40198a_iopl1 () Bool)
(declare-fun a0x40198a_iopl2 () Bool)
(declare-fun a0x40198a_nt () Bool)
(declare-fun a0x40198a_RESERVED_15 () Bool)
(declare-fun a0x40198a_rf () Bool)
(declare-fun a0x40198a_vm () Bool)
(declare-fun a0x40198a_ac () Bool)
(declare-fun a0x40198a_vif () Bool)
(declare-fun a0x40198a_vip () Bool)
(declare-fun a0x40198a_id () Bool)
(declare-fun a0x40198a_el () Bool)
(declare-fun a0x40198a_el0 () Bool)
(declare-fun a0x40198a_el1 () Bool)
(declare-fun a0x40198a_el2 () Bool)
(declare-fun a0x40198a_el3 () Bool)
(declare-fun a0x40198a_el4 () Bool)
(declare-fun a0x40198a_el5 () Bool)
(declare-fun a0x40198a_el6 () Bool)
(declare-fun a0x40198a_el7 () Bool)
(declare-fun a0x40198a_el8 () Bool)
(declare-fun a0x40198a_xmm0 () (_ BitVec 512))
(declare-fun a0x40198a_xmm1 () (_ BitVec 512))
(declare-fun a0x40198a_xmm2 () (_ BitVec 512))
(declare-fun a0x40198a_xmm3 () (_ BitVec 512))
(declare-fun a0x40198a_xmm4 () (_ BitVec 512))
(declare-fun a0x40198a_xmm5 () (_ BitVec 512))
(declare-fun a0x40198a_xmm6 () (_ BitVec 512))
(declare-fun a0x40198a_xmm7 () (_ BitVec 512))
(declare-fun a0x40198a_xmm8 () (_ BitVec 512))
(declare-fun a0x40198a_xmm9 () (_ BitVec 512))
(declare-fun a0x40198a_xmm10 () (_ BitVec 512))
(declare-fun a0x40198a_xmm11 () (_ BitVec 512))
(declare-fun a0x40198a_xmm12 () (_ BitVec 512))
(declare-fun a0x40198a_xmm13 () (_ BitVec 512))
(declare-fun a0x40198a_xmm14 () (_ BitVec 512))
(declare-fun a0x40198a_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t309 () (_ BitVec 64))
(declare-fun %t310 () (_ BitVec 32))
(declare-fun %t311 () (_ BitVec 32))
(declare-fun %t312 () (_ BitVec 32))
(assert (= %t309 a0x40198a_rax))
(assert (= %t310 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000044))))
(assert (= %t311 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t312 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40198a_rbx fnstart_rbx))
(assert (= a0x40198a_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40198a_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40198a_r12 fnstart_r12))
(assert (= a0x40198a_r13 fnstart_r13))
(assert (= a0x40198a_r14 fnstart_r14))
(assert (= a0x40198a_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t313 = zext i32 %t310 to i64
(define-fun %t313 () (_ BitVec 64) ((_ zero_extend 32) %t310))
; LLVM:     %t314 = call i64 @write (i64 %t313,i64 4211152,i64 %t309)
(define-fun addr () (_ BitVec 64) (bvadd a0x40198a_rbp #xffffffffffffffc4))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x40198a_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x40198a_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x000000000040199f))
(assert (= %t313 rdi))
(assert true)
(assert (= %t309 a0x40198a_rax))
(assert (not a0x40198a_df))
(assert (= (mem_readbv64 mem rsp) #x000000000040199f))
(declare-fun a0x40199f_xmm15 () (_ BitVec 512))
(declare-fun a0x40199f_xmm14 () (_ BitVec 512))
(declare-fun a0x40199f_xmm13 () (_ BitVec 512))
(declare-fun a0x40199f_xmm12 () (_ BitVec 512))
(declare-fun a0x40199f_xmm11 () (_ BitVec 512))
(declare-fun a0x40199f_xmm10 () (_ BitVec 512))
(declare-fun a0x40199f_xmm9 () (_ BitVec 512))
(declare-fun a0x40199f_xmm8 () (_ BitVec 512))
(declare-fun a0x40199f_xmm7 () (_ BitVec 512))
(declare-fun a0x40199f_xmm6 () (_ BitVec 512))
(declare-fun a0x40199f_xmm5 () (_ BitVec 512))
(declare-fun a0x40199f_xmm4 () (_ BitVec 512))
(declare-fun a0x40199f_xmm3 () (_ BitVec 512))
(declare-fun a0x40199f_xmm2 () (_ BitVec 512))
(declare-fun a0x40199f_xmm1 () (_ BitVec 512))
(declare-fun a0x40199f_xmm0 () (_ BitVec 512))
(declare-fun a0x40199f_el8 () Bool)
(declare-fun a0x40199f_el7 () Bool)
(declare-fun a0x40199f_el6 () Bool)
(declare-fun a0x40199f_el5 () Bool)
(declare-fun a0x40199f_el4 () Bool)
(declare-fun a0x40199f_el3 () Bool)
(declare-fun a0x40199f_el2 () Bool)
(declare-fun a0x40199f_el1 () Bool)
(declare-fun a0x40199f_el0 () Bool)
(declare-fun a0x40199f_el () Bool)
(declare-fun a0x40199f_id () Bool)
(declare-fun a0x40199f_vip () Bool)
(declare-fun a0x40199f_vif () Bool)
(declare-fun a0x40199f_ac () Bool)
(declare-fun a0x40199f_vm () Bool)
(declare-fun a0x40199f_rf () Bool)
(declare-fun a0x40199f_RESERVED_15 () Bool)
(declare-fun a0x40199f_nt () Bool)
(declare-fun a0x40199f_iopl2 () Bool)
(declare-fun a0x40199f_iopl1 () Bool)
(declare-fun a0x40199f_of () Bool)
(define-fun a0x40199f_df () Bool false)
(declare-fun a0x40199f_if () Bool)
(declare-fun a0x40199f_tf () Bool)
(declare-fun a0x40199f_sf () Bool)
(declare-fun a0x40199f_zf () Bool)
(declare-fun a0x40199f_RESERVED_5 () Bool)
(declare-fun a0x40199f_af () Bool)
(declare-fun a0x40199f_RESERVED_3 () Bool)
(declare-fun a0x40199f_pf () Bool)
(declare-fun a0x40199f_RESERVED_1 () Bool)
(declare-fun a0x40199f_cf () Bool)
(declare-fun a0x40199f_r15 () (_ BitVec 64))
(declare-fun a0x40199f_r14 () (_ BitVec 64))
(declare-fun a0x40199f_r13 () (_ BitVec 64))
(declare-fun a0x40199f_r12 () (_ BitVec 64))
(declare-fun a0x40199f_r11 () (_ BitVec 64))
(declare-fun a0x40199f_r10 () (_ BitVec 64))
(declare-fun a0x40199f_r9 () (_ BitVec 64))
(declare-fun a0x40199f_r8 () (_ BitVec 64))
(declare-fun a0x40199f_rdi () (_ BitVec 64))
(declare-fun a0x40199f_rsi () (_ BitVec 64))
(declare-fun a0x40199f_rbp () (_ BitVec 64))
(declare-fun a0x40199f_rsp () (_ BitVec 64))
(declare-fun a0x40199f_rbx () (_ BitVec 64))
(declare-fun a0x40199f_rdx () (_ BitVec 64))
(declare-fun a0x40199f_rcx () (_ BitVec 64))
(declare-fun a0x40199f_rax () (_ BitVec 64))
...
(define-fun %t314 () (_ BitVec 64) a0x40199f_rax)
; LLVM:     jump label %block_0_40199f
(assert true)
(assert (= a0x40199f_df false))
(assert (= %t311 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t312 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40198a_rbx fnstart_rbx))
