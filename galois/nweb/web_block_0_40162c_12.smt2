; web.block_0_40162c.1 @ 0x401645: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40162c_rax () (_ BitVec 64))
(declare-fun a0x40162c_rcx () (_ BitVec 64))
(declare-fun a0x40162c_rdx () (_ BitVec 64))
(declare-fun a0x40162c_rbx () (_ BitVec 64))
(declare-fun a0x40162c_rsp () (_ BitVec 64))
(declare-fun a0x40162c_rbp () (_ BitVec 64))
(declare-fun a0x40162c_rsi () (_ BitVec 64))
(declare-fun a0x40162c_rdi () (_ BitVec 64))
(declare-fun a0x40162c_r8 () (_ BitVec 64))
(declare-fun a0x40162c_r9 () (_ BitVec 64))
(declare-fun a0x40162c_r10 () (_ BitVec 64))
(declare-fun a0x40162c_r11 () (_ BitVec 64))
(declare-fun a0x40162c_r12 () (_ BitVec 64))
(declare-fun a0x40162c_r13 () (_ BitVec 64))
(declare-fun a0x40162c_r14 () (_ BitVec 64))
(declare-fun a0x40162c_r15 () (_ BitVec 64))
(declare-fun a0x40162c_cf () Bool)
(declare-fun a0x40162c_RESERVED_1 () Bool)
(declare-fun a0x40162c_pf () Bool)
(declare-fun a0x40162c_RESERVED_3 () Bool)
(declare-fun a0x40162c_af () Bool)
(declare-fun a0x40162c_RESERVED_5 () Bool)
(declare-fun a0x40162c_zf () Bool)
(declare-fun a0x40162c_sf () Bool)
(declare-fun a0x40162c_tf () Bool)
(declare-fun a0x40162c_if () Bool)
(define-fun a0x40162c_df () Bool false)
(declare-fun a0x40162c_of () Bool)
(declare-fun a0x40162c_iopl1 () Bool)
(declare-fun a0x40162c_iopl2 () Bool)
(declare-fun a0x40162c_nt () Bool)
(declare-fun a0x40162c_RESERVED_15 () Bool)
(declare-fun a0x40162c_rf () Bool)
(declare-fun a0x40162c_vm () Bool)
(declare-fun a0x40162c_ac () Bool)
(declare-fun a0x40162c_vif () Bool)
(declare-fun a0x40162c_vip () Bool)
(declare-fun a0x40162c_id () Bool)
(declare-fun a0x40162c_el () Bool)
(declare-fun a0x40162c_el0 () Bool)
(declare-fun a0x40162c_el1 () Bool)
(declare-fun a0x40162c_el2 () Bool)
(declare-fun a0x40162c_el3 () Bool)
(declare-fun a0x40162c_el4 () Bool)
(declare-fun a0x40162c_el5 () Bool)
(declare-fun a0x40162c_el6 () Bool)
(declare-fun a0x40162c_el7 () Bool)
(declare-fun a0x40162c_el8 () Bool)
(declare-fun a0x40162c_xmm0 () (_ BitVec 512))
(declare-fun a0x40162c_xmm1 () (_ BitVec 512))
(declare-fun a0x40162c_xmm2 () (_ BitVec 512))
(declare-fun a0x40162c_xmm3 () (_ BitVec 512))
(declare-fun a0x40162c_xmm4 () (_ BitVec 512))
(declare-fun a0x40162c_xmm5 () (_ BitVec 512))
(declare-fun a0x40162c_xmm6 () (_ BitVec 512))
(declare-fun a0x40162c_xmm7 () (_ BitVec 512))
(declare-fun a0x40162c_xmm8 () (_ BitVec 512))
(declare-fun a0x40162c_xmm9 () (_ BitVec 512))
(declare-fun a0x40162c_xmm10 () (_ BitVec 512))
(declare-fun a0x40162c_xmm11 () (_ BitVec 512))
(declare-fun a0x40162c_xmm12 () (_ BitVec 512))
(declare-fun a0x40162c_xmm13 () (_ BitVec 512))
(declare-fun a0x40162c_xmm14 () (_ BitVec 512))
(declare-fun a0x40162c_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t91 () (_ BitVec 32))
(declare-fun %t92 () (_ BitVec 32))
(assert (= %t91 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t92 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40162c_rbx fnstart_rbx))
(assert (= a0x40162c_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40162c_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40162c_r12 fnstart_r12))
(assert (= a0x40162c_r13 fnstart_r13))
(assert (= a0x40162c_r14 fnstart_r14))
(assert (= a0x40162c_r15 fnstart_r15))
(assert (= a0x40162c_cf a0x40162c_af))
(assert (= a0x40162c_cf a0x40162c_df))
(assert (= a0x40162c_cf a0x40162c_of))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t93 = call i64 @strncmp (i64 4211152,i64 4203240,i64 4)
(define-fun rsp () (_ BitVec 64) (bvsub a0x40162c_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x40162c_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x000000000040164a))
(assert true)
(assert true)
(assert true)
(assert (not a0x40162c_df))
(assert (= (mem_readbv64 mem rsp) #x000000000040164a))
(declare-fun a0x40164a_xmm15 () (_ BitVec 512))
(declare-fun a0x40164a_xmm14 () (_ BitVec 512))
(declare-fun a0x40164a_xmm13 () (_ BitVec 512))
(declare-fun a0x40164a_xmm12 () (_ BitVec 512))
(declare-fun a0x40164a_xmm11 () (_ BitVec 512))
(declare-fun a0x40164a_xmm10 () (_ BitVec 512))
(declare-fun a0x40164a_xmm9 () (_ BitVec 512))
(declare-fun a0x40164a_xmm8 () (_ BitVec 512))
(declare-fun a0x40164a_xmm7 () (_ BitVec 512))
(declare-fun a0x40164a_xmm6 () (_ BitVec 512))
(declare-fun a0x40164a_xmm5 () (_ BitVec 512))
(declare-fun a0x40164a_xmm4 () (_ BitVec 512))
(declare-fun a0x40164a_xmm3 () (_ BitVec 512))
(declare-fun a0x40164a_xmm2 () (_ BitVec 512))
(declare-fun a0x40164a_xmm1 () (_ BitVec 512))
(declare-fun a0x40164a_xmm0 () (_ BitVec 512))
(declare-fun a0x40164a_el8 () Bool)
(declare-fun a0x40164a_el7 () Bool)
(declare-fun a0x40164a_el6 () Bool)
(declare-fun a0x40164a_el5 () Bool)
(declare-fun a0x40164a_el4 () Bool)
(declare-fun a0x40164a_el3 () Bool)
(declare-fun a0x40164a_el2 () Bool)
(declare-fun a0x40164a_el1 () Bool)
(declare-fun a0x40164a_el0 () Bool)
(declare-fun a0x40164a_el () Bool)
(declare-fun a0x40164a_id () Bool)
(declare-fun a0x40164a_vip () Bool)
(declare-fun a0x40164a_vif () Bool)
(declare-fun a0x40164a_ac () Bool)
(declare-fun a0x40164a_vm () Bool)
(declare-fun a0x40164a_rf () Bool)
(declare-fun a0x40164a_RESERVED_15 () Bool)
(declare-fun a0x40164a_nt () Bool)
(declare-fun a0x40164a_iopl2 () Bool)
(declare-fun a0x40164a_iopl1 () Bool)
(declare-fun a0x40164a_of () Bool)
(define-fun a0x40164a_df () Bool false)
(declare-fun a0x40164a_if () Bool)
(declare-fun a0x40164a_tf () Bool)
(declare-fun a0x40164a_sf () Bool)
(declare-fun a0x40164a_zf () Bool)
(declare-fun a0x40164a_RESERVED_5 () Bool)
(declare-fun a0x40164a_af () Bool)
(declare-fun a0x40164a_RESERVED_3 () Bool)
(declare-fun a0x40164a_pf () Bool)
(declare-fun a0x40164a_RESERVED_1 () Bool)
(declare-fun a0x40164a_cf () Bool)
(declare-fun a0x40164a_r15 () (_ BitVec 64))
(declare-fun a0x40164a_r14 () (_ BitVec 64))
(declare-fun a0x40164a_r13 () (_ BitVec 64))
(declare-fun a0x40164a_r12 () (_ BitVec 64))
(declare-fun a0x40164a_r11 () (_ BitVec 64))
(declare-fun a0x40164a_r10 () (_ BitVec 64))
(declare-fun a0x40164a_r9 () (_ BitVec 64))
(declare-fun a0x40164a_r8 () (_ BitVec 64))
(declare-fun a0x40164a_rdi () (_ BitVec 64))
(declare-fun a0x40164a_rsi () (_ BitVec 64))
(declare-fun a0x40164a_rbp () (_ BitVec 64))
(declare-fun a0x40164a_rsp () (_ BitVec 64))
(declare-fun a0x40164a_rbx () (_ BitVec 64))
(declare-fun a0x40164a_rdx () (_ BitVec 64))
(declare-fun a0x40164a_rcx () (_ BitVec 64))
(declare-fun a0x40164a_rax () (_ BitVec 64))
...
(define-fun %t93 () (_ BitVec 64) a0x40164a_rax)
; LLVM:     jump label %block_0_40164a
(assert true)
(assert (= a0x40164a_df false))
(assert (= %t93 a0x40164a_rax))
(assert (= %t91 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t92 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40162c_rbx fnstart_rbx))
