; reopt___do_global_dtors_aux_0_0x401280.block_0_401296.2 @ 0x40129e: register value preserved (r14, after return)
(set-logic ALL)
...
(assert (= a0x401296_r12 fnstart_r12))
(assert (= a0x401296_r13 fnstart_r13))
(check-sat-assuming ((not (= a0x401296_r14 fnstart_r14))))
(exit)
