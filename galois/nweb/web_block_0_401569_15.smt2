; web.block_0_401569.3 @ 0x401575: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for jump)
(set-logic ALL)
...
(declare-fun a0x401569_rax () (_ BitVec 64))
(declare-fun a0x401569_rcx () (_ BitVec 64))
(declare-fun a0x401569_rdx () (_ BitVec 64))
(declare-fun a0x401569_rbx () (_ BitVec 64))
(declare-fun a0x401569_rsp () (_ BitVec 64))
(declare-fun a0x401569_rbp () (_ BitVec 64))
(declare-fun a0x401569_rsi () (_ BitVec 64))
(declare-fun a0x401569_rdi () (_ BitVec 64))
(declare-fun a0x401569_r8 () (_ BitVec 64))
(declare-fun a0x401569_r9 () (_ BitVec 64))
(declare-fun a0x401569_r10 () (_ BitVec 64))
(declare-fun a0x401569_r11 () (_ BitVec 64))
(declare-fun a0x401569_r12 () (_ BitVec 64))
(declare-fun a0x401569_r13 () (_ BitVec 64))
(declare-fun a0x401569_r14 () (_ BitVec 64))
(declare-fun a0x401569_r15 () (_ BitVec 64))
(declare-fun a0x401569_cf () Bool)
(declare-fun a0x401569_RESERVED_1 () Bool)
(declare-fun a0x401569_pf () Bool)
(declare-fun a0x401569_RESERVED_3 () Bool)
(declare-fun a0x401569_af () Bool)
(declare-fun a0x401569_RESERVED_5 () Bool)
(declare-fun a0x401569_zf () Bool)
(declare-fun a0x401569_sf () Bool)
(declare-fun a0x401569_tf () Bool)
(declare-fun a0x401569_if () Bool)
(define-fun a0x401569_df () Bool false)
(declare-fun a0x401569_of () Bool)
(declare-fun a0x401569_iopl1 () Bool)
(declare-fun a0x401569_iopl2 () Bool)
(declare-fun a0x401569_nt () Bool)
(declare-fun a0x401569_RESERVED_15 () Bool)
(declare-fun a0x401569_rf () Bool)
(declare-fun a0x401569_vm () Bool)
(declare-fun a0x401569_ac () Bool)
(declare-fun a0x401569_vif () Bool)
(declare-fun a0x401569_vip () Bool)
(declare-fun a0x401569_id () Bool)
(declare-fun a0x401569_el () Bool)
(declare-fun a0x401569_el0 () Bool)
(declare-fun a0x401569_el1 () Bool)
(declare-fun a0x401569_el2 () Bool)
(declare-fun a0x401569_el3 () Bool)
(declare-fun a0x401569_el4 () Bool)
(declare-fun a0x401569_el5 () Bool)
(declare-fun a0x401569_el6 () Bool)
(declare-fun a0x401569_el7 () Bool)
(declare-fun a0x401569_el8 () Bool)
(declare-fun a0x401569_xmm0 () (_ BitVec 512))
(declare-fun a0x401569_xmm1 () (_ BitVec 512))
(declare-fun a0x401569_xmm2 () (_ BitVec 512))
(declare-fun a0x401569_xmm3 () (_ BitVec 512))
(declare-fun a0x401569_xmm4 () (_ BitVec 512))
(declare-fun a0x401569_xmm5 () (_ BitVec 512))
(declare-fun a0x401569_xmm6 () (_ BitVec 512))
(declare-fun a0x401569_xmm7 () (_ BitVec 512))
(declare-fun a0x401569_xmm8 () (_ BitVec 512))
(declare-fun a0x401569_xmm9 () (_ BitVec 512))
(declare-fun a0x401569_xmm10 () (_ BitVec 512))
(declare-fun a0x401569_xmm11 () (_ BitVec 512))
(declare-fun a0x401569_xmm12 () (_ BitVec 512))
(declare-fun a0x401569_xmm13 () (_ BitVec 512))
(declare-fun a0x401569_xmm14 () (_ BitVec 512))
(declare-fun a0x401569_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t30 () (_ BitVec 64))
(declare-fun %t31 () (_ BitVec 32))
(declare-fun %t32 () (_ BitVec 32))
(assert (= %t30 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t31 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t32 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401569_rbx fnstart_rbx))
(assert (= a0x401569_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401569_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401569_r12 fnstart_r12))
(assert (= a0x401569_r13 fnstart_r13))
(assert (= a0x401569_r14 fnstart_r14))
(assert (= a0x401569_r15 fnstart_r15))
(assert (= a0x401569_af a0x401569_df))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t33 = add i64 %t30, 4211152
(define-fun %t33 () (_ BitVec 64) (bvadd %t30 #x00000000004041d0))
; LLVM:     %t34 = inttoptr i64 %t33 to i8*
(define-fun %t34 () (_ BitVec 64) %t33)
; LLVM:     store i8 0, i8* %t34, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x401569_rbp #xffffffffffffffd8))
...
(assert (= %t34 addr0))
(assert true)
; LLVM:     jump label %block_0_401582
(assert true)
(assert (= a0x401569_df false))
(assert (= %t30 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t31 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t32 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401569_rbx fnstart_rbx))
