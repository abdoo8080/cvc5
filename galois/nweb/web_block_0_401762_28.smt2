; web.block_0_401762.2 @ 0x401765: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for false branch)
(set-logic ALL)
...
(declare-fun a0x401762_rax () (_ BitVec 64))
(declare-fun a0x401762_rcx () (_ BitVec 64))
(declare-fun a0x401762_rdx () (_ BitVec 64))
(declare-fun a0x401762_rbx () (_ BitVec 64))
(declare-fun a0x401762_rsp () (_ BitVec 64))
(declare-fun a0x401762_rbp () (_ BitVec 64))
(declare-fun a0x401762_rsi () (_ BitVec 64))
(declare-fun a0x401762_rdi () (_ BitVec 64))
(declare-fun a0x401762_r8 () (_ BitVec 64))
(declare-fun a0x401762_r9 () (_ BitVec 64))
(declare-fun a0x401762_r10 () (_ BitVec 64))
(declare-fun a0x401762_r11 () (_ BitVec 64))
(declare-fun a0x401762_r12 () (_ BitVec 64))
(declare-fun a0x401762_r13 () (_ BitVec 64))
(declare-fun a0x401762_r14 () (_ BitVec 64))
(declare-fun a0x401762_r15 () (_ BitVec 64))
(declare-fun a0x401762_cf () Bool)
(declare-fun a0x401762_RESERVED_1 () Bool)
(declare-fun a0x401762_pf () Bool)
(declare-fun a0x401762_RESERVED_3 () Bool)
(declare-fun a0x401762_af () Bool)
(declare-fun a0x401762_RESERVED_5 () Bool)
(declare-fun a0x401762_zf () Bool)
(declare-fun a0x401762_sf () Bool)
(declare-fun a0x401762_tf () Bool)
(declare-fun a0x401762_if () Bool)
(define-fun a0x401762_df () Bool false)
(declare-fun a0x401762_of () Bool)
(declare-fun a0x401762_iopl1 () Bool)
(declare-fun a0x401762_iopl2 () Bool)
(declare-fun a0x401762_nt () Bool)
(declare-fun a0x401762_RESERVED_15 () Bool)
(declare-fun a0x401762_rf () Bool)
(declare-fun a0x401762_vm () Bool)
(declare-fun a0x401762_ac () Bool)
(declare-fun a0x401762_vif () Bool)
(declare-fun a0x401762_vip () Bool)
(declare-fun a0x401762_id () Bool)
(declare-fun a0x401762_el () Bool)
(declare-fun a0x401762_el0 () Bool)
(declare-fun a0x401762_el1 () Bool)
(declare-fun a0x401762_el2 () Bool)
(declare-fun a0x401762_el3 () Bool)
(declare-fun a0x401762_el4 () Bool)
(declare-fun a0x401762_el5 () Bool)
(declare-fun a0x401762_el6 () Bool)
(declare-fun a0x401762_el7 () Bool)
(declare-fun a0x401762_el8 () Bool)
(declare-fun a0x401762_xmm0 () (_ BitVec 512))
(declare-fun a0x401762_xmm1 () (_ BitVec 512))
(declare-fun a0x401762_xmm2 () (_ BitVec 512))
(declare-fun a0x401762_xmm3 () (_ BitVec 512))
(declare-fun a0x401762_xmm4 () (_ BitVec 512))
(declare-fun a0x401762_xmm5 () (_ BitVec 512))
(declare-fun a0x401762_xmm6 () (_ BitVec 512))
(declare-fun a0x401762_xmm7 () (_ BitVec 512))
(declare-fun a0x401762_xmm8 () (_ BitVec 512))
(declare-fun a0x401762_xmm9 () (_ BitVec 512))
(declare-fun a0x401762_xmm10 () (_ BitVec 512))
(declare-fun a0x401762_xmm11 () (_ BitVec 512))
(declare-fun a0x401762_xmm12 () (_ BitVec 512))
(declare-fun a0x401762_xmm13 () (_ BitVec 512))
(declare-fun a0x401762_xmm14 () (_ BitVec 512))
(declare-fun a0x401762_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t177 () (_ BitVec 64))
(declare-fun %t178 () (_ BitVec 32))
(declare-fun %t179 () (_ BitVec 32))
(assert (= %t177 a0x401762_rax))
(assert (= %t178 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t179 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401762_rbx fnstart_rbx))
(assert (= a0x401762_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401762_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401762_r12 fnstart_r12))
(assert (= a0x401762_r13 fnstart_r13))
(assert (= a0x401762_r14 fnstart_r14))
(assert (= a0x401762_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t180 = trunc i64 %t177 to i32
(define-fun %t180 () (_ BitVec 32) ((_ extract 31 0) %t177))
; LLVM:     %t181 = icmp eq i32 %t180, 0
(define-fun %t181 () (_ BitVec 1) (ite (= %t180 #x00000000) #b1 #b0))
; LLVM:     br i1 %t181, label %block_0_401792, label %block_0_40176b
(assert (=> (= %t181 #b1) (= (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax)))) #x00000000) #x0000000000401792 #x000000000040176b) #x0000000000401792)))
(assert (=> (= %t181 #b1) (= a0x401762_df false)))
(assert (=> (= %t181 #b1) (= %t178 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t181 #b1) (= %t179 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t181 #b1) (= a0x401762_rbx fnstart_rbx)))
(assert (=> (= %t181 #b1) (= a0x401762_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t181 #b1) (= a0x401762_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t181 #b1) (= a0x401762_r12 fnstart_r12)))
(assert (=> (= %t181 #b1) (= a0x401762_r13 fnstart_r13)))
(assert (=> (= %t181 #b1) (= a0x401762_r14 fnstart_r14)))
(assert (=> (= %t181 #b1) (= a0x401762_r15 fnstart_r15)))
(assert (=> (= %t181 #b1) (= (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401762_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true) a0x401762_df)))
(assert (=> (= %t181 #b1) (= (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401762_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true) (and (not (= (bvand ((_ extract 31 0) a0x401762_rax) #x80000000) #x00000000)) (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b010000000000000000000000000000000) #b000000000000000000000000000000000)) false true)))))
(assert (=> (= %t181 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t181 #b1)) (= (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax)))) #x00000000) #x0000000000401792 #x000000000040176b) #x000000000040176b)))
(assert (=> (not (= %t181 #b1)) (= a0x401762_df false)))
(assert (=> (not (= %t181 #b1)) (= %t178 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t181 #b1)) (= %t179 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t181 #b1)) (= a0x401762_rbx fnstart_rbx)))
(assert (=> (not (= %t181 #b1)) (= a0x401762_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t181 #b1)) (= a0x401762_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t181 #b1)) (= a0x401762_r12 fnstart_r12)))
(assert (=> (not (= %t181 #b1)) (= a0x401762_r13 fnstart_r13)))
(assert (=> (not (= %t181 #b1)) (= a0x401762_r14 fnstart_r14)))
(assert (=> (not (= %t181 #b1)) (= a0x401762_r15 fnstart_r15)))
(assert (=> (not (= %t181 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x401762_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true))))
(assert (=> (not (= %t181 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) a0x401762_df)))
(assert (=> (not (= %t181 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (and (not (= (bvand ((_ extract 31 0) a0x401762_rax) #x80000000) #x00000000)) (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x401762_rax))) #b010000000000000000000000000000000) #b000000000000000000000000000000000)) false true)))))
(check-sat-assuming ((not (=> (not (= %t181 #b1)) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
