; web.block_0_4015c2.3 @ 0x4015c6: precondition ((= (llvm t77) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(assert (= %t69 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t70 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(check-sat-assuming ((not (= %t71 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
