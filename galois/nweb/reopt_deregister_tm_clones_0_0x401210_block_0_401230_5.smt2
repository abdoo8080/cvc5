; reopt_deregister_tm_clones_0_0x401210.block_0_401230.0 @ 0x401230: register value preserved (rbx, after return)
(set-logic ALL)
...
(assert (= a0x401230_rbp fnstart_rbp))
(check-sat-assuming ((not (= a0x401230_rbx fnstart_rbx))))
(exit)
