; _fini.block_0_401f48.0 @ 0x401f54: register value preserved (rbp, after return)
(set-logic ALL)
...
; LLVM:     ret void
(define-fun rsp () (_ BitVec 64) ((_ extract 63 0) (bvadd #b01111111111111111111111111111111111111111111111111111111111111000 (concat #b0 fnstart_rsp))))
(define-fun rsp0 () (_ BitVec 64) ((_ extract 63 0) (bvadd #b00000000000000000000000000000000000000000000000000000000000001000 (concat #b0 rsp))))
(declare-fun readv () (_ BitVec 64))
(assert (on_stack rsp0 #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem rsp0)))
