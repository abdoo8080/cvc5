; web.block_0_40164a.2 @ 0x40164d: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t98 #b1)) (= a0x40164a_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
