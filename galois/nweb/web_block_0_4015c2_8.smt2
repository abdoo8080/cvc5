; web.block_0_4015c2.3 @ 0x4015c6: precondition ((= (llvm t78) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(assert (= %t70 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t71 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(check-sat-assuming ((not (= %t72 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
