; web.block_0_401762.2 @ 0x401765: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t181 #b1) (= a0x401762_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
