; reopt___do_global_dtors_aux_0_0x401280.block_0_4012a0.0 @ 0x4012a0: register value preserved (r14, after return)
(set-logic ALL)
...
(assert (= a0x4012a0_r12 fnstart_r12))
(assert (= a0x4012a0_r13 fnstart_r13))
(check-sat-assuming ((not (= a0x4012a0_r14 fnstart_r14))))
(exit)
