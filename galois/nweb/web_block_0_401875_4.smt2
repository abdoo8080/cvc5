; web.block_0_401875.1 @ 0x40187a: precondition ((= (llvm t260) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t258 #b1) (= %t256 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))))
(exit)
