; web.block_0_401515.1 @ 0x40151e: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t7 #b1) (= (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
