; web.block_0_4019b6.3 @ 0x4019be: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t324 #b1) (= a0x4019b6_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
