; web.block_0_4017dd.5 @ 0x4017f5: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(assert (= %t210 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t211 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t212 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000001c))))
(assert (= %t213 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t214 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4017dd_rbx fnstart_rbx))
