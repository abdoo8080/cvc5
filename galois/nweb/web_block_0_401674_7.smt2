; web.block_0_401674.0 @ 0x401674: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t102 () (_ BitVec 32))
(declare-fun %t103 () (_ BitVec 32))
(assert (= %t102 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t103 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401674_rbx fnstart_rbx))
(assert (= a0x401674_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401674_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401674_r12 fnstart_r12))
(assert (= a0x401674_r13 fnstart_r13))
(assert (= a0x401674_r14 fnstart_r14))
(assert (= a0x401674_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     jump label %block_0_40167c
(define-fun addr () (_ BitVec 64) (bvadd a0x401674_rbp #xffffffffffffffe0))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x0000000000000004))
(assert true)
(assert (= a0x401674_df false))
(assert (= #x0000000000000004 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t102 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t103 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401674_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x401674_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
