; web.block_0_401710.2 @ 0x40172c: precondition ((= (llvm t172) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t167 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
