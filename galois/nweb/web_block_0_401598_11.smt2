; web.block_0_401598.5 @ 0x4015a7: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t59 #b1) (= a0x401598_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
