; web.block_0_40157a.2 @ 0x40157a: precondition ((= (llvm t39) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t35 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))))
(exit)
