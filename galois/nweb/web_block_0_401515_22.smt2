; web.block_0_401515.1 @ 0x40151e: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t7 #b1)) (= a0x401515_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
