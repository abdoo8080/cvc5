; reopt___do_global_dtors_aux_0_0x401280.block_0_4012a0.0 @ 0x4012a0: register value preserved (r12, after return)
(set-logic ALL)
...
(declare-fun a0x4012a0_rax () (_ BitVec 64))
(declare-fun a0x4012a0_rcx () (_ BitVec 64))
(declare-fun a0x4012a0_rdx () (_ BitVec 64))
(declare-fun a0x4012a0_rbx () (_ BitVec 64))
(declare-fun a0x4012a0_rsp () (_ BitVec 64))
(declare-fun a0x4012a0_rbp () (_ BitVec 64))
(declare-fun a0x4012a0_rsi () (_ BitVec 64))
(declare-fun a0x4012a0_rdi () (_ BitVec 64))
(declare-fun a0x4012a0_r8 () (_ BitVec 64))
(declare-fun a0x4012a0_r9 () (_ BitVec 64))
(declare-fun a0x4012a0_r10 () (_ BitVec 64))
(declare-fun a0x4012a0_r11 () (_ BitVec 64))
(declare-fun a0x4012a0_r12 () (_ BitVec 64))
(declare-fun a0x4012a0_r13 () (_ BitVec 64))
(declare-fun a0x4012a0_r14 () (_ BitVec 64))
(declare-fun a0x4012a0_r15 () (_ BitVec 64))
(declare-fun a0x4012a0_cf () Bool)
(declare-fun a0x4012a0_RESERVED_1 () Bool)
(declare-fun a0x4012a0_pf () Bool)
(declare-fun a0x4012a0_RESERVED_3 () Bool)
(declare-fun a0x4012a0_af () Bool)
(declare-fun a0x4012a0_RESERVED_5 () Bool)
(declare-fun a0x4012a0_zf () Bool)
(declare-fun a0x4012a0_sf () Bool)
(declare-fun a0x4012a0_tf () Bool)
(declare-fun a0x4012a0_if () Bool)
(define-fun a0x4012a0_df () Bool false)
(declare-fun a0x4012a0_of () Bool)
(declare-fun a0x4012a0_iopl1 () Bool)
(declare-fun a0x4012a0_iopl2 () Bool)
(declare-fun a0x4012a0_nt () Bool)
(declare-fun a0x4012a0_RESERVED_15 () Bool)
(declare-fun a0x4012a0_rf () Bool)
(declare-fun a0x4012a0_vm () Bool)
(declare-fun a0x4012a0_ac () Bool)
(declare-fun a0x4012a0_vif () Bool)
(declare-fun a0x4012a0_vip () Bool)
(declare-fun a0x4012a0_id () Bool)
(declare-fun a0x4012a0_el () Bool)
(declare-fun a0x4012a0_el0 () Bool)
(declare-fun a0x4012a0_el1 () Bool)
(declare-fun a0x4012a0_el2 () Bool)
(declare-fun a0x4012a0_el3 () Bool)
(declare-fun a0x4012a0_el4 () Bool)
(declare-fun a0x4012a0_el5 () Bool)
(declare-fun a0x4012a0_el6 () Bool)
(declare-fun a0x4012a0_el7 () Bool)
(declare-fun a0x4012a0_el8 () Bool)
(declare-fun a0x4012a0_xmm0 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm1 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm2 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm3 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm4 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm5 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm6 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm7 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm8 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm9 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm10 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm11 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm12 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm13 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm14 () (_ BitVec 512))
(declare-fun a0x4012a0_xmm15 () (_ BitVec 512))
(assert (= a0x4012a0_rbx fnstart_rbx))
(assert (= a0x4012a0_rsp fnstart_rsp))
(assert (= a0x4012a0_rbp fnstart_rbp))
(assert (= a0x4012a0_r12 fnstart_r12))
(assert (= a0x4012a0_r13 fnstart_r13))
(assert (= a0x4012a0_r14 fnstart_r14))
(assert (= a0x4012a0_r15 fnstart_r15))
(assert (= a0x4012a0_cf a0x4012a0_af))
(assert (= a0x4012a0_cf a0x4012a0_df))
(assert (= a0x4012a0_cf a0x4012a0_of))
; LLVM:     ret void
(declare-fun readv () (_ BitVec 64))
(assert (on_stack a0x4012a0_rsp #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem a0x4012a0_rsp)))
(define-fun rsp () (_ BitVec 64) (bvadd a0x4012a0_rsp #x0000000000000008))
(assert (= rsp (bvadd fnstart_rsp #x0000000000000008)))
(assert (= readv (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x4012a0_df))
(assert (= a0x4012a0_rbp fnstart_rbp))
(assert (= a0x4012a0_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x4012a0_r12 fnstart_r12))))
(exit)
