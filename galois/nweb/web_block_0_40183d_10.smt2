; web.block_0_40183d.4 @ 0x40185a: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40183d_rax () (_ BitVec 64))
(declare-fun a0x40183d_rcx () (_ BitVec 64))
(declare-fun a0x40183d_rdx () (_ BitVec 64))
(declare-fun a0x40183d_rbx () (_ BitVec 64))
(declare-fun a0x40183d_rsp () (_ BitVec 64))
(declare-fun a0x40183d_rbp () (_ BitVec 64))
(declare-fun a0x40183d_rsi () (_ BitVec 64))
(declare-fun a0x40183d_rdi () (_ BitVec 64))
(declare-fun a0x40183d_r8 () (_ BitVec 64))
(declare-fun a0x40183d_r9 () (_ BitVec 64))
(declare-fun a0x40183d_r10 () (_ BitVec 64))
(declare-fun a0x40183d_r11 () (_ BitVec 64))
(declare-fun a0x40183d_r12 () (_ BitVec 64))
(declare-fun a0x40183d_r13 () (_ BitVec 64))
(declare-fun a0x40183d_r14 () (_ BitVec 64))
(declare-fun a0x40183d_r15 () (_ BitVec 64))
(declare-fun a0x40183d_cf () Bool)
(declare-fun a0x40183d_RESERVED_1 () Bool)
(declare-fun a0x40183d_pf () Bool)
(declare-fun a0x40183d_RESERVED_3 () Bool)
(declare-fun a0x40183d_af () Bool)
(declare-fun a0x40183d_RESERVED_5 () Bool)
(declare-fun a0x40183d_zf () Bool)
(declare-fun a0x40183d_sf () Bool)
(declare-fun a0x40183d_tf () Bool)
(declare-fun a0x40183d_if () Bool)
(define-fun a0x40183d_df () Bool false)
(declare-fun a0x40183d_of () Bool)
(declare-fun a0x40183d_iopl1 () Bool)
(declare-fun a0x40183d_iopl2 () Bool)
(declare-fun a0x40183d_nt () Bool)
(declare-fun a0x40183d_RESERVED_15 () Bool)
(declare-fun a0x40183d_rf () Bool)
(declare-fun a0x40183d_vm () Bool)
(declare-fun a0x40183d_ac () Bool)
(declare-fun a0x40183d_vif () Bool)
(declare-fun a0x40183d_vip () Bool)
(declare-fun a0x40183d_id () Bool)
(declare-fun a0x40183d_el () Bool)
(declare-fun a0x40183d_el0 () Bool)
(declare-fun a0x40183d_el1 () Bool)
(declare-fun a0x40183d_el2 () Bool)
(declare-fun a0x40183d_el3 () Bool)
(declare-fun a0x40183d_el4 () Bool)
(declare-fun a0x40183d_el5 () Bool)
(declare-fun a0x40183d_el6 () Bool)
(declare-fun a0x40183d_el7 () Bool)
(declare-fun a0x40183d_el8 () Bool)
(declare-fun a0x40183d_xmm0 () (_ BitVec 512))
(declare-fun a0x40183d_xmm1 () (_ BitVec 512))
(declare-fun a0x40183d_xmm2 () (_ BitVec 512))
(declare-fun a0x40183d_xmm3 () (_ BitVec 512))
(declare-fun a0x40183d_xmm4 () (_ BitVec 512))
(declare-fun a0x40183d_xmm5 () (_ BitVec 512))
(declare-fun a0x40183d_xmm6 () (_ BitVec 512))
(declare-fun a0x40183d_xmm7 () (_ BitVec 512))
(declare-fun a0x40183d_xmm8 () (_ BitVec 512))
(declare-fun a0x40183d_xmm9 () (_ BitVec 512))
(declare-fun a0x40183d_xmm10 () (_ BitVec 512))
(declare-fun a0x40183d_xmm11 () (_ BitVec 512))
(declare-fun a0x40183d_xmm12 () (_ BitVec 512))
(declare-fun a0x40183d_xmm13 () (_ BitVec 512))
(declare-fun a0x40183d_xmm14 () (_ BitVec 512))
(declare-fun a0x40183d_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t242 () (_ BitVec 64))
(declare-fun %t243 () (_ BitVec 32))
(declare-fun %t244 () (_ BitVec 32))
(assert (= %t242 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(assert (= %t243 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t244 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40183d_rbx fnstart_rbx))
(assert (= a0x40183d_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40183d_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40183d_r12 fnstart_r12))
(assert (= a0x40183d_r13 fnstart_r13))
(assert (= a0x40183d_r14 fnstart_r14))
(assert (= a0x40183d_r15 fnstart_r15))
(assert (= a0x40183d_cf a0x40183d_af))
(assert (= a0x40183d_cf a0x40183d_df))
(assert (= a0x40183d_cf a0x40183d_of))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t245 = shl i64 %t242, 4
(define-fun %t245 () (_ BitVec 64) (bvshl %t242 #x0000000000000004))
; LLVM:     %t246 = add i64 %t245, 4210952
(define-fun %t246 () (_ BitVec 64) (bvadd %t245 #x0000000000404108))
; LLVM:     %t247 = inttoptr i64 %t246 to i64*
(define-fun %t247 () (_ BitVec 64) %t246)
; LLVM:     %t248 = load i64* %t247, align 0
(define-fun addr () (_ BitVec 64) (bvadd a0x40183d_rbp #xffffffffffffffe0))
...
(define-fun addr0 () (_ BitVec 64) (bvadd rax #x0000000000000008))
(declare-fun readv0 () (_ BitVec 64))
(assert (= addr0 %t247))
(assert (not_in_stack_range addr0 #x0000000000000040))
(assert (= readv0 (mem_readbv64 init_mem addr0)))
(define-fun %t248 () (_ BitVec 64) (mem_readbv64 init_mem addr0))
; LLVM:     jump label %block_0_401875
(define-fun addr1 () (_ BitVec 64) (bvadd a0x40183d_rbp #xffffffffffffffc8))
(assert (is_in_mc_only_stack_range addr1 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr1 readv0))
(assert true)
(assert (= a0x40183d_df false))
(assert (= %t248 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t243 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t244 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40183d_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x40183d_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
