; web.block_0_401731.1 @ 0x40173f: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x401731_rbx fnstart_rbx))
(assert (= a0x401731_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x401731_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
