; web.block_0_4015ad.5 @ 0x4015bc: precondition ((= (llvm t76) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t68 #b1)) (= %t61 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
