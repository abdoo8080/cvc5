; web.block_0_40155b.5 @ 0x401563: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t29 #b1)) (= a0x40155b_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
