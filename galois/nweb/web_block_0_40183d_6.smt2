; web.block_0_40183d.4 @ 0x40185a: precondition ((= (llvm t255) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t248 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000040))))))
(exit)
