; web.block_0_4019b6.3 @ 0x4019be: precondition ((= (llvm t327) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t324 #b1)) (= %t321 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
