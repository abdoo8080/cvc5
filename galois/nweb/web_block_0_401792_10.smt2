; web.block_0_401792.1 @ 0x40179c: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x401792_rax () (_ BitVec 64))
(declare-fun a0x401792_rcx () (_ BitVec 64))
(declare-fun a0x401792_rdx () (_ BitVec 64))
(declare-fun a0x401792_rbx () (_ BitVec 64))
(declare-fun a0x401792_rsp () (_ BitVec 64))
(declare-fun a0x401792_rbp () (_ BitVec 64))
(declare-fun a0x401792_rsi () (_ BitVec 64))
(declare-fun a0x401792_rdi () (_ BitVec 64))
(declare-fun a0x401792_r8 () (_ BitVec 64))
(declare-fun a0x401792_r9 () (_ BitVec 64))
(declare-fun a0x401792_r10 () (_ BitVec 64))
(declare-fun a0x401792_r11 () (_ BitVec 64))
(declare-fun a0x401792_r12 () (_ BitVec 64))
(declare-fun a0x401792_r13 () (_ BitVec 64))
(declare-fun a0x401792_r14 () (_ BitVec 64))
(declare-fun a0x401792_r15 () (_ BitVec 64))
(declare-fun a0x401792_cf () Bool)
(declare-fun a0x401792_RESERVED_1 () Bool)
(declare-fun a0x401792_pf () Bool)
(declare-fun a0x401792_RESERVED_3 () Bool)
(declare-fun a0x401792_af () Bool)
(declare-fun a0x401792_RESERVED_5 () Bool)
(declare-fun a0x401792_zf () Bool)
(declare-fun a0x401792_sf () Bool)
(declare-fun a0x401792_tf () Bool)
(declare-fun a0x401792_if () Bool)
(define-fun a0x401792_df () Bool false)
(declare-fun a0x401792_of () Bool)
(declare-fun a0x401792_iopl1 () Bool)
(declare-fun a0x401792_iopl2 () Bool)
(declare-fun a0x401792_nt () Bool)
(declare-fun a0x401792_RESERVED_15 () Bool)
(declare-fun a0x401792_rf () Bool)
(declare-fun a0x401792_vm () Bool)
(declare-fun a0x401792_ac () Bool)
(declare-fun a0x401792_vif () Bool)
(declare-fun a0x401792_vip () Bool)
(declare-fun a0x401792_id () Bool)
(declare-fun a0x401792_el () Bool)
(declare-fun a0x401792_el0 () Bool)
(declare-fun a0x401792_el1 () Bool)
(declare-fun a0x401792_el2 () Bool)
(declare-fun a0x401792_el3 () Bool)
(declare-fun a0x401792_el4 () Bool)
(declare-fun a0x401792_el5 () Bool)
(declare-fun a0x401792_el6 () Bool)
(declare-fun a0x401792_el7 () Bool)
(declare-fun a0x401792_el8 () Bool)
(declare-fun a0x401792_xmm0 () (_ BitVec 512))
(declare-fun a0x401792_xmm1 () (_ BitVec 512))
(declare-fun a0x401792_xmm2 () (_ BitVec 512))
(declare-fun a0x401792_xmm3 () (_ BitVec 512))
(declare-fun a0x401792_xmm4 () (_ BitVec 512))
(declare-fun a0x401792_xmm5 () (_ BitVec 512))
(declare-fun a0x401792_xmm6 () (_ BitVec 512))
(declare-fun a0x401792_xmm7 () (_ BitVec 512))
(declare-fun a0x401792_xmm8 () (_ BitVec 512))
(declare-fun a0x401792_xmm9 () (_ BitVec 512))
(declare-fun a0x401792_xmm10 () (_ BitVec 512))
(declare-fun a0x401792_xmm11 () (_ BitVec 512))
(declare-fun a0x401792_xmm12 () (_ BitVec 512))
(declare-fun a0x401792_xmm13 () (_ BitVec 512))
(declare-fun a0x401792_xmm14 () (_ BitVec 512))
(declare-fun a0x401792_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t190 () (_ BitVec 32))
(declare-fun %t191 () (_ BitVec 32))
(assert (= %t190 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t191 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401792_rbx fnstart_rbx))
(assert (= a0x401792_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401792_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401792_r12 fnstart_r12))
(assert (= a0x401792_r13 fnstart_r13))
(assert (= a0x401792_r14 fnstart_r14))
(assert (= a0x401792_r15 fnstart_r15))
(assert (= a0x401792_af a0x401792_df))
(assert (= a0x401792_af a0x401792_of))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t192 = call i64 @strcpy (i64 4211152,i64 4203328)
(define-fun rsp () (_ BitVec 64) (bvsub a0x401792_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x401792_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x00000000004017a1))
(assert true)
(assert true)
(assert (not a0x401792_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004017a1))
(declare-fun a0x4017a1_xmm15 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm14 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm13 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm12 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm11 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm10 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm9 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm8 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm7 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm6 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm5 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm4 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm3 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm2 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm1 () (_ BitVec 512))
(declare-fun a0x4017a1_xmm0 () (_ BitVec 512))
(declare-fun a0x4017a1_el8 () Bool)
(declare-fun a0x4017a1_el7 () Bool)
(declare-fun a0x4017a1_el6 () Bool)
(declare-fun a0x4017a1_el5 () Bool)
(declare-fun a0x4017a1_el4 () Bool)
(declare-fun a0x4017a1_el3 () Bool)
(declare-fun a0x4017a1_el2 () Bool)
(declare-fun a0x4017a1_el1 () Bool)
(declare-fun a0x4017a1_el0 () Bool)
(declare-fun a0x4017a1_el () Bool)
(declare-fun a0x4017a1_id () Bool)
(declare-fun a0x4017a1_vip () Bool)
(declare-fun a0x4017a1_vif () Bool)
(declare-fun a0x4017a1_ac () Bool)
(declare-fun a0x4017a1_vm () Bool)
(declare-fun a0x4017a1_rf () Bool)
(declare-fun a0x4017a1_RESERVED_15 () Bool)
(declare-fun a0x4017a1_nt () Bool)
(declare-fun a0x4017a1_iopl2 () Bool)
(declare-fun a0x4017a1_iopl1 () Bool)
(declare-fun a0x4017a1_of () Bool)
(define-fun a0x4017a1_df () Bool false)
(declare-fun a0x4017a1_if () Bool)
(declare-fun a0x4017a1_tf () Bool)
(declare-fun a0x4017a1_sf () Bool)
(declare-fun a0x4017a1_zf () Bool)
(declare-fun a0x4017a1_RESERVED_5 () Bool)
(declare-fun a0x4017a1_af () Bool)
(declare-fun a0x4017a1_RESERVED_3 () Bool)
(declare-fun a0x4017a1_pf () Bool)
(declare-fun a0x4017a1_RESERVED_1 () Bool)
(declare-fun a0x4017a1_cf () Bool)
(declare-fun a0x4017a1_r15 () (_ BitVec 64))
(declare-fun a0x4017a1_r14 () (_ BitVec 64))
(declare-fun a0x4017a1_r13 () (_ BitVec 64))
(declare-fun a0x4017a1_r12 () (_ BitVec 64))
(declare-fun a0x4017a1_r11 () (_ BitVec 64))
(declare-fun a0x4017a1_r10 () (_ BitVec 64))
(declare-fun a0x4017a1_r9 () (_ BitVec 64))
(declare-fun a0x4017a1_r8 () (_ BitVec 64))
(declare-fun a0x4017a1_rdi () (_ BitVec 64))
(declare-fun a0x4017a1_rsi () (_ BitVec 64))
(declare-fun a0x4017a1_rbp () (_ BitVec 64))
(declare-fun a0x4017a1_rsp () (_ BitVec 64))
(declare-fun a0x4017a1_rbx () (_ BitVec 64))
(declare-fun a0x4017a1_rdx () (_ BitVec 64))
(declare-fun a0x4017a1_rcx () (_ BitVec 64))
(declare-fun a0x4017a1_rax () (_ BitVec 64))
...
(define-fun %t192 () (_ BitVec 64) a0x4017a1_rax)
; LLVM:     jump label %block_0_4017a1
(assert true)
(assert (= a0x4017a1_df false))
(assert (= %t190 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t191 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401792_rbx fnstart_rbx))
