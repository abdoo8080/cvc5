; reopt___do_global_dtors_aux_0_0x401280.block_0_401296.2 @ 0x40129d: machine code reads from unallocated stack space
(set-logic ALL)
...
(check-sat-assuming ((not (on_stack a0x401296_rsp #x0000000000000008))))
(exit)
