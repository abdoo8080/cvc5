; reopt_frame_dummy_0_0x4012b0.block_0_4012b0.1 @ 0x4012b4: register value preserved (rbp, after return)
(set-logic ALL)
...
(assert (= (mem_readbv64 init_mem fnstart_rsp) #x00000000004012b6))
(declare-fun a0x4012b6_xmm15 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm14 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm13 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm12 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm11 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm10 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm9 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm8 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm7 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm6 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm5 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm4 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm3 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm2 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm1 () (_ BitVec 512))
(declare-fun a0x4012b6_xmm0 () (_ BitVec 512))
(declare-fun a0x4012b6_el8 () Bool)
(declare-fun a0x4012b6_el7 () Bool)
(declare-fun a0x4012b6_el6 () Bool)
(declare-fun a0x4012b6_el5 () Bool)
(declare-fun a0x4012b6_el4 () Bool)
(declare-fun a0x4012b6_el3 () Bool)
(declare-fun a0x4012b6_el2 () Bool)
(declare-fun a0x4012b6_el1 () Bool)
(declare-fun a0x4012b6_el0 () Bool)
(declare-fun a0x4012b6_el () Bool)
(declare-fun a0x4012b6_id () Bool)
(declare-fun a0x4012b6_vip () Bool)
(declare-fun a0x4012b6_vif () Bool)
(declare-fun a0x4012b6_ac () Bool)
(declare-fun a0x4012b6_vm () Bool)
(declare-fun a0x4012b6_rf () Bool)
(declare-fun a0x4012b6_RESERVED_15 () Bool)
(declare-fun a0x4012b6_nt () Bool)
(declare-fun a0x4012b6_iopl2 () Bool)
(declare-fun a0x4012b6_iopl1 () Bool)
(declare-fun a0x4012b6_of () Bool)
(define-fun a0x4012b6_df () Bool false)
(declare-fun a0x4012b6_if () Bool)
(declare-fun a0x4012b6_tf () Bool)
(declare-fun a0x4012b6_sf () Bool)
(declare-fun a0x4012b6_zf () Bool)
(declare-fun a0x4012b6_RESERVED_5 () Bool)
(declare-fun a0x4012b6_af () Bool)
(declare-fun a0x4012b6_RESERVED_3 () Bool)
(declare-fun a0x4012b6_pf () Bool)
(declare-fun a0x4012b6_RESERVED_1 () Bool)
(declare-fun a0x4012b6_cf () Bool)
(declare-fun a0x4012b6_r15 () (_ BitVec 64))
(declare-fun a0x4012b6_r14 () (_ BitVec 64))
(declare-fun a0x4012b6_r13 () (_ BitVec 64))
(declare-fun a0x4012b6_r12 () (_ BitVec 64))
(declare-fun a0x4012b6_r11 () (_ BitVec 64))
(declare-fun a0x4012b6_r10 () (_ BitVec 64))
(declare-fun a0x4012b6_r9 () (_ BitVec 64))
(declare-fun a0x4012b6_r8 () (_ BitVec 64))
(declare-fun a0x4012b6_rdi () (_ BitVec 64))
(declare-fun a0x4012b6_rsi () (_ BitVec 64))
(declare-fun a0x4012b6_rbp () (_ BitVec 64))
(declare-fun a0x4012b6_rsp () (_ BitVec 64))
(declare-fun a0x4012b6_rbx () (_ BitVec 64))
(declare-fun a0x4012b6_rdx () (_ BitVec 64))
(declare-fun a0x4012b6_rcx () (_ BitVec 64))
(declare-fun a0x4012b6_rax () (_ BitVec 64))
(declare-fun mem () (Array (_ BitVec 64) (_ BitVec 8)))
(assert (eqrange mem init_mem (bvadd fnstart_rsp #x0000000000000008) (bvadd fnstart_rsp #x0000000000000007)))
; LLVM:     ret void
(assert (= (bvadd fnstart_rsp #x0000000000000008) (bvadd fnstart_rsp #x0000000000000008)))
(assert (= #x00000000004012b6 (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x4012b6_df))
(check-sat-assuming ((not (= fnstart_rbp fnstart_rbp))))
(exit)
