; web.block_0_4017ab.1 @ 0x4017b6: precondition ((= (llvm t200) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= #x0000000000000000 (mem_readbv64 mem1 (bvsub fnstart_rsp #x0000000000000040))))))
(exit)
