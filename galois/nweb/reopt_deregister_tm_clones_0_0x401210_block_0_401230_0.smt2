; reopt_deregister_tm_clones_0_0x401210.block_0_401230.0 @ 0x401230: machine code reads from unallocated stack space
(set-logic ALL)
...
(check-sat-assuming ((not (on_stack a0x401230_rsp #x0000000000000008))))
(exit)
