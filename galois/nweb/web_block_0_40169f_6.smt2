; web.block_0_40169f.3 @ 0x4016ab: precondition ((= (llvm t130) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(assert (= %t120 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028))))
(check-sat-assuming ((not (= %t121 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
