; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.3 @ 0x40128b: precondition ((= cf df), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t2 #b1) (= (ite (not (= (bvand (bvadd #b100000000 (concat #b0 readv)) #b100000000) #b000000000)) false true) fnstart_df)))))
(exit)
