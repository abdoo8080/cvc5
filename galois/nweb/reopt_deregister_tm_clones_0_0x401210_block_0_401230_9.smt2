; reopt_deregister_tm_clones_0_0x401210.block_0_401230.0 @ 0x401230: register value preserved (r15, after return)
(set-logic ALL)
...
(assert (= a0x401230_r13 fnstart_r13))
(assert (= a0x401230_r14 fnstart_r14))
(check-sat-assuming ((not (= a0x401230_r15 fnstart_r15))))
(exit)
