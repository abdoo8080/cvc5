; web.block_0_401605.1 @ 0x40161e: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x401605_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
