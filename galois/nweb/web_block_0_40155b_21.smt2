; web.block_0_40155b.5 @ 0x401563: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t29 #b1)) (= a0x40155b_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
