; web.block_0_4018b8.2 @ 0x4018be: precondition ((= (llvm t278) (mcstack (bvsub stack_high (_ bv64 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t272 #b1)) (= %t268 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000040)))))))
(exit)
