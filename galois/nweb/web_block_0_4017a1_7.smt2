; web.block_0_4017a1.1 @ 0x4017a6: precondition ((= (llvm t197) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t193 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
