; web.block_0_401605.1 @ 0x40161e: precondition ((= (llvm t88) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t84 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
