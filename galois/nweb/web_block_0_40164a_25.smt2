; web.block_0_40164a.2 @ 0x40164d: precondition ((= cf of), for false branch)
(set-logic ALL)
...
(declare-fun %t94 () (_ BitVec 64))
(declare-fun %t95 () (_ BitVec 32))
(declare-fun %t96 () (_ BitVec 32))
(assert (= %t94 a0x40164a_rax))
(assert (= %t95 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t96 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40164a_rbx fnstart_rbx))
(assert (= a0x40164a_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40164a_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40164a_r12 fnstart_r12))
(assert (= a0x40164a_r13 fnstart_r13))
(assert (= a0x40164a_r14 fnstart_r14))
(assert (= a0x40164a_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t97 = trunc i64 %t94 to i32
(define-fun %t97 () (_ BitVec 32) ((_ extract 31 0) %t94))
; LLVM:     %t98 = icmp eq i32 %t97, 0
(define-fun %t98 () (_ BitVec 1) (ite (= %t97 #x00000000) #b1 #b0))
; LLVM:     br i1 %t98, label %block_0_401674, label %block_0_401653
(assert (=> (= %t98 #b1) (= (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax)))) #x00000000) #x0000000000401674 #x0000000000401653) #x0000000000401674)))
(assert (=> (= %t98 #b1) (= a0x40164a_df false)))
(assert (=> (= %t98 #b1) (= %t95 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (= %t98 #b1) (= %t96 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (= %t98 #b1) (= a0x40164a_rbx fnstart_rbx)))
(assert (=> (= %t98 #b1) (= a0x40164a_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (= %t98 #b1) (= a0x40164a_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (= %t98 #b1) (= a0x40164a_r12 fnstart_r12)))
(assert (=> (= %t98 #b1) (= a0x40164a_r13 fnstart_r13)))
(assert (=> (= %t98 #b1) (= a0x40164a_r14 fnstart_r14)))
(assert (=> (= %t98 #b1) (= a0x40164a_r15 fnstart_r15)))
(assert (=> (= %t98 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))
(assert (=> (not (= %t98 #b1)) (= (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax)))) #x00000000) #x0000000000401674 #x0000000000401653) #x0000000000401653)))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_df false)))
(assert (=> (not (= %t98 #b1)) (= %t95 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))
(assert (=> (not (= %t98 #b1)) (= %t96 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_rbx fnstart_rbx)))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_rsp (bvsub fnstart_rsp #x0000000000000048))))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_rbp (bvsub fnstart_rsp #x0000000000000008))))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_r12 fnstart_r12)))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_r13 fnstart_r13)))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_r14 fnstart_r14)))
(assert (=> (not (= %t98 #b1)) (= a0x40164a_r15 fnstart_r15)))
(assert (=> (not (= %t98 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (ite (ite (not (= (bvand (bvxor #x00000000 ((_ extract 31 0) a0x40164a_rax)) #x00000010) #x00000000)) (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)) (not (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax))) #b000000000000000000000000000010000) #b000000000000000000000000000000000)))) false true))))
(assert (=> (not (= %t98 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) a0x40164a_df)))
(check-sat-assuming ((not (=> (not (= %t98 #b1)) (= (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax))) #b100000000000000000000000000000000) #b000000000000000000000000000000000)) false true) (and (not (= (bvand ((_ extract 31 0) a0x40164a_rax) #x80000000) #x00000000)) (ite (not (= (bvand (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax))) #b010000000000000000000000000000000) #b000000000000000000000000000000000)) false true)))))))
(exit)
