; web.block_0_40155b.5 @ 0x401563: precondition ((= (llvm t31) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t29 #b1)) (= %t23 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010)))))))
(exit)
