; web.block_0_4016c6.0 @ 0x4016c6: precondition ((= (llvm t132) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t129 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
