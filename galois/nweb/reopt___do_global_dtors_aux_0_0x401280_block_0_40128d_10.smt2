; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.1 @ 0x401291: precondition ((= r13 (fnstart r13)), for jump)
(set-logic ALL)
...
(declare-fun a0x40128d_rax () (_ BitVec 64))
(declare-fun a0x40128d_rcx () (_ BitVec 64))
(declare-fun a0x40128d_rdx () (_ BitVec 64))
(declare-fun a0x40128d_rbx () (_ BitVec 64))
(declare-fun a0x40128d_rsp () (_ BitVec 64))
(declare-fun a0x40128d_rbp () (_ BitVec 64))
(declare-fun a0x40128d_rsi () (_ BitVec 64))
(declare-fun a0x40128d_rdi () (_ BitVec 64))
(declare-fun a0x40128d_r8 () (_ BitVec 64))
(declare-fun a0x40128d_r9 () (_ BitVec 64))
(declare-fun a0x40128d_r10 () (_ BitVec 64))
(declare-fun a0x40128d_r11 () (_ BitVec 64))
(declare-fun a0x40128d_r12 () (_ BitVec 64))
(declare-fun a0x40128d_r13 () (_ BitVec 64))
(declare-fun a0x40128d_r14 () (_ BitVec 64))
(declare-fun a0x40128d_r15 () (_ BitVec 64))
(declare-fun a0x40128d_cf () Bool)
(declare-fun a0x40128d_RESERVED_1 () Bool)
(declare-fun a0x40128d_pf () Bool)
(declare-fun a0x40128d_RESERVED_3 () Bool)
(declare-fun a0x40128d_af () Bool)
(declare-fun a0x40128d_RESERVED_5 () Bool)
(declare-fun a0x40128d_zf () Bool)
(declare-fun a0x40128d_sf () Bool)
(declare-fun a0x40128d_tf () Bool)
(declare-fun a0x40128d_if () Bool)
(define-fun a0x40128d_df () Bool false)
(declare-fun a0x40128d_of () Bool)
(declare-fun a0x40128d_iopl1 () Bool)
(declare-fun a0x40128d_iopl2 () Bool)
(declare-fun a0x40128d_nt () Bool)
(declare-fun a0x40128d_RESERVED_15 () Bool)
(declare-fun a0x40128d_rf () Bool)
(declare-fun a0x40128d_vm () Bool)
(declare-fun a0x40128d_ac () Bool)
(declare-fun a0x40128d_vif () Bool)
(declare-fun a0x40128d_vip () Bool)
(declare-fun a0x40128d_id () Bool)
(declare-fun a0x40128d_el () Bool)
(declare-fun a0x40128d_el0 () Bool)
(declare-fun a0x40128d_el1 () Bool)
(declare-fun a0x40128d_el2 () Bool)
(declare-fun a0x40128d_el3 () Bool)
(declare-fun a0x40128d_el4 () Bool)
(declare-fun a0x40128d_el5 () Bool)
(declare-fun a0x40128d_el6 () Bool)
(declare-fun a0x40128d_el7 () Bool)
(declare-fun a0x40128d_el8 () Bool)
(declare-fun a0x40128d_xmm0 () (_ BitVec 512))
(declare-fun a0x40128d_xmm1 () (_ BitVec 512))
(declare-fun a0x40128d_xmm2 () (_ BitVec 512))
(declare-fun a0x40128d_xmm3 () (_ BitVec 512))
(declare-fun a0x40128d_xmm4 () (_ BitVec 512))
(declare-fun a0x40128d_xmm5 () (_ BitVec 512))
(declare-fun a0x40128d_xmm6 () (_ BitVec 512))
(declare-fun a0x40128d_xmm7 () (_ BitVec 512))
(declare-fun a0x40128d_xmm8 () (_ BitVec 512))
(declare-fun a0x40128d_xmm9 () (_ BitVec 512))
(declare-fun a0x40128d_xmm10 () (_ BitVec 512))
(declare-fun a0x40128d_xmm11 () (_ BitVec 512))
(declare-fun a0x40128d_xmm12 () (_ BitVec 512))
(declare-fun a0x40128d_xmm13 () (_ BitVec 512))
(declare-fun a0x40128d_xmm14 () (_ BitVec 512))
(declare-fun a0x40128d_xmm15 () (_ BitVec 512))
(assert (= a0x40128d_rbx fnstart_rbx))
(assert (= a0x40128d_rsp fnstart_rsp))
(assert (= a0x40128d_rbp fnstart_rbp))
(assert (= a0x40128d_r12 fnstart_r12))
(assert (= a0x40128d_r13 fnstart_r13))
(assert (= a0x40128d_r14 fnstart_r14))
(assert (= a0x40128d_r15 fnstart_r15))
(assert (= a0x40128d_cf a0x40128d_af))
(assert (= a0x40128d_cf a0x40128d_df))
(assert (= a0x40128d_cf a0x40128d_of))
; LLVM:     call void
(define-fun rsp () (_ BitVec 64) (bvsub a0x40128d_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range rsp #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem rsp a0x40128d_rbp))
(define-fun rsp0 () (_ BitVec 64) (bvsub rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem0 () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 mem addr #x0000000000401296))
(assert (not a0x40128d_df))
(assert (= (mem_readbv64 mem0 rsp0) #x0000000000401296))
(declare-fun a0x401296_xmm15 () (_ BitVec 512))
(declare-fun a0x401296_xmm14 () (_ BitVec 512))
(declare-fun a0x401296_xmm13 () (_ BitVec 512))
(declare-fun a0x401296_xmm12 () (_ BitVec 512))
(declare-fun a0x401296_xmm11 () (_ BitVec 512))
(declare-fun a0x401296_xmm10 () (_ BitVec 512))
(declare-fun a0x401296_xmm9 () (_ BitVec 512))
(declare-fun a0x401296_xmm8 () (_ BitVec 512))
(declare-fun a0x401296_xmm7 () (_ BitVec 512))
(declare-fun a0x401296_xmm6 () (_ BitVec 512))
(declare-fun a0x401296_xmm5 () (_ BitVec 512))
(declare-fun a0x401296_xmm4 () (_ BitVec 512))
(declare-fun a0x401296_xmm3 () (_ BitVec 512))
(declare-fun a0x401296_xmm2 () (_ BitVec 512))
(declare-fun a0x401296_xmm1 () (_ BitVec 512))
(declare-fun a0x401296_xmm0 () (_ BitVec 512))
(declare-fun a0x401296_el8 () Bool)
(declare-fun a0x401296_el7 () Bool)
(declare-fun a0x401296_el6 () Bool)
(declare-fun a0x401296_el5 () Bool)
(declare-fun a0x401296_el4 () Bool)
(declare-fun a0x401296_el3 () Bool)
(declare-fun a0x401296_el2 () Bool)
(declare-fun a0x401296_el1 () Bool)
(declare-fun a0x401296_el0 () Bool)
(declare-fun a0x401296_el () Bool)
(declare-fun a0x401296_id () Bool)
(declare-fun a0x401296_vip () Bool)
(declare-fun a0x401296_vif () Bool)
(declare-fun a0x401296_ac () Bool)
(declare-fun a0x401296_vm () Bool)
(declare-fun a0x401296_rf () Bool)
(declare-fun a0x401296_RESERVED_15 () Bool)
(declare-fun a0x401296_nt () Bool)
(declare-fun a0x401296_iopl2 () Bool)
(declare-fun a0x401296_iopl1 () Bool)
(declare-fun a0x401296_of () Bool)
(define-fun a0x401296_df () Bool false)
(declare-fun a0x401296_if () Bool)
(declare-fun a0x401296_tf () Bool)
(declare-fun a0x401296_sf () Bool)
(declare-fun a0x401296_zf () Bool)
(declare-fun a0x401296_RESERVED_5 () Bool)
(declare-fun a0x401296_af () Bool)
(declare-fun a0x401296_RESERVED_3 () Bool)
(declare-fun a0x401296_pf () Bool)
(declare-fun a0x401296_RESERVED_1 () Bool)
(declare-fun a0x401296_cf () Bool)
(declare-fun a0x401296_r15 () (_ BitVec 64))
(declare-fun a0x401296_r14 () (_ BitVec 64))
(declare-fun a0x401296_r13 () (_ BitVec 64))
(declare-fun a0x401296_r12 () (_ BitVec 64))
(declare-fun a0x401296_r11 () (_ BitVec 64))
(declare-fun a0x401296_r10 () (_ BitVec 64))
(declare-fun a0x401296_r9 () (_ BitVec 64))
(declare-fun a0x401296_r8 () (_ BitVec 64))
(declare-fun a0x401296_rdi () (_ BitVec 64))
(declare-fun a0x401296_rsi () (_ BitVec 64))
(declare-fun a0x401296_rbp () (_ BitVec 64))
(declare-fun a0x401296_rsp () (_ BitVec 64))
(declare-fun a0x401296_rbx () (_ BitVec 64))
(declare-fun a0x401296_rdx () (_ BitVec 64))
(declare-fun a0x401296_rcx () (_ BitVec 64))
(declare-fun a0x401296_rax () (_ BitVec 64))
(declare-fun mem1 () (Array (_ BitVec 64) (_ BitVec 8)))
(assert (eqrange mem1 mem0 (bvadd rsp0 #x0000000000000008) (bvadd fnstart_rsp #x0000000000000007)))
; LLVM:     jump label %block_0_401296
(assert true)
(assert (= a0x401296_df false))
(assert (= a0x40128d_rbx fnstart_rbx))
(assert (= (bvadd rsp0 #x0000000000000008) (bvsub fnstart_rsp #x0000000000000008)))
(assert (= rsp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40128d_r12 fnstart_r12))
(check-sat-assuming ((not (= a0x40128d_r13 fnstart_r13))))
(exit)
