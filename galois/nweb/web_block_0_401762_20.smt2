; web.block_0_401762.2 @ 0x401765: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t181 #b1)) (= a0x401762_rbp (bvsub fnstart_rsp #x0000000000000008))))))
(exit)
