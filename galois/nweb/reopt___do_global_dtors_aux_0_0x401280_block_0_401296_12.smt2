; reopt___do_global_dtors_aux_0_0x401280.block_0_401296.2 @ 0x40129e: register value preserved (r15, after return)
(set-logic ALL)
...
(assert (= a0x401296_rbx fnstart_rbx))
(assert (= a0x401296_rsp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401296_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401296_r12 fnstart_r12))
(assert (= a0x401296_r13 fnstart_r13))
(assert (= a0x401296_r14 fnstart_r14))
(assert (= a0x401296_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t3 = inttoptr i64 4211136 to i8*
(define-fun %t3 () (_ BitVec 64) #x00000000004041c0)
; LLVM:     store i8 1, i8* %t3, align 0
(assert (= %t3 #x00000000004041c0))
(assert true)
; LLVM:     ret void
(declare-fun readv () (_ BitVec 64))
(assert (on_stack a0x401296_rsp #x0000000000000008))
(assert (= readv (mem_readbv64 init_mem a0x401296_rsp)))
(define-fun rsp () (_ BitVec 64) (bvadd a0x401296_rsp #x0000000000000008))
...
(assert (= rsp0 (bvadd fnstart_rsp #x0000000000000008)))
(assert (= readv0 (mem_readbv64 init_mem fnstart_rsp)))
(assert (not a0x401296_df))
(assert (= readv fnstart_rbp))
(assert (= a0x401296_rbx fnstart_rbx))
(assert (= a0x401296_r12 fnstart_r12))
(assert (= a0x401296_r13 fnstart_r13))
(assert (= a0x401296_r14 fnstart_r14))
(check-sat-assuming ((not (= a0x401296_r15 fnstart_r15))))
(exit)
