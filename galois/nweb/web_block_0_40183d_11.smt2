; web.block_0_40183d.4 @ 0x40185a: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x40183d_rbx fnstart_rbx))
(assert (= a0x40183d_rsp (bvsub fnstart_rsp #x0000000000000048)))
(check-sat-assuming ((not (= a0x40183d_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
