; web.block_0_40164a.2 @ 0x40164d: instruction pointer is expected value (false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t98 #b1)) (= (ite (= ((_ extract 31 0) (bvadd #b100000000000000000000000000000000 (concat #b0 ((_ extract 31 0) a0x40164a_rax)))) #x00000000) #x0000000000401674 #x0000000000401653) #x0000000000401653)))))
(exit)
