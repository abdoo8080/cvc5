; web.block_0_4015e4.2 @ 0x401600: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4015e4_rax () (_ BitVec 64))
(declare-fun a0x4015e4_rcx () (_ BitVec 64))
(declare-fun a0x4015e4_rdx () (_ BitVec 64))
(declare-fun a0x4015e4_rbx () (_ BitVec 64))
(declare-fun a0x4015e4_rsp () (_ BitVec 64))
(declare-fun a0x4015e4_rbp () (_ BitVec 64))
(declare-fun a0x4015e4_rsi () (_ BitVec 64))
(declare-fun a0x4015e4_rdi () (_ BitVec 64))
(declare-fun a0x4015e4_r8 () (_ BitVec 64))
(declare-fun a0x4015e4_r9 () (_ BitVec 64))
(declare-fun a0x4015e4_r10 () (_ BitVec 64))
(declare-fun a0x4015e4_r11 () (_ BitVec 64))
(declare-fun a0x4015e4_r12 () (_ BitVec 64))
(declare-fun a0x4015e4_r13 () (_ BitVec 64))
(declare-fun a0x4015e4_r14 () (_ BitVec 64))
(declare-fun a0x4015e4_r15 () (_ BitVec 64))
(declare-fun a0x4015e4_cf () Bool)
(declare-fun a0x4015e4_RESERVED_1 () Bool)
(declare-fun a0x4015e4_pf () Bool)
(declare-fun a0x4015e4_RESERVED_3 () Bool)
(declare-fun a0x4015e4_af () Bool)
(declare-fun a0x4015e4_RESERVED_5 () Bool)
(declare-fun a0x4015e4_zf () Bool)
(declare-fun a0x4015e4_sf () Bool)
(declare-fun a0x4015e4_tf () Bool)
(declare-fun a0x4015e4_if () Bool)
(define-fun a0x4015e4_df () Bool false)
(declare-fun a0x4015e4_of () Bool)
(declare-fun a0x4015e4_iopl1 () Bool)
(declare-fun a0x4015e4_iopl2 () Bool)
(declare-fun a0x4015e4_nt () Bool)
(declare-fun a0x4015e4_RESERVED_15 () Bool)
(declare-fun a0x4015e4_rf () Bool)
(declare-fun a0x4015e4_vm () Bool)
(declare-fun a0x4015e4_ac () Bool)
(declare-fun a0x4015e4_vif () Bool)
(declare-fun a0x4015e4_vip () Bool)
(declare-fun a0x4015e4_id () Bool)
(declare-fun a0x4015e4_el () Bool)
(declare-fun a0x4015e4_el0 () Bool)
(declare-fun a0x4015e4_el1 () Bool)
(declare-fun a0x4015e4_el2 () Bool)
(declare-fun a0x4015e4_el3 () Bool)
(declare-fun a0x4015e4_el4 () Bool)
(declare-fun a0x4015e4_el5 () Bool)
(declare-fun a0x4015e4_el6 () Bool)
(declare-fun a0x4015e4_el7 () Bool)
(declare-fun a0x4015e4_el8 () Bool)
(declare-fun a0x4015e4_xmm0 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm1 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm2 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm3 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm4 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm5 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm6 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm7 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm8 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm9 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm10 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm11 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm12 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm13 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm14 () (_ BitVec 512))
(declare-fun a0x4015e4_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t80 () (_ BitVec 32))
(declare-fun %t81 () (_ BitVec 32))
(assert (= %t80 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t81 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4015e4_rbx fnstart_rbx))
(assert (= a0x4015e4_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4015e4_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4015e4_r12 fnstart_r12))
(assert (= a0x4015e4_r13 fnstart_r13))
(assert (= a0x4015e4_r14 fnstart_r14))
(assert (= a0x4015e4_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t82 = zext i32 %t80 to i64
(define-fun %t82 () (_ BitVec 64) ((_ zero_extend 32) %t80))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x4015e4_rbp #xfffffffffffffff8))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x4015e4_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x4015e4_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x0000000000401605))
(assert true)
(assert true)
(assert true)
(assert (= %t82 rcx))
(assert (not a0x4015e4_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401605))
(declare-fun a0x401605_xmm15 () (_ BitVec 512))
(declare-fun a0x401605_xmm14 () (_ BitVec 512))
(declare-fun a0x401605_xmm13 () (_ BitVec 512))
(declare-fun a0x401605_xmm12 () (_ BitVec 512))
(declare-fun a0x401605_xmm11 () (_ BitVec 512))
(declare-fun a0x401605_xmm10 () (_ BitVec 512))
(declare-fun a0x401605_xmm9 () (_ BitVec 512))
(declare-fun a0x401605_xmm8 () (_ BitVec 512))
(declare-fun a0x401605_xmm7 () (_ BitVec 512))
(declare-fun a0x401605_xmm6 () (_ BitVec 512))
(declare-fun a0x401605_xmm5 () (_ BitVec 512))
(declare-fun a0x401605_xmm4 () (_ BitVec 512))
(declare-fun a0x401605_xmm3 () (_ BitVec 512))
(declare-fun a0x401605_xmm2 () (_ BitVec 512))
(declare-fun a0x401605_xmm1 () (_ BitVec 512))
(declare-fun a0x401605_xmm0 () (_ BitVec 512))
(declare-fun a0x401605_el8 () Bool)
(declare-fun a0x401605_el7 () Bool)
(declare-fun a0x401605_el6 () Bool)
(declare-fun a0x401605_el5 () Bool)
(declare-fun a0x401605_el4 () Bool)
(declare-fun a0x401605_el3 () Bool)
(declare-fun a0x401605_el2 () Bool)
(declare-fun a0x401605_el1 () Bool)
(declare-fun a0x401605_el0 () Bool)
(declare-fun a0x401605_el () Bool)
(declare-fun a0x401605_id () Bool)
(declare-fun a0x401605_vip () Bool)
(declare-fun a0x401605_vif () Bool)
(declare-fun a0x401605_ac () Bool)
(declare-fun a0x401605_vm () Bool)
(declare-fun a0x401605_rf () Bool)
(declare-fun a0x401605_RESERVED_15 () Bool)
(declare-fun a0x401605_nt () Bool)
(declare-fun a0x401605_iopl2 () Bool)
(declare-fun a0x401605_iopl1 () Bool)
(declare-fun a0x401605_of () Bool)
(define-fun a0x401605_df () Bool false)
(declare-fun a0x401605_if () Bool)
(declare-fun a0x401605_tf () Bool)
(declare-fun a0x401605_sf () Bool)
(declare-fun a0x401605_zf () Bool)
(declare-fun a0x401605_RESERVED_5 () Bool)
(declare-fun a0x401605_af () Bool)
(declare-fun a0x401605_RESERVED_3 () Bool)
(declare-fun a0x401605_pf () Bool)
(declare-fun a0x401605_RESERVED_1 () Bool)
(declare-fun a0x401605_cf () Bool)
(declare-fun a0x401605_r15 () (_ BitVec 64))
(declare-fun a0x401605_r14 () (_ BitVec 64))
(declare-fun a0x401605_r13 () (_ BitVec 64))
(declare-fun a0x401605_r12 () (_ BitVec 64))
(declare-fun a0x401605_r11 () (_ BitVec 64))
(declare-fun a0x401605_r10 () (_ BitVec 64))
(declare-fun a0x401605_r9 () (_ BitVec 64))
(declare-fun a0x401605_r8 () (_ BitVec 64))
(declare-fun a0x401605_rdi () (_ BitVec 64))
(declare-fun a0x401605_rsi () (_ BitVec 64))
(declare-fun a0x401605_rbp () (_ BitVec 64))
(declare-fun a0x401605_rsp () (_ BitVec 64))
(declare-fun a0x401605_rbx () (_ BitVec 64))
(declare-fun a0x401605_rdx () (_ BitVec 64))
(declare-fun a0x401605_rcx () (_ BitVec 64))
(declare-fun a0x401605_rax () (_ BitVec 64))
...
; LLVM:     jump label %block_0_401605
(assert true)
(assert (= a0x401605_df false))
(assert (= %t80 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t81 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4015e4_rbx fnstart_rbx))
