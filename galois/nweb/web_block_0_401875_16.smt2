; web.block_0_401875.1 @ 0x40187a: precondition ((= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp)), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t258 #b1) (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp)))))
(exit)
