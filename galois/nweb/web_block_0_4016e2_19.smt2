; web.block_0_4016e2.6 @ 0x4016f1: precondition ((= (llvm t169) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t152 #b1)) (= %t143 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
