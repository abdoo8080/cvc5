; web.block_0_4016cd.7 @ 0x4016dc: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t142 #b1)) (= a0x4016cd_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
