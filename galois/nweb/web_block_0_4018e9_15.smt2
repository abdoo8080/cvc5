; web.block_0_4018e9.2 @ 0x401909: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x4018e9_rax () (_ BitVec 64))
(declare-fun a0x4018e9_rcx () (_ BitVec 64))
(declare-fun a0x4018e9_rdx () (_ BitVec 64))
(declare-fun a0x4018e9_rbx () (_ BitVec 64))
(declare-fun a0x4018e9_rsp () (_ BitVec 64))
(declare-fun a0x4018e9_rbp () (_ BitVec 64))
(declare-fun a0x4018e9_rsi () (_ BitVec 64))
(declare-fun a0x4018e9_rdi () (_ BitVec 64))
(declare-fun a0x4018e9_r8 () (_ BitVec 64))
(declare-fun a0x4018e9_r9 () (_ BitVec 64))
(declare-fun a0x4018e9_r10 () (_ BitVec 64))
(declare-fun a0x4018e9_r11 () (_ BitVec 64))
(declare-fun a0x4018e9_r12 () (_ BitVec 64))
(declare-fun a0x4018e9_r13 () (_ BitVec 64))
(declare-fun a0x4018e9_r14 () (_ BitVec 64))
(declare-fun a0x4018e9_r15 () (_ BitVec 64))
(declare-fun a0x4018e9_cf () Bool)
(declare-fun a0x4018e9_RESERVED_1 () Bool)
(declare-fun a0x4018e9_pf () Bool)
(declare-fun a0x4018e9_RESERVED_3 () Bool)
(declare-fun a0x4018e9_af () Bool)
(declare-fun a0x4018e9_RESERVED_5 () Bool)
(declare-fun a0x4018e9_zf () Bool)
(declare-fun a0x4018e9_sf () Bool)
(declare-fun a0x4018e9_tf () Bool)
(declare-fun a0x4018e9_if () Bool)
(define-fun a0x4018e9_df () Bool false)
(declare-fun a0x4018e9_of () Bool)
(declare-fun a0x4018e9_iopl1 () Bool)
(declare-fun a0x4018e9_iopl2 () Bool)
(declare-fun a0x4018e9_nt () Bool)
(declare-fun a0x4018e9_RESERVED_15 () Bool)
(declare-fun a0x4018e9_rf () Bool)
(declare-fun a0x4018e9_vm () Bool)
(declare-fun a0x4018e9_ac () Bool)
(declare-fun a0x4018e9_vif () Bool)
(declare-fun a0x4018e9_vip () Bool)
(declare-fun a0x4018e9_id () Bool)
(declare-fun a0x4018e9_el () Bool)
(declare-fun a0x4018e9_el0 () Bool)
(declare-fun a0x4018e9_el1 () Bool)
(declare-fun a0x4018e9_el2 () Bool)
(declare-fun a0x4018e9_el3 () Bool)
(declare-fun a0x4018e9_el4 () Bool)
(declare-fun a0x4018e9_el5 () Bool)
(declare-fun a0x4018e9_el6 () Bool)
(declare-fun a0x4018e9_el7 () Bool)
(declare-fun a0x4018e9_el8 () Bool)
(declare-fun a0x4018e9_xmm0 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm1 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm2 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm3 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm4 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm5 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm6 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm7 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm8 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm9 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm10 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm11 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm12 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm13 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm14 () (_ BitVec 512))
(declare-fun a0x4018e9_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t278 () (_ BitVec 64))
(declare-fun %t279 () (_ BitVec 32))
(declare-fun %t280 () (_ BitVec 32))
(declare-fun %t281 () (_ BitVec 32))
(assert (= %t278 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t279 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t280 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t281 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4018e9_rbx fnstart_rbx))
(assert (= a0x4018e9_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x4018e9_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x4018e9_r12 fnstart_r12))
(assert (= a0x4018e9_r13 fnstart_r13))
(assert (= a0x4018e9_r14 fnstart_r14))
(assert (= a0x4018e9_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t282 = zext i32 %t280 to i64
(define-fun %t282 () (_ BitVec 64) ((_ zero_extend 32) %t280))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x4018e9_rbp #xfffffffffffffff8))
(declare-fun readv () (_ BitVec 32))
(assert (on_stack addr #x0000000000000004))
(assert (= readv (mem_readbv32 init_mem addr)))
(define-fun rcx () (_ BitVec 64) ((_ zero_extend 32) readv))
(define-fun rsp () (_ BitVec 64) (bvsub a0x4018e9_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x4018e9_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x000000000040190e))
(assert true)
(assert true)
(assert true)
(assert (= %t282 rcx))
(assert (not a0x4018e9_df))
(assert (= (mem_readbv64 mem rsp) #x000000000040190e))
...
; LLVM:     jump label %block_0_40190e
(assert true)
(assert (= a0x40190e_df false))
(assert (= %t278 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000040))))
(assert (= %t279 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t280 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t281 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4018e9_rbx fnstart_rbx))
