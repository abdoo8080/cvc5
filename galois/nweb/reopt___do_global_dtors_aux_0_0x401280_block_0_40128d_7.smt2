; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.1 @ 0x401291: precondition ((= rsp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(assert (= a0x40128d_rbx fnstart_rbx))
(check-sat-assuming ((not (= (bvadd rsp0 #x0000000000000008) (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
