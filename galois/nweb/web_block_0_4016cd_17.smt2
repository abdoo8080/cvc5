; web.block_0_4016cd.7 @ 0x4016dc: precondition ((= (llvm t144) (mcstack (bvsub stack_high (_ bv20 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t142 #b1)) (= %t133 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000014)))))))
(exit)
