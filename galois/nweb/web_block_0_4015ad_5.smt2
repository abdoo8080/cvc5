; web.block_0_4015ad.5 @ 0x4015bc: precondition ((= (llvm t69) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t68 #b1) (= %t60 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030)))))))
(exit)
