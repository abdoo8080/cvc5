; web.block_0_401674.0 @ 0x401674: precondition ((= (llvm t106) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t103 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
