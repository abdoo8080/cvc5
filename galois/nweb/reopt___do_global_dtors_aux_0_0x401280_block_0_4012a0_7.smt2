; reopt___do_global_dtors_aux_0_0x401280.block_0_4012a0.0 @ 0x4012a0: register value preserved (r13, after return)
(set-logic ALL)
...
(assert (= a0x4012a0_rbx fnstart_rbx))
(assert (= a0x4012a0_r12 fnstart_r12))
(check-sat-assuming ((not (= a0x4012a0_r13 fnstart_r13))))
(exit)
