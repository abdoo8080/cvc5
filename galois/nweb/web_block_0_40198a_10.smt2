; web.block_0_40198a.2 @ 0x40199a: precondition ((= (llvm t316) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t312 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
