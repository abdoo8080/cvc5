; web.block_0_4019da.0 @ 0x4019da: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(assert (= %t331 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x4019da_rbx fnstart_rbx))
(check-sat-assuming ((not (= a0x4019da_rsp (bvsub fnstart_rsp #x0000000000000048)))))
(exit)
