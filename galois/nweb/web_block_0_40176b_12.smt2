; web.block_0_40176b.1 @ 0x401784: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40176b_rax () (_ BitVec 64))
(declare-fun a0x40176b_rcx () (_ BitVec 64))
(declare-fun a0x40176b_rdx () (_ BitVec 64))
(declare-fun a0x40176b_rbx () (_ BitVec 64))
(declare-fun a0x40176b_rsp () (_ BitVec 64))
(declare-fun a0x40176b_rbp () (_ BitVec 64))
(declare-fun a0x40176b_rsi () (_ BitVec 64))
(declare-fun a0x40176b_rdi () (_ BitVec 64))
(declare-fun a0x40176b_r8 () (_ BitVec 64))
(declare-fun a0x40176b_r9 () (_ BitVec 64))
(declare-fun a0x40176b_r10 () (_ BitVec 64))
(declare-fun a0x40176b_r11 () (_ BitVec 64))
(declare-fun a0x40176b_r12 () (_ BitVec 64))
(declare-fun a0x40176b_r13 () (_ BitVec 64))
(declare-fun a0x40176b_r14 () (_ BitVec 64))
(declare-fun a0x40176b_r15 () (_ BitVec 64))
(declare-fun a0x40176b_cf () Bool)
(declare-fun a0x40176b_RESERVED_1 () Bool)
(declare-fun a0x40176b_pf () Bool)
(declare-fun a0x40176b_RESERVED_3 () Bool)
(declare-fun a0x40176b_af () Bool)
(declare-fun a0x40176b_RESERVED_5 () Bool)
(declare-fun a0x40176b_zf () Bool)
(declare-fun a0x40176b_sf () Bool)
(declare-fun a0x40176b_tf () Bool)
(declare-fun a0x40176b_if () Bool)
(define-fun a0x40176b_df () Bool false)
(declare-fun a0x40176b_of () Bool)
(declare-fun a0x40176b_iopl1 () Bool)
(declare-fun a0x40176b_iopl2 () Bool)
(declare-fun a0x40176b_nt () Bool)
(declare-fun a0x40176b_RESERVED_15 () Bool)
(declare-fun a0x40176b_rf () Bool)
(declare-fun a0x40176b_vm () Bool)
(declare-fun a0x40176b_ac () Bool)
(declare-fun a0x40176b_vif () Bool)
(declare-fun a0x40176b_vip () Bool)
(declare-fun a0x40176b_id () Bool)
(declare-fun a0x40176b_el () Bool)
(declare-fun a0x40176b_el0 () Bool)
(declare-fun a0x40176b_el1 () Bool)
(declare-fun a0x40176b_el2 () Bool)
(declare-fun a0x40176b_el3 () Bool)
(declare-fun a0x40176b_el4 () Bool)
(declare-fun a0x40176b_el5 () Bool)
(declare-fun a0x40176b_el6 () Bool)
(declare-fun a0x40176b_el7 () Bool)
(declare-fun a0x40176b_el8 () Bool)
(declare-fun a0x40176b_xmm0 () (_ BitVec 512))
(declare-fun a0x40176b_xmm1 () (_ BitVec 512))
(declare-fun a0x40176b_xmm2 () (_ BitVec 512))
(declare-fun a0x40176b_xmm3 () (_ BitVec 512))
(declare-fun a0x40176b_xmm4 () (_ BitVec 512))
(declare-fun a0x40176b_xmm5 () (_ BitVec 512))
(declare-fun a0x40176b_xmm6 () (_ BitVec 512))
(declare-fun a0x40176b_xmm7 () (_ BitVec 512))
(declare-fun a0x40176b_xmm8 () (_ BitVec 512))
(declare-fun a0x40176b_xmm9 () (_ BitVec 512))
(declare-fun a0x40176b_xmm10 () (_ BitVec 512))
(declare-fun a0x40176b_xmm11 () (_ BitVec 512))
(declare-fun a0x40176b_xmm12 () (_ BitVec 512))
(declare-fun a0x40176b_xmm13 () (_ BitVec 512))
(declare-fun a0x40176b_xmm14 () (_ BitVec 512))
(declare-fun a0x40176b_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t182 () (_ BitVec 32))
(declare-fun %t183 () (_ BitVec 32))
(assert (= %t182 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t183 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40176b_rbx fnstart_rbx))
(assert (= a0x40176b_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40176b_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40176b_r12 fnstart_r12))
(assert (= a0x40176b_r13 fnstart_r13))
(assert (= a0x40176b_r14 fnstart_r14))
(assert (= a0x40176b_r15 fnstart_r15))
(assert (= a0x40176b_cf a0x40176b_af))
(assert (= a0x40176b_cf a0x40176b_df))
(assert (= a0x40176b_cf a0x40176b_of))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t184 = call i64 @strncmp (i64 4211152,i64 4204238,i64 6)
(define-fun rsp () (_ BitVec 64) (bvsub a0x40176b_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x40176b_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x0000000000401789))
(assert true)
(assert true)
(assert true)
(assert (not a0x40176b_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401789))
(declare-fun a0x401789_xmm15 () (_ BitVec 512))
(declare-fun a0x401789_xmm14 () (_ BitVec 512))
(declare-fun a0x401789_xmm13 () (_ BitVec 512))
(declare-fun a0x401789_xmm12 () (_ BitVec 512))
(declare-fun a0x401789_xmm11 () (_ BitVec 512))
(declare-fun a0x401789_xmm10 () (_ BitVec 512))
(declare-fun a0x401789_xmm9 () (_ BitVec 512))
(declare-fun a0x401789_xmm8 () (_ BitVec 512))
(declare-fun a0x401789_xmm7 () (_ BitVec 512))
(declare-fun a0x401789_xmm6 () (_ BitVec 512))
(declare-fun a0x401789_xmm5 () (_ BitVec 512))
(declare-fun a0x401789_xmm4 () (_ BitVec 512))
(declare-fun a0x401789_xmm3 () (_ BitVec 512))
(declare-fun a0x401789_xmm2 () (_ BitVec 512))
(declare-fun a0x401789_xmm1 () (_ BitVec 512))
(declare-fun a0x401789_xmm0 () (_ BitVec 512))
(declare-fun a0x401789_el8 () Bool)
(declare-fun a0x401789_el7 () Bool)
(declare-fun a0x401789_el6 () Bool)
(declare-fun a0x401789_el5 () Bool)
(declare-fun a0x401789_el4 () Bool)
(declare-fun a0x401789_el3 () Bool)
(declare-fun a0x401789_el2 () Bool)
(declare-fun a0x401789_el1 () Bool)
(declare-fun a0x401789_el0 () Bool)
(declare-fun a0x401789_el () Bool)
(declare-fun a0x401789_id () Bool)
(declare-fun a0x401789_vip () Bool)
(declare-fun a0x401789_vif () Bool)
(declare-fun a0x401789_ac () Bool)
(declare-fun a0x401789_vm () Bool)
(declare-fun a0x401789_rf () Bool)
(declare-fun a0x401789_RESERVED_15 () Bool)
(declare-fun a0x401789_nt () Bool)
(declare-fun a0x401789_iopl2 () Bool)
(declare-fun a0x401789_iopl1 () Bool)
(declare-fun a0x401789_of () Bool)
(define-fun a0x401789_df () Bool false)
(declare-fun a0x401789_if () Bool)
(declare-fun a0x401789_tf () Bool)
(declare-fun a0x401789_sf () Bool)
(declare-fun a0x401789_zf () Bool)
(declare-fun a0x401789_RESERVED_5 () Bool)
(declare-fun a0x401789_af () Bool)
(declare-fun a0x401789_RESERVED_3 () Bool)
(declare-fun a0x401789_pf () Bool)
(declare-fun a0x401789_RESERVED_1 () Bool)
(declare-fun a0x401789_cf () Bool)
(declare-fun a0x401789_r15 () (_ BitVec 64))
(declare-fun a0x401789_r14 () (_ BitVec 64))
(declare-fun a0x401789_r13 () (_ BitVec 64))
(declare-fun a0x401789_r12 () (_ BitVec 64))
(declare-fun a0x401789_r11 () (_ BitVec 64))
(declare-fun a0x401789_r10 () (_ BitVec 64))
(declare-fun a0x401789_r9 () (_ BitVec 64))
(declare-fun a0x401789_r8 () (_ BitVec 64))
(declare-fun a0x401789_rdi () (_ BitVec 64))
(declare-fun a0x401789_rsi () (_ BitVec 64))
(declare-fun a0x401789_rbp () (_ BitVec 64))
(declare-fun a0x401789_rsp () (_ BitVec 64))
(declare-fun a0x401789_rbx () (_ BitVec 64))
(declare-fun a0x401789_rdx () (_ BitVec 64))
(declare-fun a0x401789_rcx () (_ BitVec 64))
(declare-fun a0x401789_rax () (_ BitVec 64))
...
(define-fun %t184 () (_ BitVec 64) a0x401789_rax)
; LLVM:     jump label %block_0_401789
(assert true)
(assert (= a0x401789_df false))
(assert (= %t184 a0x401789_rax))
(assert (= %t182 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t183 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40176b_rbx fnstart_rbx))
