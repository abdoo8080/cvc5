; web.block_0_4016b0.1 @ 0x4016c1: precondition ((= (llvm t106) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t127 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
