; web.block_0_4015ce.1 @ 0x4015df: precondition ((= (llvm t45) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t78 (mem_readbv32 mem (bvsub fnstart_rsp #x000000000000000c))))))
(exit)
