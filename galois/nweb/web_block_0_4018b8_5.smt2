; web.block_0_4018b8.2 @ 0x4018be: precondition ((= (llvm t275) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t272 #b1) (= %t269 (mem_readbv32 mem (bvsub fnstart_rsp #x0000000000000010)))))))
(exit)
