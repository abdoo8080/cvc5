; web.block_0_4017dd.5 @ 0x4017f5: precondition ((= (llvm t224) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t213 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
