; web.block_0_4016e2.6 @ 0x4016f1: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t152 #b1)) (= a0x4016e2_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
