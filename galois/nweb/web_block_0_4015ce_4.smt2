; web.block_0_4015ce.1 @ 0x4015df: precondition ((= (llvm t42) (mcstack (bvsub stack_high (_ bv48 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t75 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000030))))))
(exit)
