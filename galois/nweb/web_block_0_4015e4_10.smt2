; web.block_0_4015e4.2 @ 0x401600: precondition ((= (llvm t83) (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 32))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= %t80 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))))
(exit)
