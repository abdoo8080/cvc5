; web.block_0_40158a.5 @ 0x401592: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t50 #b1)) (= a0x40158a_rsp (bvsub fnstart_rsp #x0000000000000048))))))
(exit)
