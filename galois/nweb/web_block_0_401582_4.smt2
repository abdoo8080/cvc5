; web.block_0_401582.0 @ 0x401582: precondition ((= (llvm t43) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= #x0000000000000000 (mem_readbv64 mem (bvsub fnstart_rsp #x0000000000000028))))))
(exit)
