; web.block_0_401959.2 @ 0x401975: precondition ((= rbp (bvsub stack_high (_ bv8 64))), for jump)
(set-logic ALL)
...
(check-sat-assuming ((not (= a0x401959_rbp (bvsub fnstart_rsp #x0000000000000008)))))
(exit)
