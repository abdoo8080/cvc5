; web.block_0_40152f.2 @ 0x40154b: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun a0x40152f_rax () (_ BitVec 64))
(declare-fun a0x40152f_rcx () (_ BitVec 64))
(declare-fun a0x40152f_rdx () (_ BitVec 64))
(declare-fun a0x40152f_rbx () (_ BitVec 64))
(declare-fun a0x40152f_rsp () (_ BitVec 64))
(declare-fun a0x40152f_rbp () (_ BitVec 64))
(declare-fun a0x40152f_rsi () (_ BitVec 64))
(declare-fun a0x40152f_rdi () (_ BitVec 64))
(declare-fun a0x40152f_r8 () (_ BitVec 64))
(declare-fun a0x40152f_r9 () (_ BitVec 64))
(declare-fun a0x40152f_r10 () (_ BitVec 64))
(declare-fun a0x40152f_r11 () (_ BitVec 64))
(declare-fun a0x40152f_r12 () (_ BitVec 64))
(declare-fun a0x40152f_r13 () (_ BitVec 64))
(declare-fun a0x40152f_r14 () (_ BitVec 64))
(declare-fun a0x40152f_r15 () (_ BitVec 64))
(declare-fun a0x40152f_cf () Bool)
(declare-fun a0x40152f_RESERVED_1 () Bool)
(declare-fun a0x40152f_pf () Bool)
(declare-fun a0x40152f_RESERVED_3 () Bool)
(declare-fun a0x40152f_af () Bool)
(declare-fun a0x40152f_RESERVED_5 () Bool)
(declare-fun a0x40152f_zf () Bool)
(declare-fun a0x40152f_sf () Bool)
(declare-fun a0x40152f_tf () Bool)
(declare-fun a0x40152f_if () Bool)
(define-fun a0x40152f_df () Bool false)
(declare-fun a0x40152f_of () Bool)
(declare-fun a0x40152f_iopl1 () Bool)
(declare-fun a0x40152f_iopl2 () Bool)
(declare-fun a0x40152f_nt () Bool)
(declare-fun a0x40152f_RESERVED_15 () Bool)
(declare-fun a0x40152f_rf () Bool)
(declare-fun a0x40152f_vm () Bool)
(declare-fun a0x40152f_ac () Bool)
(declare-fun a0x40152f_vif () Bool)
(declare-fun a0x40152f_vip () Bool)
(declare-fun a0x40152f_id () Bool)
(declare-fun a0x40152f_el () Bool)
(declare-fun a0x40152f_el0 () Bool)
(declare-fun a0x40152f_el1 () Bool)
(declare-fun a0x40152f_el2 () Bool)
(declare-fun a0x40152f_el3 () Bool)
(declare-fun a0x40152f_el4 () Bool)
(declare-fun a0x40152f_el5 () Bool)
(declare-fun a0x40152f_el6 () Bool)
(declare-fun a0x40152f_el7 () Bool)
(declare-fun a0x40152f_el8 () Bool)
(declare-fun a0x40152f_xmm0 () (_ BitVec 512))
(declare-fun a0x40152f_xmm1 () (_ BitVec 512))
(declare-fun a0x40152f_xmm2 () (_ BitVec 512))
(declare-fun a0x40152f_xmm3 () (_ BitVec 512))
(declare-fun a0x40152f_xmm4 () (_ BitVec 512))
(declare-fun a0x40152f_xmm5 () (_ BitVec 512))
(declare-fun a0x40152f_xmm6 () (_ BitVec 512))
(declare-fun a0x40152f_xmm7 () (_ BitVec 512))
(declare-fun a0x40152f_xmm8 () (_ BitVec 512))
(declare-fun a0x40152f_xmm9 () (_ BitVec 512))
(declare-fun a0x40152f_xmm10 () (_ BitVec 512))
(declare-fun a0x40152f_xmm11 () (_ BitVec 512))
(declare-fun a0x40152f_xmm12 () (_ BitVec 512))
(declare-fun a0x40152f_xmm13 () (_ BitVec 512))
(declare-fun a0x40152f_xmm14 () (_ BitVec 512))
(declare-fun a0x40152f_xmm15 () (_ BitVec 512))
(define-fun %arg0 () (_ BitVec 64) fnstart_rdi)
(define-fun %arg1 () (_ BitVec 64) fnstart_rsi)
(declare-fun %t12 () (_ BitVec 64))
(declare-fun %t13 () (_ BitVec 32))
(declare-fun %t14 () (_ BitVec 32))
(assert (= %t12 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t13 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t14 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40152f_rbx fnstart_rbx))
(assert (= a0x40152f_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40152f_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40152f_r12 fnstart_r12))
(assert (= a0x40152f_r13 fnstart_r13))
(assert (= a0x40152f_r14 fnstart_r14))
(assert (= a0x40152f_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t15 = zext i32 %t14 to i64
(define-fun %t15 () (_ BitVec 64) ((_ zero_extend 32) %t14))
; LLVM:     call void
(define-fun addr () (_ BitVec 64) (bvadd a0x40152f_rbp #xfffffffffffffffc))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x40152f_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x40152f_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x0000000000401550))
(assert true)
(assert true)
(assert true)
(assert (= %t15 rcx))
(assert (not a0x40152f_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401550))
...
; LLVM:     jump label %block_0_401550
(assert true)
(assert (= a0x401550_df false))
(assert (= %t12 (mem_readbv64 mem0 (bvsub fnstart_rsp #x0000000000000030))))
(assert (= %t13 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t14 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40152f_rbx fnstart_rbx))
