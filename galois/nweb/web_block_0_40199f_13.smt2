; web.block_0_40199f.2 @ 0x4019b1: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t315 () (_ BitVec 32))
(declare-fun %t316 () (_ BitVec 32))
(assert (= %t315 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t316 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40199f_rbx fnstart_rbx))
(assert (= a0x40199f_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x40199f_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x40199f_r12 fnstart_r12))
(assert (= a0x40199f_r13 fnstart_r13))
(assert (= a0x40199f_r14 fnstart_r14))
(assert (= a0x40199f_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t317 = zext i32 %t315 to i64
(define-fun %t317 () (_ BitVec 64) ((_ zero_extend 32) %t315))
; LLVM:     %t318 = call i64 @read (i64 %t317,i64 4211152,i64 8096)
(define-fun addr () (_ BitVec 64) (bvadd a0x40199f_rbp #xfffffffffffffff0))
...
(define-fun rsp () (_ BitVec 64) (bvsub a0x40199f_rsp #x0000000000000008))
(define-fun addr0 () (_ BitVec 64) (bvsub a0x40199f_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr0 #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr0 #x00000000004019b6))
(assert (= %t317 rdi))
(assert true)
(assert true)
(assert (not a0x40199f_df))
(assert (= (mem_readbv64 mem rsp) #x00000000004019b6))
...
(define-fun %t318 () (_ BitVec 64) a0x4019b6_rax)
; LLVM:     jump label %block_0_4019b6
(assert true)
(assert (= a0x4019b6_df false))
(assert (= %t318 a0x4019b6_rax))
(assert (= %t315 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000018))))
(assert (= %t316 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x40199f_rbx fnstart_rbx))
