; web.block_0_40155b.5 @ 0x401563: precondition ((= (llvm t32) (mcstack (bvsub stack_high (_ bv12 64)) (_ BitVec 32))), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t29 #b1)) (= %t24 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c)))))))
(exit)
