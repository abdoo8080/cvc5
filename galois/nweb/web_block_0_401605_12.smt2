; web.block_0_401605.1 @ 0x40161e: precondition ((= rsp (bvsub stack_high (_ bv72 64))), for jump)
(set-logic ALL)
...
(declare-fun %t83 () (_ BitVec 32))
(declare-fun %t84 () (_ BitVec 32))
(assert (= %t83 (mem_readbv32 init_mem (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t84 (mem_readbv32 init_mem (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401605_rbx fnstart_rbx))
(assert (= a0x401605_rsp (bvsub fnstart_rsp #x0000000000000048)))
(assert (= a0x401605_rbp (bvsub fnstart_rsp #x0000000000000008)))
(assert (= a0x401605_r12 fnstart_r12))
(assert (= a0x401605_r13 fnstart_r13))
(assert (= a0x401605_r14 fnstart_r14))
(assert (= a0x401605_r15 fnstart_r15))
(assert (= (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000008)) fnstart_rbp))
; LLVM:     %t85 = call i64 @strncmp (i64 4211152,i64 4203235,i64 4)
(define-fun rsp () (_ BitVec 64) (bvsub a0x401605_rsp #x0000000000000008))
(define-fun addr () (_ BitVec 64) (bvsub a0x401605_rsp #x0000000000000008))
(assert (is_in_mc_only_stack_range addr #x0000000000000008))
(define-fun mem () (Array (_ BitVec 64) (_ BitVec 8)) (mem_writebv64 init_mem addr #x0000000000401623))
(assert true)
(assert true)
(assert true)
(assert (not a0x401605_df))
(assert (= (mem_readbv64 mem rsp) #x0000000000401623))
(declare-fun a0x401623_xmm15 () (_ BitVec 512))
(declare-fun a0x401623_xmm14 () (_ BitVec 512))
(declare-fun a0x401623_xmm13 () (_ BitVec 512))
(declare-fun a0x401623_xmm12 () (_ BitVec 512))
(declare-fun a0x401623_xmm11 () (_ BitVec 512))
(declare-fun a0x401623_xmm10 () (_ BitVec 512))
(declare-fun a0x401623_xmm9 () (_ BitVec 512))
(declare-fun a0x401623_xmm8 () (_ BitVec 512))
(declare-fun a0x401623_xmm7 () (_ BitVec 512))
(declare-fun a0x401623_xmm6 () (_ BitVec 512))
(declare-fun a0x401623_xmm5 () (_ BitVec 512))
(declare-fun a0x401623_xmm4 () (_ BitVec 512))
(declare-fun a0x401623_xmm3 () (_ BitVec 512))
(declare-fun a0x401623_xmm2 () (_ BitVec 512))
(declare-fun a0x401623_xmm1 () (_ BitVec 512))
(declare-fun a0x401623_xmm0 () (_ BitVec 512))
(declare-fun a0x401623_el8 () Bool)
(declare-fun a0x401623_el7 () Bool)
(declare-fun a0x401623_el6 () Bool)
(declare-fun a0x401623_el5 () Bool)
(declare-fun a0x401623_el4 () Bool)
(declare-fun a0x401623_el3 () Bool)
(declare-fun a0x401623_el2 () Bool)
(declare-fun a0x401623_el1 () Bool)
(declare-fun a0x401623_el0 () Bool)
(declare-fun a0x401623_el () Bool)
(declare-fun a0x401623_id () Bool)
(declare-fun a0x401623_vip () Bool)
(declare-fun a0x401623_vif () Bool)
(declare-fun a0x401623_ac () Bool)
(declare-fun a0x401623_vm () Bool)
(declare-fun a0x401623_rf () Bool)
(declare-fun a0x401623_RESERVED_15 () Bool)
(declare-fun a0x401623_nt () Bool)
(declare-fun a0x401623_iopl2 () Bool)
(declare-fun a0x401623_iopl1 () Bool)
(declare-fun a0x401623_of () Bool)
(define-fun a0x401623_df () Bool false)
(declare-fun a0x401623_if () Bool)
(declare-fun a0x401623_tf () Bool)
(declare-fun a0x401623_sf () Bool)
(declare-fun a0x401623_zf () Bool)
(declare-fun a0x401623_RESERVED_5 () Bool)
(declare-fun a0x401623_af () Bool)
(declare-fun a0x401623_RESERVED_3 () Bool)
(declare-fun a0x401623_pf () Bool)
(declare-fun a0x401623_RESERVED_1 () Bool)
(declare-fun a0x401623_cf () Bool)
(declare-fun a0x401623_r15 () (_ BitVec 64))
(declare-fun a0x401623_r14 () (_ BitVec 64))
(declare-fun a0x401623_r13 () (_ BitVec 64))
(declare-fun a0x401623_r12 () (_ BitVec 64))
(declare-fun a0x401623_r11 () (_ BitVec 64))
(declare-fun a0x401623_r10 () (_ BitVec 64))
(declare-fun a0x401623_r9 () (_ BitVec 64))
(declare-fun a0x401623_r8 () (_ BitVec 64))
(declare-fun a0x401623_rdi () (_ BitVec 64))
(declare-fun a0x401623_rsi () (_ BitVec 64))
(declare-fun a0x401623_rbp () (_ BitVec 64))
(declare-fun a0x401623_rsp () (_ BitVec 64))
(declare-fun a0x401623_rbx () (_ BitVec 64))
(declare-fun a0x401623_rdx () (_ BitVec 64))
(declare-fun a0x401623_rcx () (_ BitVec 64))
(declare-fun a0x401623_rax () (_ BitVec 64))
...
(define-fun %t85 () (_ BitVec 64) a0x401623_rax)
; LLVM:     jump label %block_0_401623
(assert true)
(assert (= a0x401623_df false))
(assert (= %t85 a0x401623_rax))
(assert (= %t83 (mem_readbv32 mem0 (bvsub fnstart_rsp #x0000000000000010))))
(assert (= %t84 (mem_readbv32 mem0 (bvsub fnstart_rsp #x000000000000000c))))
(assert (= a0x401605_rbx fnstart_rbx))
