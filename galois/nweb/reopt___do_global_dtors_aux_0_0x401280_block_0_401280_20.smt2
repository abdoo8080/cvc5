; reopt___do_global_dtors_aux_0_0x401280.block_0_401280.3 @ 0x40128b: precondition ((= r13 (fnstart r13)), for false branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (not (= %t2 #b1)) (= fnstart_r13 fnstart_r13)))))
(exit)
