; reopt___do_global_dtors_aux_0_0x401280.block_0_40128d.1 @ 0x401291: precondition ((= r15 (fnstart r15)), for jump)
(set-logic ALL)
...
(assert (= a0x40128d_r13 fnstart_r13))
(assert (= a0x40128d_r14 fnstart_r14))
(check-sat-assuming ((not (= a0x40128d_r15 fnstart_r15))))
(exit)
