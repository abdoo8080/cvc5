; web.block_0_4016f7.7 @ 0x40170a: precondition ((= (llvm t164) (mcstack (bvsub stack_high (_ bv40 64)) (_ BitVec 64))), for true branch)
(set-logic ALL)
...
(check-sat-assuming ((not (=> (= %t163 #b1) (= %t153 (mem_readbv64 init_mem (bvsub fnstart_rsp #x0000000000000028)))))))
(exit)
