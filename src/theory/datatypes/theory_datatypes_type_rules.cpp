...
TypeNode DtSygusWeightTypeRule::preComputeType(NodeManager* nm, TNode n)
{
  return nm->integerType();
}
                                            ...
                                            std::ostream* errOut)
{
  if (check)
  {
    if (/* !n[0].isVar() || */ !n[0].getType(check).isInteger()
...
TypeNode WeightSymbolOpTypeRule::preComputeType(NodeManager* nm, TNode n)
{
...
TypeNode WeightSymbolTypeRule::preComputeType(NodeManager* nm, TNode n)
{
  return nm->integerType();
}
